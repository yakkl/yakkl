...
"""
    ...
    def add_message_formatting_conversation(self) -> None:
        ...
        stream = ensure_stream(realm, 'yakkl features')
        ...
        staged_messages = [
            {'sender': starr,
             'content': "Hey @**Bel Fisher**, check out Yakkl's Markdown formatting! "
            ...
            {'sender': starr,
             'content': "I just set up a custom linkifier, "
                        "so `#1234` becomes [#1234](github.com/yakkl/yakkl/1234), "
        ...
        # to yakkl.com and ask an admin of that server to get you the rendered_content.

 ...
 */
export function getToken(address: string, chainId: number): TokenInfo | undefined {
 ...
 */
export function isWrappedNative(token: TokenInfo): boolean {
 ...
 */
export function validateTokenList(list: any): list is TokenList {
  ...
  return list.tokens.every((token: any) => 
    token &&

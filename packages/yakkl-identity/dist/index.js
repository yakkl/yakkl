 ...
 */
export function createBrowserIdentity(config) {
 ...
 */
export function createCLIIdentity(config) {
    return new IdentityManager({
        storage: 'memory',
        providers: {
            oauth: true,
 ...
 */
export function createServiceIdentity(config) {
    return new IdentityManager({
        storage: 'distributed',
        providers: {
            service: true,
 ...
 */
export function createAgentIdentity(config) {
    return new IdentityManager({
        storage: 'hybrid',
        providers: {
            service: true,

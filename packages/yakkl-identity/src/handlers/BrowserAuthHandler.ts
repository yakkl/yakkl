...
export class BrowserAuthHandler {
   ...
   */
  private async handleOAuth(credentials: any): Promise<Identity | null> {
   ...
   */
  private async handlePasskey(credentials: any): Promise<Identity | null> {
    ...
    if (credentials.action === 'register') {
      ...
      const result = await provider.completeRegistration(
        credentials.userId,
        credential
      );
   ...
   */
  private async handleEmail(credentials: any): Promise<Identity | null> {
   ...
   */
  private async handleWallet(credentials: any): Promise<Identity | null> {
  ...
  private async verifyMagicLink(email: string, code: string): Promise<boolean> {

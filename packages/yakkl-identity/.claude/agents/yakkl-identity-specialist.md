# uyakkl-identity Specialist Agent

## Purpose
Specialized agent for working with the yakkl-identity package, understanding its specific patterns, dependencies, and requirements.

## Package Overview
- **Location**: packages/yakkl-identity
...
## Responsibilities
1. Implement yakkl-identity-specific features

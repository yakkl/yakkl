  ...
  <div class="w-full">
    <div class="w-[33%] ml-[33%] pt-[8%]">
      ...
      <p class="mb-4 text-xl">
        YAKKL® flagged the site you're trying to visit as 'potentially deceptive'.
        Attackers may trick you into doing something dangerous.
      ...
      <p class="mt-4 text-xl">
        ...
        <a href={flaggedSite} class="underline">

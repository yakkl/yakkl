	...
	onMount(() => {
		if (browserSvelte) {
			try {
				...
				const urlYid = $page.url.searchParams.get('yid');

				if (!urlFlaggedSite) {
					throw 'No flaggedSite parameter';
				}

				// Update state variables
				yid = urlYid || '';
				flaggedSite = urlFlaggedSite;

				// Append yid parameter
	...
	<div class="w-full">
		<div class="w-[33%] ml-[33%] pt-[8%]">
			...
			<p class="mb-4 text-xl">
				YAKKL® flagged the site you're trying to visit as 'potentially deceptive'. Attackers may
				trick you into doing something dangerous.
				<a
					href="https://cryptoscamdb.org/search"
					target="_blank"
					rel="noreferrer"
			...
			<p class="mt-4 text-xl">
				...
				<br />
				If you understand the risks and still want to proceed, you can
				<a href={flaggedSite} class="underline"> click here to continue to the site. </a>
			</p>
		</div>
		<a
			href="https://yakkl.com?utm_source=yakkl&utm_medium=warning"
			class="btn btn-primary rounded-xl ml-[33%] mt-4"
		>

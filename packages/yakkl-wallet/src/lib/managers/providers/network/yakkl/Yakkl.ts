...
import type { Network, BlockTag, BigNumberish, TransactionResponse, Deferrable, TransactionRequest, Block, BlockWithTransactions, TransactionReceipt, Filter, Log, EventType, Listener } from '$lib/common';
...
export class Yakkl extends AbstractProvider {
  ...
  constructor(privateKey: string | null, 
    ...
    chainId: number = 1) {
    super('YAKKL', blockchains, chainIds, blockchain, chainId);
    // Implementation for constructor for YAKKL provider...
  }

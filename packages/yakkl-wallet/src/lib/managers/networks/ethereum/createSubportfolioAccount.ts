...
export async function createSubportfolioAccount(
	...
	try {
		...
		if (selectedData !== null) {
			yakklPrimaryAccount = (selectedData as CurrentlySelectedData)

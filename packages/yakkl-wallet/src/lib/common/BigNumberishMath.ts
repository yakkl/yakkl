/**
 * BigNumberishMath - Re-export from @yakkl/core
...
import { BigNumberishMath as CoreBigNumberishMath } from '@yakkl/core';

// Re-export for backward compatibility
export const BigNumberishMath = CoreBigNumberishMath;

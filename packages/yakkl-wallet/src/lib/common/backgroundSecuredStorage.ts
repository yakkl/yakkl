...
export async function getObjectFromLocalStorage<T>(key: string, timeoutMs = 2000): Promise<T | null> {
...
export async function setObjectInLocalStorage<T extends Record<string, any>>(key: string, obj: T | string): Promise<void> {
  try {
...
export class SecureStore {
  constructor(private readonly namespace: string, private readonly keySource: string | SaltedKey) {}

...
<script lang="ts">
	...
	import EthereumIcon from './icons/EthereumIcon.svelte';
	import BaseIcon from './icons/BaseIcon.svelte';
	import OptimismIcon from './icons/OptimismIcon.svelte';

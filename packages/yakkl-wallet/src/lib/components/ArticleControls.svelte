...
<Tooltip content={$isBookmarked ? 'Unbookmark article' : 'Bookmark article'}>
  <button
    class="text-gray-400 hover:text-gray-500 focus:outline-none relative {bookmarkEnabled ? '' : 'opacity-50 cursor-not-allowed'}"
    disabled={!bookmarkEnabled}
    onclick={handleBookmark}
  >
    <BookmarkIcon
      className="w-5 h-5 {$isBookmarked ? 'fill-yellow-400' : 'fill-none'} stroke-current text-gray-400"
    />
  </button>
</Tooltip>
<Tooltip content="Print article">
  <button
    class="text-gray-400 hover:text-gray-500 focus:outline-none relative {printEnabled ? '' : 'opacity-50 cursor-not-allowed'}"
...
<Tooltip content="Delete">
  <button
    class="text-gray-400 hover:text-gray-500 focus:outline-none relative {deleteEnabled ? '' : 'opacity-50 cursor-not-allowed'}"

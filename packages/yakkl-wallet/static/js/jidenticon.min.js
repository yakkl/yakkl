...
!(function (t, n) {
	var i = (function (t) {
		...
		function f(t, n, i) {
			var e = [0.55, 0.5, 0.5, 0.46, 0.6, 0.55, 0.55][(6 * t + 0.5) | 0];
			return u(t, n, (i = i < 0.5 ? i * e * 2 : e + (i - 0.5) * (1 - e) * 2));
		}
		var h = t,
			s = { G: 'jdenticon_config', n: 'config' },
			a = {};
		function c(t) {
			a = t;
		}
		...
		function l(t, n) {
			...
			function g(t) {
				var n,
					e = i.hues;
				return (
					e && e.length > 0 && (n = e[0 | (0.999 * t * e.length)]),
					'number' == typeof n ? (((n / 360) % 1) + 1) % 1 : t
				);
			}
			return {
				X: g,
				p: 'number' == typeof u ? u : 0.5,
				H: 'number' == typeof f ? f : 0,
				q: l('color', [0.4, 0.8]),
				I: l('grayscale', [0.3, 0.9]),
				J: r(c),
		...
		var g = 1,
			d = 2,
			p = { t: 'data-jdenticon-hash', o: 'data-jdenticon-value' },
			y = '[' + p.t + '],[' + p.o + ']',
				...
				new MutationObserver(function (n) {
					for (var i = 0; i < n.length; i++) {
						for (var e = n[i], r = e.addedNodes, o = 0; r && o < r.length; o++) {
							...
							if (1 == u.nodeType)
								if (b(u)) t(u);
								else for (var f = u.querySelectorAll(y), h = 0; h < f.length; h++) t(f[h]);
						}
		...
		A.prototype.L = function (t, n, i, e) {
			var r = this.u + this.K,
				...
				u = this.Z;
			return 1 === u
				? new x(r - n - (e || 0), this.v + t)
				: 2 === u
					? new x(r - t - (i || 0), o - n - (e || 0))
					: 3 === u
						? new x(this.u + n, o - t - (i || 0))
						: new x(this.u + t, this.v + n);
		};
		var S = new A(0, 0, 0, 0);
		function j(t) {
			(this.M = t), (this.A = S);
		...
		function M(t, n, i, e) {
			...
			(t %= 14)
				? 1 == t
					? ((u = 0 | (0.5 * i)), (f = 0 | (0.8 * i)), n.j(i - u, 0, u, f, 2))
					: 2 == t
						? ((u = 0 | (i / 3)), n.i(u, u, i - u, i - u))
						: 3 == t
							? ((s = i < 6 ? 1 : i < 8 ? 2 : 0 | (0.25 * i)),
								(h = (h = 0.1 * i) > 1 ? 0 | h : h > 0.5 ? 1 : h),
								n.i(s, s, i - h - s, i - h - s))
							: 4 == t
								? ((o = 0 | (0.15 * i)), (u = 0 | (0.5 * i)), n.h(i - u - o, i - u - o, u))
								: 5 == t
									? ((s = 4 * (h = 0.1 * i)) > 3 && (s |= 0),
										n.i(0, 0, i, i),
										n.g([s, s, i - h, s, s + (i - s - h) / 2, i - h], !0))
									: 6 == t
										? n.g([0, 0, i, 0, i, 0.7 * i, 0.4 * i, 0.4 * i, 0.7 * i, i, 0, i])
										: 7 == t
											? n.j(i / 2, i / 2, i / 2, i / 2, 3)
											: 8 == t
												? (n.i(0, 0, i, i / 2),
													n.i(0, i / 2, i / 2, i / 2),
													n.j(i / 2, i / 2, i / 2, i / 2, 1))
												: 9 == t
													? ((h = 0.14 * i),
														(s = i < 4 ? 1 : i < 6 ? 2 : 0 | (0.35 * i)),
														(h = i < 8 ? h : 0 | h),
														n.i(0, 0, i, i),
														n.i(s, s, i - s - h, i - s - h, !0))
													: 10 == t
														? ((s = 3 * (h = 0.12 * i)), n.i(0, 0, i, i), n.h(s, s, i - h - s, !0))
														: 11 == t
															? n.j(i / 2, i / 2, i / 2, i / 2, 3)
															: 12 == t
																? ((o = 0.25 * i), n.i(0, 0, i, i), n.N(o, o, i - o, i - o, !0))
																: !e && ((o = 0.4 * i), (u = 1.2 * i), n.h(o, o, u))
				: ((r = 0.42 * i), n.g([0, 0, i, 0, i, i - 2 * r, i - r, i, 0, i]));
		}
		function N(t, n, i) {
			var e;
			(t %= 4)
		...
		function k(t, i, e) {
			...
			function c(e, r, o, u, c) {
				...
				for (var p = 0; p < c.length; p++)
					(f.A = new A(s + c[p][0] * h, a + c[p][1] * h, h, l++ % 4)), r(v, f, h, p);
				t.P();
			}
			var v,
				g = T(n(i, -7) / 268435455, r),
				d = [];
			function p(t) {
				if (t.indexOf(v) >= 0)
					for (var n = 0; n < t.length; n++) if (d.indexOf(t[n]) >= 0) return !0;
			}
			for (var y = 0; y < 3; y++)
				(v = n(i, 8 + y, 1) % g.length), (p([0, 4]) || p([2, 3])) && (v = 1), d.push(v);
			c(0, N, 2, 3, [
				[1, 0],
				[2, 0],
				[2, 3],
		...
		function I(t) {
			...
			for (; r < u.length; o++)
				f[o >> 2] =
					f[o >> 2] |
					(('%' == u[r] ? parseInt(u.substring(r + 1, (r += 3)), 16) : u.charCodeAt(r++)) <<
						(8 * (3 - (3 & o))));
					...
					(o =
						...
						(r < 20
							...
							: r < 40
								? 1859775393 + (a ^ c ^ v)
								: r < 60
									? 2400959708 + ((a & c) ^ (a & v) ^ (c & v))
									: 3395469782 + (a ^ c ^ v)) +
						(h[r] = r < e ? 0 | f[d + r] : y(h[r - 3] ^ h[r - 8] ^ h[r - 14] ^ h[r - 16], 1))),
						(l = v),
						(v = c),
						(c = y(a, 30)),
						(a = s),
		...
		function F(t, n) {
			var i = t.canvas,
				...
				r = i.height;
			t.save(),
				n || ((n = Math.min(e, r)), t.translate(((e - n) / 2) | 0, ((r - n) / 2) | 0)),
				(this.l = t),
				(this.k = n),
				t.clearRect(0, 0, n, n);
		}
		(C.g = function (t, n) {
			for (
				var i = this, e = n ? -2 : 2, r = [], o = n ? t.length - 2 : 0;
				o < t.length && o >= 0;
				o += e
			)
				r.push(i.A.L(t[o], t[o + 1]));
			this.M.g(r);
		}),
		...
		var G = { T: 'http://www.w3.org/2000/svg', U: 'width', V: 'height' };
		function H(t) {
			(this.k = t),
				(this.F =
					'<svg xmlns="' +
		...
		function V(t, n) {
			...
			for (var r = document.createElementNS(G.T, n), o = 0; o + 1 < i.length; o += 2)
				r.setAttribute(i[o], i[o + 1]);
			t.appendChild(r);
		}
		function W(t) {
			var n = (this.k = Math.min(
				Number(t.getAttribute(G.U)) || 100,
				Number(t.getAttribute(G.V)) || 100
			));
			for (this.W = t; t.firstChild; ) t.removeChild(t.firstChild);
			t.setAttribute('viewBox', '0 0 ' + n + ' ' + n),
				t.setAttribute('preserveAspectRatio', 'xMidYMid meet');
		}
		(J.m = function (t, n) {
			n &&
				(this.F +=
					'<rect width="100%" height="100%" fill="' + t + '" opacity="' + n.toFixed(2) + '"/>');
		}),
			(J.S = function (t, n) {
		...
		function X(t, n, i, e) {
			if ('string' != typeof t) {
				var r =
					O(n) ||
					(null != n && P(n)) ||
					O(t.getAttribute(p.t)) ||
					(t.hasAttribute(p.o) && P(t.getAttribute(p.o)));
				if (r) {
					var o = e(t, b(t));
					o && k(o, r, i);
				}
			} else if (m) for (var u = m(t), f = 0; f < u.length; f++) X(u[f], n, i, e);
		}
		function Q(t, n) {
			return (

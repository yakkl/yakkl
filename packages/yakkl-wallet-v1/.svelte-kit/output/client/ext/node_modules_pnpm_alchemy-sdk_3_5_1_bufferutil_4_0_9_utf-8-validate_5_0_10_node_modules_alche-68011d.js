/*! For license information please see node_modules_pnpm_alchemy-sdk_3_5_1_bufferutil_4_0_9_utf-8-validate_5_0_10_node_modules_alche-68011d.js.LICENSE.txt */
'use strict';
(self['webpackChunkyakkl_wallet'] = self['webpackChunkyakkl_wallet'] || []).push([
	[
		'node_modules_pnpm_alchemy-sdk_3_5_1_bufferutil_4_0_9_utf-8-validate_5_0_10_node_modules_alche-68011d'
	],
	{
			...
			(e, t, r) => {
				...
				function decode_arithmetic(e) {
					...
					while (true) {
						...
						if (t == 0) break;
						g.push(t);
						let i = p + Math.floor((A * o[t]) / n);
						let a = p + Math.floor((A * o[t + 1]) / n) - 1;
						while (((i ^ a) & u) == 0) {
							m = ((m << 1) & f) | read_bit();
							i = (i << 1) & f;
							a = ((a << 1) & f) | 1;
				...
				function read_linear_table(e, t) {
					...
					let s = read_transposed(o.length, 1 + e, t);
					return flat(
						s.map((e, t) => {
							const s = e[0],
								i = e.slice(1);
				...
				function read_emoji_trie(e) {
					...
					function read() {
						...
						let i = n == 1;
						let a = n == 2;
						return { branches: r, valid: o, fe0f: s, save: i, check: a };
					}
				}
			},
		'../../node_modules/.pnpm/@ethersproject+hash@5.7.0/node_modules/@ethersproject/hash/lib.esm/ens-normalize/include.js':
			(e, t, r) => {
				...
				function getData() {
					return (0, o.read_compressed_payload)(
						(0, n.decode)(
		...
		'../../node_modules/.pnpm/@ethersproject+hash@5.7.0/node_modules/@ethersproject/hash/lib.esm/ens-normalize/lib.js':
			(e, t, r) => {
				...
				const i = (0, o.getData)();
				const a = new Set((0, s.read_member_array)(i));
				const l = new Set((0, s.read_member_array)(i));
				const c = (0, s.read_mapped_map)(i);
				const d = (0, s.read_emoji_trie)(i);
				const u = 45;
				const h = 95;
				...
				function ens_normalize_post_check(e) {
					for (let t of e.split('.')) {
						...
						try {
							...
							if (e.length >= 4 && e.every((e) => e < 128) && e[2] === u && e[3] === u) {
				...
				function consume_emoji_reversed(e, t) {
					...
					while (a) {
						let l = e[--a];
						n =
							(r = n.branches.find((e) => e.set.has(l))) === null || r === void 0 ? void 0 : r.node;
						if (!n) break;
						if (n.save) {
							s = l;
						} else if (n.check) {
		...
		'../../node_modules/.pnpm/@ethersproject+hash@5.7.0/node_modules/@ethersproject/hash/lib.esm/namehash.js':
			(e, t, r) => {
				...
				function ensNameSplit(e) {
					const t = (0, o.toUtf8Bytes)((0, l.ens_normalize)(e));
					const r = [];
					if (e.length === 0) {
						return r;
					}
				...
				function namehash(e) {
					...
					while (r.length) {
						t = (0, s.keccak256)((0, n.concat)([t, (0, s.keccak256)(r.pop())]));
					}
				...
				function ethDefaultProvider(e) {
					const func = function (t, r) {
						...
						if (t.PocketProvider && r.pocket !== '-') {
							...
							try {
								const s = new t.PocketProvider(e, r.pocket);
								if (s.network && o.indexOf(s.network.name) === -1) {
									n.push(s);
								}
							} catch (e) {}
						}
						...
						if (t.AnkrProvider && r.ankr !== '-') {
							try {
								const o = ['ropsten'];
								const s = new t.AnkrProvider(e, r.ankr);
								if (s.network && o.indexOf(s.network.name) === -1) {
									n.push(s);
								}
							} catch (e) {}
		...
		'../../node_modules/.pnpm/@ethersproject+providers@5.7.2_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/@ethersproject/providers/lib.esm/base-provider.js':
			(e, t, r) => {
				...
				var g = r('../../node_modules/.pnpm/bech32@1.1.4/node_modules/bech32/index.js');
				var p = r.n(g);
				var A = r(
					'../../node_modules/.pnpm/@ethersproject+logger@5.7.0/node_modules/@ethersproject/logger/lib.esm/index.js'
				);
				...
				const y = new A.Logger(v.version);
				const k = 10;
				function checkTopic(e) {
					if (e == null) {
						return 'null';
					}
					if ((0, a.hexDataLength)(e) !== 32) {
				...
				function getEventTag(e) {
					...
					} else if (n.ForkEvent.isForkEvent(e)) {
				...
				class Event {
					constructor(e, t, r) {
						(0, u.defineReadOnly)(this, 'tag', e);
						(0, u.defineReadOnly)(this, 'listener', t);
						(0, u.defineReadOnly)(this, 'once', r);
				...
				function bytes32ify(e) {
					return (0, a.hexZeroPad)(i.BigNumber.from(e).toHexString(), 32);
				}
				function base58Encode(e) {
					return s.Base58.encode(
						(0, a.concat)([e, (0, a.hexDataSlice)((0, h.sha256)((0, h.sha256)(e)), 0, 4)])
					);
				}
				...
				function _parseBytes(e, t) {
					...
					const r = i.BigNumber.from((0, a.hexDataSlice)(e, t, t + 32)).toNumber();
					const n = i.BigNumber.from((0, a.hexDataSlice)(e, r, r + 32)).toNumber();
				...
				class Resolver {
					constructor(e, t, r, n) {
						(0, u.defineReadOnly)(this, 'provider', e);
						(0, u.defineReadOnly)(this, 'name', r);
						(0, u.defineReadOnly)(this, 'address', e.formatter.address(t));
						(0, u.defineReadOnly)(this, '_resolvedAddress', n);
					}
					supportsWildcard() {
						if (!this._supportsEip2544) {
							this._supportsEip2544 = this.provider
								...
								.catch((e) => {
									if (e.code === A.Logger.errors.CALL_EXCEPTION) {
										return false;
									}
					...
					_fetch(e, t) {
						return b(this, void 0, void 0, function* () {
							const r = {
								...
								data: (0, a.hexConcat)([e, (0, c.namehash)(this.name), t || '0x'])
							};
							let n = false;
							if (yield this.supportsWildcard()) {
								n = true;
								r.data = (0, a.hexConcat)([
									'0x9061b923',
							...
							try {
								...
								if ((0, a.arrayify)(e).length % 32 === 4) {
									y.throwError('resolver threw error', A.Logger.errors.CALL_EXCEPTION, {
										transaction: r,
										data: e
									});
								}
					...
					_getAddress(e, t) {
						const r = E[String(e)];
						if (r == null) {
							y.throwError(`unsupported coin type: ${e}`, A.Logger.errors.UNSUPPORTED_OPERATION, {
						...
						if (r.p2pkh != null) {
							...
							if (e) {
								...
								if (e[2].length === t * 2 && t >= 1 && t <= 75) {
									return base58Encode((0, a.concat)([[r.p2pkh], '0x' + e[2]]));
								}
							}
						}
						if (r.p2sh != null) {
							...
							if (e) {
								const t = parseInt(e[1], 16);
								if (e[2].length === t * 2 && t >= 1 && t <= 75) {
									return base58Encode((0, a.concat)([[r.p2sh], '0x' + e[2]]));
								}
							}
						}
						if (r.prefix != null) {
							...
							try {
								...
								for (let r = 0; r < B.length; r++) {
									...
									switch (o) {
										...
										case 'erc721':
										case 'erc1155': {
											const r = o === 'erc721' ? '0xc87b56dd' : '0x0e89341c';
											...
											const d = (0, a.hexZeroPad)(i.BigNumber.from(l[1]).toHexString(), 32);
											if (o === 'erc721') {
												const t = this.provider.formatter.callAddress(
													yield this.provider.call({
														to: c,
														data: (0, a.hexConcat)(['0x6352211e', d])
													})
												);
												if (s !== t) {
													return null;
												...
												const t = i.BigNumber.from(
													yield this.provider.call({
														to: c,
														data: (0, a.hexConcat)(['0x00fdd58e', (0, a.hexZeroPad)(s, 32), d])
													})
												);
												if (t.isZero()) {
													return null;
											...
											const u = {
												...
												data: (0, a.hexConcat)([r, d])
											};
											let h = _parseString(yield this.provider.call(u), 0);
											if (h == null) {
												return null;
											}
											e.push({ type: 'metadata-url-base', content: h });
											if (o === 'erc1155') {
												h = h.replace('{id}', d.substring(2));
					...
					getContentHash() {
						return b(this, void 0, void 0, function* () {
							...
							if (i) {
								if (i[1].length === 34 * 2) {
									const e = { '=': '', '+': '-', '/': '_' };
									const t = (0, o.encode)('0x' + i[1]).replace(/[=+\/]/g, (t) => e[t]);
									return 'sia://' + t;
								}
							}
							return y.throwError(
					...
					getText(e) {
						return b(this, void 0, void 0, function* () {
							...
							t = (0, a.concat)([bytes32ify(64), bytes32ify(t.length), t]);
							if (t.length % 32 !== 0) {
								t = (0, a.concat)([t, (0, a.hexZeroPad)('0x', 32 - (e.length % 32))]);
							}
				...
				class BaseProvider extends n.Provider {
					constructor(e) {
						...
						(0, u.defineReadOnly)(this, 'anyNetwork', e === 'any');
						if (this.anyNetwork) {
						...
						if (e instanceof Promise) {
							...
							const t = (0, u.getStatic)(new.target, 'getNetwork')(e);
							if (t) {
								(0, u.defineReadOnly)(this, '_network', t);
					...
					_ready() {
						return b(this, void 0, void 0, function* () {
							if (this._network == null) {
								...
								if (!e) {
									y.throwError('no network detected', A.Logger.errors.UNKNOWN_ERROR, {});
								}
								if (this._network == null) {
									if (this.anyNetwork) {
										this._network = e;
									} else {
										(0, u.defineReadOnly)(this, '_network', e);
									}
					...
					get ready() {
						return (0, m.poll)(() =>
							this._ready().then(
								(e) => e,
								(e) => {
									if (e.code === A.Logger.errors.NETWORK_ERROR && e.event === 'noNetwork') {
										return undefined;
									}
									throw e;
								}
					...
					static getNetwork(e) {
						return (0, d.getNetwork)(e == null ? 'homestead' : e);
					}
					ccipReadFetch(e, t, r) {
						return b(this, void 0, void 0, function* () {
							...
							for (let e = 0; e < r.length; e++) {
								const t = r[e];
								const i = t.replace('{sender}', n).replace('{data}', o);
								const a = t.indexOf('{data}') >= 0 ? null : JSON.stringify({ data: o, sender: n });
								const l = yield (0, m.fetchJson)({ url: i, errorPassThrough: true }, a, (e, t) => {
					...
					poll() {
						return b(this, void 0, void 0, function* () {
							...
							if (Math.abs(this._emitted.block - r) > 1e3) {
								...
								this.emit(
									'error',
									y.makeError('network block skew detected', A.Logger.errors.NETWORK_ERROR, {
										blockNumber: r,
										event: 'blockSkew',
					...
					getNetwork() {
						return b(this, void 0, void 0, function* () {
							...
							if (e.chainId !== t.chainId) {
								...
								const r = y.makeError('underlying network changed', A.Logger.errors.NETWORK_ERROR, {
									event: 'changed',
									network: e,
									detectedNetwork: t
								});
							...
							return new Promise((o, s) => {
																	...
																	if (i.from === n.from && i.nonce === n.nonce) {
																		...
																		s(
																			y.makeError(
																				...
																				A.Logger.errors.TRANSACTION_REPLACED,
																				{
								...
								if (typeof r === 'number' && r > 0) {
									const e = setTimeout(() => {
										...
										s(y.makeError('timeout exceeded', A.Logger.errors.TIMEOUT, { timeout: r }));
									}, r);
									if (e.unref) {
										e.unref();
									}
					...
					getGasPrice() {
						return b(this, void 0, void 0, function* () {
							...
							try {
								...
								return y.throwError('bad result from backend', A.Logger.errors.SERVER_ERROR, {
									method: 'getGasPrice',
									result: e,
									error: t
								});
					...
					getTransactionCount(e, t) {
						return b(this, void 0, void 0, function* () {
							...
							try {
								return i.BigNumber.from(n).toNumber();
							} catch (e) {
								return y.throwError('bad result from backend', A.Logger.errors.SERVER_ERROR, {
					...
					_wrapTransaction(e, t, r) {
						if (t != null && (0, a.hexDataLength)(t) !== 32) {
						...
						n.wait = (t, n) =>
							b(this, void 0, void 0, function* () {
								...
								const s = yield this._waitForTransaction(e.hash, t, n, o);
								if (s == null && t === 0) {
									return null;
								}
								this._emitted['t:' + e.hash] = s.blockNumber;
								if (s.status === 0) {
									y.throwError('transaction failed', A.Logger.errors.CALL_EXCEPTION, {
					...
					sendTransaction(e) {
						return b(this, void 0, void 0, function* () {
							yield this.getNetwork();
							const t = yield Promise.resolve(e).then((e) => (0, a.hexlify)(e));
					...
					_getTransactionRequest(e) {
						return b(this, void 0, void 0, function* () {
							...
							['data'].forEach((e) => {
								...
								r[e] = Promise.resolve(t[e]).then((e) => (e ? (0, a.hexlify)(e) : null));
							});
							return this.formatter.transactionRequest(yield (0, u.resolveProperties)(r));
						});
					}
					_getFilter(e) {
						return b(this, void 0, void 0, function* () {
							...
							return this.formatter.filter(yield (0, u.resolveProperties)(t));
						});
					}
					_call(e, t, r) {
						return b(this, void 0, void 0, function* () {
							...
							const n = e.to;
							const o = yield this.perform('call', { transaction: e, blockTag: t });
							if (
								r >= 0 &&
								t === 'latest' &&
								n != null &&
								...
								try {
									const s = (0, a.hexDataSlice)(o, 4);
									const l = (0, a.hexDataSlice)(s, 0, 32);
									if (!i.BigNumber.from(l).eq(n)) {
										y.throwError('CCIP Read sender did not match', A.Logger.errors.CALL_EXCEPTION, {
											name: 'OffchainLookup',
									...
									const c = [];
									const d = i.BigNumber.from((0, a.hexDataSlice)(s, 32, 64)).toNumber();
									const u = i.BigNumber.from((0, a.hexDataSlice)(s, d, d + 32)).toNumber();
									const h = (0, a.hexDataSlice)(s, d + 32);
									for (let t = 0; t < u; t++) {
										const r = _parseString(h, t * 32);
										if (r == null) {
											y.throwError(
												'CCIP Read contained corrupt URL string',
												A.Logger.errors.CALL_EXCEPTION,
												{
													name: 'OffchainLookup',
													signature: 'OffchainLookup(address,string[],bytes,bytes4,bytes)',
													transaction: e,
									...
									const f = _parseBytes(s, 64);
									if (!i.BigNumber.from((0, a.hexDataSlice)(s, 100, 128)).isZero()) {
										y.throwError(
									...
									const m = (0, a.hexDataSlice)(s, 96, 100);
									const g = _parseBytes(s, 128);
									const p = yield this.ccipReadFetch(e, f, c);
									if (p == null) {
										y.throwError(
									...
									const v = { to: n, data: (0, a.hexConcat)([m, encodeBytes([p, g])]) };
									return this._call(v, t, r + 1);
								} catch (e) {
									if (e.code === A.Logger.errors.SERVER_ERROR) {
										throw e;
									}
								}
							}
					...
					estimateGas(e) {
						return b(this, void 0, void 0, function* () {
							yield this.getNetwork();
							const t = yield (0, u.resolveProperties)({
								transaction: this._getTransactionRequest(e)
							});
					...
					_getAddress(e) {
						return b(this, void 0, void 0, function* () {
							...
							if (t == null) {
								y.throwError('ENS name not configured', A.Logger.errors.UNSUPPORTED_OPERATION, {
					...
					_getBlock(e, t) {
						return b(this, void 0, void 0, function* () {
							...
							if ((0, a.isHexString)(e, 32)) {
								n.blockHash = e;
							} else {
								try {
									n.blockTag = yield this._getBlockTag(e);
									if ((0, a.isHexString)(n.blockTag)) {
					...
					getLogs(e) {
						return b(this, void 0, void 0, function* () {
							yield this.getNetwork();
							const t = yield (0, u.resolveProperties)({ filter: this._getFilter(e) });
							...
							return w.Formatter.arrayOf(this.formatter.filterLog.bind(this.formatter))(r);
						});
					}
					getEtherPrice() {
						return b(this, void 0, void 0, function* () {
							...
							if ((0, a.isHexString)(e)) {
								...
								try {
									const e = _parseString(
										yield this.call({
											to: o,
											data: '0x691f3431' + (0, c.namehash)(n).substring(2)
										}),
										0
									);
					...
					perform(e, t) {
						return y.throwError(e + ' not implemented', A.Logger.errors.NOT_IMPLEMENTED, {
							operation: e
						});
					}
					_startEvent(e) {
		...
		'../../node_modules/.pnpm/@ethersproject+providers@5.7.2_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/@ethersproject/providers/lib.esm/formatter.js':
			(e, t, r) => {
				...
				const u = new c.Logger(d.version);
				class Formatter {
					constructor() {
					...
					getDefaultFormats() {
						...
						e.filter = {
							...
							blockHash: Formatter.allowNull(s, undefined),
					...
					number(e) {
						...
						return o.BigNumber.from(e).toNumber();
					}
					type(e) {
						if (e === '0x' || e == null) {
							return 0;
					...
					hex(e, t) {
						...
						return u.throwArgumentError('invalid hash', 'value', e);
					}
					data(e, t) {
					...
					callAddress(e) {
						if (!(0, s.isHexString)(e, 32)) {
							return null;
						}
						const t = (0, n.getAddress)((0, s.hexDataSlice)(e, 12));
					...
					blockTag(e) {
						...
						if (typeof e === 'number' || (0, s.isHexString)(e)) {
					...
					_block(e, t) {
						...
						n._difficulty = r == null ? null : o.BigNumber.from(r);
						return n;
					}
					block(e) {
					...
					transactionResponse(e) {
						...
						if (e.to && o.BigNumber.from(e.to).isZero()) {
					...
					receipt(e) {
						...
						if (t.root != null) {
							if (t.root.length <= 4) {
								const e = o.BigNumber.from(t.root).toNumber();
								if (e === 0 || e === 1) {
									if (t.status != null && t.status !== e) {
										u.throwArgumentError('alt-root-status/status mismatch', 'value', {
											root: t.root,
											status: t.status
										});
									}
									...
									u.throwArgumentError('invalid alt-root-status', 'value.root', t.root);
								}
							} else if (t.root.length !== 66) {
								u.throwArgumentError('invalid root hash', 'value.root', t.root);
							}
						}
						if (t.status != null) {
							t.byzantium = true;
			...
			(e, t, r) => {
				...
				function spelunk(e, t) {
					...
					if (typeof e.message === 'string' && e.message.match('reverted')) {
						const r = (0, s.isHexString)(e.data) ? e.data : null;
						if (!t || r) {
				...
				function checkError(e, t, r) {
					...
					if (o.match(/nonce (is )?too low/i)) {
						g.throwError('nonce has already been used', u.Logger.errors.NONCE_EXPIRED, {
							error: t,
							method: e,
							transaction: n
						});
					...
					if (o.match(/replacement transaction underpriced|transaction gas price.*too low/i)) {
						g.throwError('replacement fee too low', u.Logger.errors.REPLACEMENT_UNDERPRICED, {
							error: t,
							method: e,
							transaction: n
						});
				...
				const A = {};
				class JsonRpcSigner extends n.Signer {
					constructor(e, t, r) {
						super();
						if (e !== A) {
							throw new Error(
						...
						if (typeof r === 'string') {
							(0, a.defineReadOnly)(this, '_address', this.provider.formatter.address(r));
							(0, a.defineReadOnly)(this, '_index', null);
						} else if (typeof r === 'number') {
							(0, a.defineReadOnly)(this, '_index', r);
							(0, a.defineReadOnly)(this, '_address', null);
						} else {
							g.throwArgumentError('invalid address or index', 'addressOrIndex', r);
						}
					}
					connect(e) {
						return g.throwError(
					...
					connectUnchecked() {
						return new UncheckedJsonRpcSigner(A, this.provider, this._address || this._index);
					}
					getAddress() {
						if (this._address) {
						...
						if (e.to != null) {
							e.to = Promise.resolve(e.to).then((e) =>
								m(this, void 0, void 0, function* () {
									...
									if (t == null) {
										g.throwArgumentError('provided ENS name resolves to null', 'tx.to', e);
									}
									return t;
								})
							);
						}
						return (0, a.resolveProperties)({ tx: (0, a.resolveProperties)(e), sender: t }).then(
							({ tx: t, sender: r }) => {
								if (t.from != null) {
									if (t.from.toLowerCase() !== r) {
										g.throwArgumentError('from address mismatch', 'transaction', e);
									}
								} else {
									t.from = r;
								}
								...
								return this.provider.send('eth_sendTransaction', [n]).then(
									...
									(e) => {
										if (typeof e.message === 'string' && e.message.match(/user denied/i)) {
											g.throwError('user rejected transaction', u.Logger.errors.ACTION_REJECTED, {
					...
					signMessage(e) {
						return m(this, void 0, void 0, function* () {
							const t = typeof e === 'string' ? (0, l.toUtf8Bytes)(e) : e;
							...
							try {
								...
								if (typeof t.message === 'string' && t.message.match(/user denied/i)) {
									g.throwError('user rejected signing', u.Logger.errors.ACTION_REJECTED, {
										action: 'signMessage',
										from: r,
										messageData: e
									});
					...
					_legacySignMessage(e) {
						return m(this, void 0, void 0, function* () {
							...
							const r = yield this.getAddress();
							try {
								return yield this.provider.send('eth_sign', [r.toLowerCase(), (0, s.hexlify)(t)]);
							} catch (t) {
								if (typeof t.message === 'string' && t.message.match(/user denied/i)) {
									g.throwError('user rejected signing', u.Logger.errors.ACTION_REJECTED, {
					...
					_signTypedData(e, t, r) {
						return m(this, void 0, void 0, function* () {
							const n = yield i.TypedDataEncoder.resolveNames(e, t, r, (e) =>
							...
							try {
								return yield this.provider.send('eth_signTypedData_v4', [
									o.toLowerCase(),
									JSON.stringify(i.TypedDataEncoder.getPayload(n.domain, t, n.value))
								]);
							} catch (e) {
								if (typeof e.message === 'string' && e.message.match(/user denied/i)) {
									g.throwError('user rejected signing', u.Logger.errors.ACTION_REJECTED, {
				...
				class JsonRpcProvider extends f.BaseProvider {
					constructor(e, t) {
						...
						super(r);
						if (!e) {
							e = (0, a.getStatic)(this.constructor, 'defaultUrl')();
						}
						if (typeof e === 'string') {
							(0, a.defineReadOnly)(this, 'connection', Object.freeze({ url: e }));
						} else {
							(0, a.defineReadOnly)(this, 'connection', Object.freeze((0, a.shallowCopy)(e)));
						}
						this._nextId = 42;
					}
					get _cache() {
					...
					_uncachedDetectNetwork() {
						return m(this, void 0, void 0, function* () {
							...
							if (e != null) {
								...
								try {
									return t(o.BigNumber.from(e).toNumber());
								} catch (t) {
									return g.throwError('could not detect network', u.Logger.errors.NETWORK_ERROR, {
										chainId: e,
					...
					getSigner(e) {
						return new JsonRpcSigner(A, this, e);
					}
					...
					send(e, t) {
						...
						const o = (0, d.fetchJson)(this.connection, JSON.stringify(r), getResult).then(
							(e) => {
					...
					prepareRequest(e, t) {
						switch (e) {
							...
							case 'getStorageAt':
								return [
									'eth_getStorageAt',
									[getLowerCase(t.address), (0, s.hexZeroPad)(t.position, 32), t.blockTag]
								];
							...
							case 'call': {
								const e = (0, a.getStatic)(this.constructor, 'hexlifyTransaction');
					...
					perform(e, t) {
						return m(this, void 0, void 0, function* () {
							if (e === 'call' || e === 'estimateGas') {
								...
								if (e && e.type != null && o.BigNumber.from(e.type).isZero()) {
							...
							if (r == null) {
								g.throwError(e + ' not implemented', u.Logger.errors.NOT_IMPLEMENTED, {
									operation: e
								});
							}
							try {
					...
					static hexlifyTransaction(e, t) {
						...
						[
							...
							const r = (0, s.hexValue)(o.BigNumber.from(e[t]));
							if (t === 'gasLimit') {
								t = 'gas';
							}
							n[t] = r;
						...
						if (e.accessList) {
							n['accessList'] = (0, c.accessListify)(e.accessList);
						}
						return n;
					}
				}
		...
		'../../node_modules/.pnpm/alchemy-sdk@3.5.1_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/alchemy-sdk/dist/esm/alchemy-provider-8b0c3e20.js':
			(e, t, r) => {
				...
				class AlchemyProvider extends s.JsonRpcProvider {
					constructor(e) {
						...
						const sendBatchFn = (e) => (0, i.fetchJson)(a, JSON.stringify(e));
					...
					_send(e, t, r, o = false) {
						...
						this.emit('debug', { action: 'request', request: (0, n.d)(s), provider: this });
						const l = ['eth_chainId', 'eth_blockNumber'].indexOf(e) >= 0;
						if (l && this._cache[e]) {
							return this._cache[e];
						}
						const c = (0, i.fetchJson)(this.connection, JSON.stringify(s), getResult).then(
							(e) => {
								this.emit('debug', { action: 'response', request: s, response: e, provider: this });
								return e;
							},
							(e) => {
								this.emit('debug', { action: 'response', error: e, request: s, provider: this });
								throw e;
							}
						);
						if (l) {
		...
		'../../node_modules/.pnpm/bech32@1.1.4/node_modules/bech32/index.js': (e) => {
			...
			function __decode(e, t) {
				...
				for (var d = 0; d < a.length; ++d) {
					var u = a.charAt(d);
					var h = r[u];
					if (h === undefined) return 'Unknown character ' + u;
					l = polymodStep(l) ^ h;
					if (d + 6 >= a.length) continue;
					c.push(h);
				}
			...
			function convert(e, t, r, n) {
				...
				if (n) {
					...
					if ((o << (r - s)) & i) return 'Non-zero padding';
				}
				return a;
			}
...
//# sourceMappingURL=node_modules_pnpm_alchemy-sdk_3_5_1_bufferutil_4_0_9_utf-8-validate_5_0_10_node_modules_alche-68011d.js.map

(self['webpackChunkwallet'] = self['webpackChunkwallet'] || []).push([
	[154],
	{
		/***/ 1154: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			// EXTERNAL MODULE: ../../node_modules/alchemy-sdk/dist/esm/index-bb84a433.js + 21 modules
			var index_bb84a433 = __webpack_require__(6330);
			...
			// EXTERNAL MODULE: ../../node_modules/alchemy-sdk/dist/esm/alchemy-provider-c13827af.js
			var alchemy_provider_c13827af = __webpack_require__(7092);
			// EXTERNAL MODULE: ../../node_modules/axios/index.js
			var axios = __webpack_require__(6660); // CONCATENATED MODULE: ../../node_modules/alchemy-sdk/dist/esm/alchemy-websocket-provider-76d152e7.js
			...
			class WebsocketBackfiller {
				...
				getNewHeadsBackfill(isCancelled, previousHeads, fromBlockNumber) {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						// new heads.
						const lastSeenBlockNumber = (0, index_bb84a433.f)(
				...
				getLogsBackfill(isCancelled, filter, previousLogs, fromBlockNumber) {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						const removedLogs = previousLogs
							.filter((log) => (0, index_bb84a433.f)(log.blockNumber) > commonAncestor.blockNumber)
						...
						const fromBlockInclusive =
							commonAncestor.blockNumber === Number.NEGATIVE_INFINITY
								? (0, index_bb84a433.f)(previousLogs[0].blockNumber)
						...
						addedLogs = addedLogs.filter(
							(log) =>
								log &&
								((0, index_bb84a433.f)(log.blockNumber) > commonAncestor.blockNumber ||
									(0, index_bb84a433.f)(log.logIndex) > commonAncestor.logIndex)
						);
						throwIfCancelled(isCancelled);
				...
				getBlockNumber() {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						return (0, index_bb84a433.f)(blockNumberHex);
					});
				}
				/**
					...
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						for (let i = fromBlockInclusive; i < toBlockExclusive; i++) {
							batchParts.push({
								...
								params: [(0, index_bb84a433.t)(i), false]
							});
						}
						// TODO: handle errors
				...
				getReorgHeads(isCancelled, previousHeads) {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						for (let i = previousHeads.length - 1; i >= 0; i--) {
							...
							const blockHead = yield this.getBlockByNumber((0, index_bb84a433.f)(oldEvent.number));
							throwIfCancelled(isCancelled);
				...
				getBlockByNumber(blockNumber) {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						return this.provider.send('eth_getBlockByNumber', [
							(0, index_bb84a433.t)(blockNumber),
							false
						]);
					});
				}
				...
				getCommonAncestor(isCancelled, previousLogs) {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						let blockHead = yield this.getBlockByNumber(
							(0, index_bb84a433.f)(previousLogs[previousLogs.length - 1].blockNumber)
						);
						throwIfCancelled(isCancelled);
						for (let i = previousLogs.length - 1; i >= 0; i--) {
							...
							if (oldLog.blockNumber !== blockHead.number) {
								blockHead = yield this.getBlockByNumber((0, index_bb84a433.f)(oldLog.blockNumber));
							}
							// Since logs are ordered in ascending order, the first log that matches
							// the hash should be the largest logIndex.
							if (oldLog.blockHash === blockHead.hash) {
								return {
									blockNumber: (0, index_bb84a433.f)(oldLog.blockNumber),
									logIndex: (0, index_bb84a433.f)(oldLog.logIndex)
								};
							}
						}
						return {
				 ...
				 */ getLogsInRange(filter, fromBlockInclusive, toBlockExclusive) {
					return (0, index_bb84a433._)(this, void 0, void 0, function* () {
						...
						const rangeFilter = Object.assign(Object.assign({}, filter), {
							fromBlock: (0, index_bb84a433.t)(fromBlockInclusive),
							toBlock: (0, index_bb84a433.t)(toBlockExclusive - 1)
						});
			...
			class AlchemyWebSocketProvider extends WebSocketProvider {
				...
				constructor(config, wsConstructor) {
					...
					const apiKey = alchemy_provider_c13827af.AlchemyProvider.getApiKey(config.apiKey);
					// Generate our own connection info with the correct endpoint URLs.
					const alchemyNetwork = alchemy_provider_c13827af.AlchemyProvider.getAlchemyNetwork(
						config.network
					);
					const connection = alchemy_provider_c13827af.AlchemyProvider.getAlchemyConnectionInfo(
						alchemyNetwork,
						apiKey,
						'wss'
					);
					const protocol = `alchemy-sdk-${index_bb84a433.V}`;
					...
					const ethersNetwork = index_bb84a433.E[alchemyNetwork];
					...
					this.handleReopen = () => {
						...
						for (const subscription of this.virtualSubscriptionsById.values()) {
							void (() =>
								(0, index_bb84a433._)(this, void 0, void 0, function* () {
									try {
					...
					this.startHeartbeat();
					this.cancelBackfill = index_bb84a433.n;
				}
				/**
				...
				static getNetwork(network) {
					if (typeof network === 'string' && network in index_bb84a433.C) {
						return index_bb84a433.C[network];
					}
				...
				off(eventName, listener) {
					if ((0, index_bb84a433.i)(eventName)) {
				...
				removeAllListeners(eventName) {
					if (eventName !== undefined && (0, index_bb84a433.i)(eventName)) {
				...
				_addEventListener(eventName, listener, once) {
					if ((0, index_bb84a433.i)(eventName)) {
						(0, index_bb84a433.v)(eventName);
						const event = new index_bb84a433.c((0, index_bb84a433.e)(eventName), listener, once);
				...
				_startEvent(event) {
					...
					const customLogicTypes = [...index_bb84a433.A, 'block', 'filter'];
				...
				emit(eventName, ...args) {
					if ((0, index_bb84a433.i)(eventName)) {
						...
						const eventTag = (0, index_bb84a433.e)(eventName);
				 ...
				 */
				isCommunityResource() {
					return this.apiKey === index_bb84a433.D;
				}
				/**
				 * DO NOT MODIFY.
				 *
				...
				_stopEvent(event) {
					let tag = event.tag;
					// START MODIFIED CODE
					if (index_bb84a433.A.includes(event.type)) {
						// There are remaining pending transaction listeners.
						if (this._events.filter((e) => index_bb84a433.A.includes(e.type)).length) {
							return;
						}
						// END MODIFIED CODE
				...
				customStartEvent(event) {
					if (event.type === index_bb84a433.h) {
						const { fromAddress, toAddress, hashesOnly } = event;
						void this._subscribe(
							event.tag,
							[index_bb84a433.j.PENDING_TRANSACTIONS, { fromAddress, toAddress, hashesOnly }],
							this.emitProcessFn(event),
							event
						);
					} else if (event.type === index_bb84a433.k) {
						const { addresses, includeRemoved, hashesOnly } = event;
						void this._subscribe(
							event.tag,
							[index_bb84a433.j.MINED_TRANSACTIONS, { addresses, includeRemoved, hashesOnly }],
							this.emitProcessFn(event),
							event
						);
				...
				emitProcessFn(event) {
					switch (event.type) {
						case index_bb84a433.h:
							return (result) =>
								this.emit(
									{
										method: index_bb84a433.j.PENDING_TRANSACTIONS,
						...
						case index_bb84a433.k:
							return (result) =>
								this.emit(
									{
										method: index_bb84a433.j.MINED_TRANSACTIONS,
			...
			function getNewHeadsBlockNumber(event) {
				return (0, index_bb84a433.f)(event.number);
			}
			function getLogsBlockNumber(event) {
				return (0, index_bb84a433.f)(event.blockNumber);
			}

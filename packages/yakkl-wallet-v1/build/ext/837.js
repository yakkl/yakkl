(self['webpackChunkwallet'] = self['webpackChunkwallet'] || []).push([
	[837],
	{
		/***/ 5837: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			'use strict';
			// ESM COMPAT FLAG
			...
			// EXTERNAL MODULE: ../../node_modules/.pnpm/alchemy-sdk@3.5.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/alchemy-sdk/dist/esm/index-87e431aa.js + 70 modules
			var index_87e431aa = __webpack_require__(1331);
			// EXTERNAL MODULE: ../../node_modules/.pnpm/sturdy-websocket@0.2.1/node_modules/sturdy-websocket/dist/index.js
			var dist = __webpack_require__(7120);
			...
			var lib_esm = __webpack_require__(9187);
			...
			// EXTERNAL MODULE: ../../node_modules/.pnpm/@ethersproject+providers@5.7.2_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/@ethersproject/providers/lib.esm/json-rpc-provider.js + 8 modules
			var json_rpc_provider = __webpack_require__(1015);
			...
			var _version = __webpack_require__(2406); // ../../node_modules/.pnpm/@ethersproject+providers@5.7.2_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/@ethersproject/providers/lib.esm/ws.js
			let WS = null;
			try {
				WS = WebSocket;
				if (WS == null) {
			...
			// EXTERNAL MODULE: ../../node_modules/.pnpm/alchemy-sdk@3.5.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/alchemy-sdk/dist/esm/alchemy-provider-ffcaaa67.js
			var alchemy_provider_ffcaaa67 = __webpack_require__(2434); // ../../node_modules/.pnpm/alchemy-sdk@3.5.0_bufferutil@4.0.9_utf-8-validate@5.0.10/node_modules/alchemy-sdk/dist/esm/alchemy-websocket-provider-c488fef1.js
			...
			class WebsocketBackfiller {
				...
				getNewHeadsBackfill(isCancelled, previousHeads, fromBlockNumber) {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						// new heads.
						const lastSeenBlockNumber = (0, index_87e431aa.f)(
				...
				getLogsBackfill(isCancelled, filter, previousLogs, fromBlockNumber) {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						const removedLogs = previousLogs
							.filter((log) => (0, index_87e431aa.f)(log.blockNumber) > commonAncestor.blockNumber)
						...
						const fromBlockInclusive =
							commonAncestor.blockNumber === Number.NEGATIVE_INFINITY
								? (0, index_87e431aa.f)(previousLogs[0].blockNumber)
						...
						addedLogs = addedLogs.filter(
							(log) =>
								log &&
								((0, index_87e431aa.f)(log.blockNumber) > commonAncestor.blockNumber ||
									(0, index_87e431aa.f)(log.logIndex) > commonAncestor.logIndex)
						);
						throwIfCancelled(isCancelled);
				...
				getBlockNumber() {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						return (0, index_87e431aa.f)(blockNumberHex);
					});
				}
				/**
					...
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						for (let i = fromBlockInclusive; i < toBlockExclusive; i++) {
							batchParts.push({
								...
								params: [(0, index_87e431aa.t)(i), false]
							});
						}
						// TODO: handle errors
				...
				getReorgHeads(isCancelled, previousHeads) {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						for (let i = previousHeads.length - 1; i >= 0; i--) {
							...
							const blockHead = yield this.getBlockByNumber((0, index_87e431aa.f)(oldEvent.number));
							throwIfCancelled(isCancelled);
				...
				getBlockByNumber(blockNumber) {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						return this.provider.send('eth_getBlockByNumber', [
							(0, index_87e431aa.t)(blockNumber),
							false
						]);
					});
				}
				...
				getCommonAncestor(isCancelled, previousLogs) {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						let blockHead = yield this.getBlockByNumber(
							(0, index_87e431aa.f)(previousLogs[previousLogs.length - 1].blockNumber)
						);
						throwIfCancelled(isCancelled);
						for (let i = previousLogs.length - 1; i >= 0; i--) {
							...
							if (oldLog.blockNumber !== blockHead.number) {
								blockHead = yield this.getBlockByNumber((0, index_87e431aa.f)(oldLog.blockNumber));
							}
							// Since logs are ordered in ascending order, the first log that matches
							// the hash should be the largest logIndex.
							if (oldLog.blockHash === blockHead.hash) {
								return {
									blockNumber: (0, index_87e431aa.f)(oldLog.blockNumber),
									logIndex: (0, index_87e431aa.f)(oldLog.logIndex)
								};
							}
						}
						return {
				 ...
				 */ getLogsInRange(filter, fromBlockInclusive, toBlockExclusive) {
					return (0, index_87e431aa._)(this, void 0, void 0, function* () {
						...
						const rangeFilter = Object.assign(Object.assign({}, filter), {
							fromBlock: (0, index_87e431aa.t)(fromBlockInclusive),
							toBlock: (0, index_87e431aa.t)(toBlockExclusive - 1)
						});
			...
			class AlchemyWebSocketProvider extends WebSocketProvider {
				...
				constructor(config, wsConstructor) {
					...
					const apiKey = alchemy_provider_ffcaaa67.AlchemyProvider.getApiKey(config.apiKey);
					// Generate our own connection info with the correct endpoint URLs.
					const alchemyNetwork = alchemy_provider_ffcaaa67.AlchemyProvider.getAlchemyNetwork(
						config.network
					);
					const connection = alchemy_provider_ffcaaa67.AlchemyProvider.getAlchemyConnectionInfo(
						alchemyNetwork,
						apiKey,
						'wss'
					);
					const protocol = `alchemy-sdk-${index_87e431aa.V}`;
					...
					const ethersNetwork = index_87e431aa.E[alchemyNetwork];
					...
					this.handleReopen = () => {
						...
						for (const subscription of this.virtualSubscriptionsById.values()) {
							void (() =>
								(0, index_87e431aa._)(this, void 0, void 0, function* () {
									try {
					...
					this.startHeartbeat();
					this.cancelBackfill = index_87e431aa.n;
				}
				/**
				...
				static getNetwork(network) {
					if (typeof network === 'string' && network in index_87e431aa.C) {
						return index_87e431aa.C[network];
					}
				...
				off(eventName, listener) {
					if ((0, index_87e431aa.i)(eventName)) {
				...
				removeAllListeners(eventName) {
					if (eventName !== undefined && (0, index_87e431aa.i)(eventName)) {
				...
				_addEventListener(eventName, listener, once) {
					if ((0, index_87e431aa.i)(eventName)) {
						(0, index_87e431aa.v)(eventName);
						const event = new index_87e431aa.c((0, index_87e431aa.e)(eventName), listener, once);
				...
				_startEvent(event) {
					...
					const customLogicTypes = [...index_87e431aa.A, 'block', 'filter'];
				...
				emit(eventName, ...args) {
					if ((0, index_87e431aa.i)(eventName)) {
						...
						const eventTag = (0, index_87e431aa.e)(eventName);
				 ...
				 */
				isCommunityResource() {
					return this.apiKey === index_87e431aa.D;
				}
				/**
				 * DO NOT MODIFY.
				 *
				...
				_stopEvent(event) {
					let tag = event.tag;
					// START MODIFIED CODE
					if (index_87e431aa.A.includes(event.type)) {
						// There are remaining pending transaction listeners.
						if (this._events.filter((e) => index_87e431aa.A.includes(e.type)).length) {
							return;
						}
						// END MODIFIED CODE
				...
				customStartEvent(event) {
					if (event.type === index_87e431aa.h) {
						const { fromAddress, toAddress, hashesOnly } = event;
						void this._subscribe(
							event.tag,
							[index_87e431aa.j.PENDING_TRANSACTIONS, { fromAddress, toAddress, hashesOnly }],
							this.emitProcessFn(event),
							event
						);
					} else if (event.type === index_87e431aa.k) {
						const { addresses, includeRemoved, hashesOnly } = event;
						void this._subscribe(
							event.tag,
							[index_87e431aa.j.MINED_TRANSACTIONS, { addresses, includeRemoved, hashesOnly }],
							this.emitProcessFn(event),
							event
						);
				...
				emitProcessFn(event) {
					switch (event.type) {
						case index_87e431aa.h:
							return (result) =>
								this.emit(
									{
										method: index_87e431aa.j.PENDING_TRANSACTIONS,
						...
						case index_87e431aa.k:
							return (result) =>
								this.emit(
									{
										method: index_87e431aa.j.MINED_TRANSACTIONS,
			...
			function getWebsocketConstructor() {
				return isNodeEnvironment() ? __webpack_require__(4385).w3cwebsocket : WebSocket;
			}
			...
			function getNewHeadsBlockNumber(event) {
				return (0, index_87e431aa.f)(event.number);
			}
			function getLogsBlockNumber(event) {
				return (0, index_87e431aa.f)(event.blockNumber);
			}
		...
		/***/ 7120: /***/ (__unused_webpack_module, exports) => {
			'use strict';
		...
		/***/ 4385: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
			var _globalThis;
			if (typeof globalThis === 'object') {
				_globalThis = globalThis;
			} else {
				try {
					_globalThis = __webpack_require__(5888);
				} catch (error) {
				} finally {
			...
			var websocket_version = __webpack_require__(9793);
		...
		/***/ 9793: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
			module.exports = __webpack_require__(2214).version;

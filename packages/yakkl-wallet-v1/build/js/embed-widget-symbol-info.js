	...
	(() => {
		...
		class u {
			...
			_replaceScript(r) {
				...
				const u = s.nonce || s.getAttribute('nonce'),
					m = (function (t) {
				...
				(this.iframe = this._createIframe(C, c, a, E, P)),
				...
				if (
					(I
						? ((0, t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I), s?.remove())
						: f
		...
		new (class extends u {
			...
			filterRawSettings(t) {
				...
				return void 0 === e.height && (e.height = 203 + (e.isTransparent ? 0 : 2)), e;
			}

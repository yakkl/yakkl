...
<!-- overflow-scroll  -->
<div
	class="relative pl-1 pr-1 m-1 ml-2 mr-2 bg-gradient-to-b from-indigo-900 to-indigo-700/80 rounded-xl"
>
	<main class="mt-1 max-w-7xl pl-1 pr-1">
		...
		<div
			class="mt-1 mr-2 mb-2 w-full h-[564px] text-xs p-2 border border-1 text-gray-100 border-black dark:border-white dark:text-white overflow-scroll"
		>
		...
		<div class="mt-2 mb-2">
			...
			<svg
				...
				viewBox="0 0 24 24"
				stroke-width="1.5"
				class="stroke-white animate-bounce w-6 h-6 -ml-1 inline-block"
			>
				<path
			...
			<label class="inline-block text-white dark:text-white font-bold" for="terms"
				>I have read and agree to the terms of service</label
			>
		</div>
		<div class="text-xs text-gray-100 dark:text-white mb-10">
			By checking the box above you are agreeing to our terms of service. Disclaimer and Privacy
			Policy can be found at yakkl.com. If you do not agree with the terms of service then you may
			close YAKKL® Smart Wallet and remove it.
		</div>
	</main>
</div>

...
(self['webpackChunkyakkl_wallet'] = self['webpackChunkyakkl_wallet'] || []).push([
	[399],
	{
				...
				const func = function (t, r) {
					...
					if (t.PocketProvider && r.pocket !== '-') {
						...
						try {
							...
							if (i.network && o.indexOf(i.network.name) === -1) {
								n.push(i);
							}
						} catch (e) {}
					}
					...
					if (t.AnkrProvider && r.ankr !== '-') {
						try {
							const o = ['ropsten'];
							const i = new t.AnkrProvider(e, r.ankr);
							if (i.network && o.indexOf(i.network.name) === -1) {
								n.push(i);
							}
						} catch (e) {}
					...
					if (t.FallbackProvider) {
						...
						return new t.FallbackProvider(n, o);
					}
					return n[0];
				};
			...
			function getNetwork(e) {
				...
				if (!t) {
					if (typeof e.chainId !== 'number') {
						i.throwArgumentError('invalid network chainId', 'network', e);
					}
					return e;
				}
				if (e.chainId !== 0 && e.chainId !== t.chainId) {
					i.throwArgumentError('network chainId mismatch', 'network', e);
				}
		...
		1015: (e, t, r) => {
			...
			function decode_arithmetic(e) {
				...
				while (true) {
					...
					if (t == 0) break;
					A.push(t);
					let s = g + Math.floor((p * o[t]) / n);
					let a = g + Math.floor((p * o[t + 1]) / n) - 1;
					while (((s ^ a) & h) == 0) {
						m = ((m << 1) & f) | read_bit();
						s = (s << 1) & f;
						a = ((a << 1) & f) | 1;
				...
				return A.map((t) => {
					switch (t - w) {
						case 3:
							return w + 65792 + ((e[s++] << 16) | (e[s++] << 8) | e[s++]);
						case 2:
			...
			function read_ascending(e, t) {
				let r = Array(e);
				for (let n = 0, o = -1; n < e; n++) r[n] = o += 1 + t();
				return r;
			}
			function read_deltas(e, t) {
				let r = Array(e);
				for (let n = 0, o = 0; n < e; n++) r[n] = o += signed(t());
				return r;
			}
			function read_member_array(e, t) {
				let r = read_ascending(e(), e);
				let n = e();
				let o = read_ascending(n, e);
				let i = read_counts(n, e);
				for (let e = 0; e < n; e++) {
					for (let t = 0; t < i[e]; t++) {
						r.push(o[e] + t);
					}
			...
			function read_linear_table(e, t) {
				let r = 1 + t();
				let n = t();
				let o = read_zero_terminated_array(t);
				let i = read_transposed(o.length, 1 + e, t);
				return flat(
					i.map((e, t) => {
						const i = e[0],
							s = e.slice(1);
			...
			function read_emoji_trie(e) {
				...
				function read() {
					...
					let s = n == 1;
					let a = n == 2;
					return { branches: r, valid: o, fe0f: i, save: s, check: a };
				}
			}
			function getData() {
			...
			const y = getData();
			const v = new Set(read_member_array(y));
			const k = new Set(read_member_array(y));
			const b = read_mapped_map(y);
			const E = read_emoji_trie(y);
			const N = 45;
			const B = 95;
			...
			function ens_normalize_post_check(e) {
				for (let t of e.split('.')) {
					let e = explode_cp(t);
					try {
						for (let t = e.lastIndexOf(B) - 1; t >= 0; t--) {
							if (e[t] !== B) {
			...
			function namehash(e) {
				if (typeof e !== 'string') {
					_.throwArgumentError('invalid ENS name; not a string', 'name', e);
				}
				let t = C;
				const r = ensNameSplit(e);
				while (r.length) {
					t = (0, p.S)((0, i.xW)([t, (0, p.S)(r.pop())]));
				}
				return (0, i.c$)(t);
			}
			...
			class Formatter {
				...
				getDefaultFormats() {
					...
					const o = this.data.bind(this);
					const i = this.hash.bind(this);
					...
					e.receipt = {
						...
						gasUsed: r,
						logsBloom: Formatter.allowNull(o),
						blockHash: i,
						transactionHash: i,
					...
					e.filter = {
						...
						blockHash: Formatter.allowNull(i, undefined),
					...
					e.filterLog = {
						...
						address: t,
						data: Formatter.allowFalsish(o, '0x'),
						topics: Formatter.arrayOf(i),
						transactionHash: i,
						logIndex: l
					};
				...
				_block(e, t) {
					...
					n._difficulty = r == null ? null : o.gH.from(r);
					return n;
				}
				block(e) {
				...
				receipt(e) {
					...
					if (t.root != null) {
						if (t.root.length <= 4) {
							const e = o.gH.from(t.root).toNumber();
							if (e === 0 || e === 1) {
			...
			function checkTopic(e) {
				...
				if ((0, i.cm)(e) !== 32) {
					S.throwArgumentError('invalid topic', 'topic', e);
				}
				return e.toLowerCase();
			}
			...
			const Q = ['block', 'network', 'pending', 'poll'];
			class Event {
				constructor(e, t, r) {
					(0, a.yY)(this, 'tag', e);
				...
				pollable() {
					return this.tag.indexOf(':') >= 0 || Q.indexOf(this.tag) >= 0;
				}
			}
			const U = {
			...
			function bytes32ify(e) {
				return (0, i.bj)(o.gH.from(e).toHexString(), 32);
			}
			function base58Encode(e) {
				return A.zn.encode((0, i.xW)([e, (0, i.Ab)((0, I.sc)((0, I.sc)(e)), 0, 4)]));
			}
			const Y = new RegExp('^(ipfs)://(.*)$', 'i');
			const M = [
				new RegExp('^(https)://(.*)$', 'i'),
				new RegExp('^(data):(.*)$', 'i'),
				Y,
			...
			function _parseBytes(e, t) {
				...
				const r = o.gH.from((0, i.Ab)(e, t, t + 32)).toNumber();
				const n = o.gH.from((0, i.Ab)(e, r, r + 32)).toNumber();
				return (0, i.Ab)(e, r + 32, r + 32 + n);
			}
			function getIpfsLink(e) {
				if (e.match(/^ipfs:\/\/ipfs\//i)) {
					...
					S.throwArgumentError('unsupported IPFS format', 'link', e);
				}
			...
			function encodeBytes(e) {
				...
				for (let n = 0; n < e.length; n++) {
					const o = (0, i.k9)(e[n]);
					t[n] = numPad(r);
					t.push(numPad(o.length));
					t.push(bytesPad(o));
					r += 32 + Math.ceil(o.length / 32) * 32;
				}
				return (0, i.qn)(t);
			}
			class Resolver {
				...
				_fetch(e, t) {
					return L(this, void 0, void 0, function* () {
						const r = {
							...
							data: (0, i.qn)([e, namehash(this.name), t || '0x'])
						};
						let n = false;
						if (yield this.supportsWildcard()) {
							n = true;
							r.data = (0, i.qn)(['0x9061b923', encodeBytes([dnsEncode(this.name), r.data])]);
						}
						try {
							let e = yield this.provider.call(r);
							if ((0, i.k9)(e).length % 32 === 4) {
								S.throwError('resolver threw error', h.Vy.errors.CALL_EXCEPTION, {
									transaction: r,
									data: e
								});
							}
				...
				_getAddress(e, t) {
					const r = U[String(e)];
					if (r == null) {
						S.throwError(`unsupported coin type: ${e}`, h.Vy.errors.UNSUPPORTED_OPERATION, {
					...
					if (r.p2pkh != null) {
						...
						if (e) {
							...
							if (e[2].length === t * 2 && t >= 1 && t <= 75) {
								return base58Encode((0, i.xW)([[r.p2pkh], '0x' + e[2]]));
							}
						}
					}
					if (r.p2sh != null) {
						...
						if (e) {
							const t = parseInt(e[1], 16);
							if (e[2].length === t * 2 && t >= 1 && t <= 75) {
								return base58Encode((0, i.xW)([[r.p2sh], '0x' + e[2]]));
							}
						}
					}
					if (r.prefix != null) {
				...
				getAddress(e) {
					return L(this, void 0, void 0, function* () {
						...
						if (r == null) {
							S.throwError(`invalid or unsupported coin data`, h.Vy.errors.UNSUPPORTED_OPERATION, {
								operation: `getAddress(${e})`,
								coinType: e,
								data: t
							});
						...
						try {
							...
							for (let r = 0; r < M.length; r++) {
								...
								switch (s) {
									...
									case 'erc721':
									case 'erc1155': {
										const r = s === 'erc721' ? '0xc87b56dd' : '0x0e89341c';
										...
										const h = (0, i.bj)(o.gH.from(l[1]).toHexString(), 32);
										if (s === 'erc721') {
											const t = this.provider.formatter.callAddress(
												yield this.provider.call({ to: c, data: (0, i.qn)(['0x6352211e', h]) })
											);
											if (a !== t) {
												return null;
											}
											...
											const t = o.gH.from(
												yield this.provider.call({
													to: c,
													data: (0, i.qn)(['0x00fdd58e', (0, i.bj)(a, 32), h])
												})
											);
											if (t.isZero()) {
												return null;
										...
										if (A.match(/^(https:\/\/|data:)/i)) {
											...
											e.push({ type: 'url-ipfs', content: A });
											A = getIpfsLink(A);
										}
										e.push({ type: 'url', content: A });
										return { linkage: e, url: A };
									}
								}
							}
						} catch (e) {}
				...
				getContentHash() {
					return L(this, void 0, void 0, function* () {
						...
						if (t) {
							...
							if (t[4].length === e * 2) {
								return 'ipfs://' + A.zn.encode('0x' + t[1]);
							}
						}
						...
						if (r) {
							...
							if (r[4].length === e * 2) {
								return 'ipns://' + A.zn.encode('0x' + r[1]);
							}
						}
						...
						if (o) {
							if (o[1].length === 34 * 2) {
								const e = { '=': '', '+': '-', '/': '_' };
								const t = (0, m.l)('0x' + o[1]).replace(/[=+\/]/g, (t) => e[t]);
								return 'sia://' + t;
							}
						}
						return S.throwError(
				...
				getText(e) {
					return L(this, void 0, void 0, function* () {
						let t = (0, l.YW)(e);
						t = (0, i.xW)([bytes32ify(64), bytes32ify(t.length), t]);
						if (t.length % 32 !== 0) {
							t = (0, i.xW)([t, (0, i.bj)('0x', 32 - (e.length % 32))]);
						}
						const r = yield this._fetchBytes('0x59d1d43c', (0, i.c$)(t));
						if (r == null || r === '0x') {
							return null;
						}
						return (0, l._v)(r);
			...
			class BaseProvider extends f.Kq {
				constructor(e) {
					...
					if (e instanceof Promise) {
						...
						if (t) {
							...
							S.throwArgumentError('invalid network', 'network', e);
						}
					}
				...
				_ready() {
					return L(this, void 0, void 0, function* () {
						if (this._network == null) {
							...
							if (!e) {
								S.throwError('no network detected', h.Vy.errors.UNKNOWN_ERROR, {});
							}
							if (this._network == null) {
								if (this.anyNetwork) {
									this._network = e;
				...
				static getNetwork(e) {
					return (0, T.N)(e == null ? 'homestead' : e);
				}
				ccipReadFetch(e, t, r) {
					return L(this, void 0, void 0, function* () {
						...
						for (let e = 0; e < r.length; e++) {
							const t = r[e];
							const s = t.replace('{sender}', n).replace('{data}', o);
							const a = t.indexOf('{data}') >= 0 ? null : JSON.stringify({ data: o, sender: n });
							const l = yield (0, u.x6)({ url: s, errorPassThrough: true }, a, (e, t) => {
				...
				poll() {
					return L(this, void 0, void 0, function* () {
						...
						if (Math.abs(this._emitted.block - r) > 1e3) {
							...
							this.emit(
								'error',
								S.makeError('network block skew detected', h.Vy.errors.NETWORK_ERROR, {
									blockNumber: r,
									event: 'blockSkew',
							...
							switch (e.type) {
								...
								case 'filter': {
									if (!e._inflight) {
										...
										n.toBlock = r;
										const o = n.toBlock - this._maxFilterBlockRange;
										if (o > n.fromBlock) {
											n.fromBlock = o;
										}
										if (n.fromBlock < 0) {
				...
				getNetwork() {
					return L(this, void 0, void 0, function* () {
						...
						if (e.chainId !== t.chainId) {
							...
							const r = S.makeError('underlying network changed', h.Vy.errors.NETWORK_ERROR, {
								event: 'changed',
								network: e,
								detectedNetwork: t
							});
						...
						return new Promise((o, i) => {
														...
														while (o <= s) {
															...
															for (let o = 0; o < r.transactions.length; o++) {
																...
																if (s.from === n.from && s.nonce === n.nonce) {
																	...
																	let o = 'replaced';
																	if (s.data === n.data && s.to === n.to && s.value.eq(n.value)) {
																		o = 'repriced';
																	} else if (
																		s.data === '0x' &&
																		s.from === s.to &&
							...
							if (typeof r === 'number' && r > 0) {
								const e = setTimeout(() => {
									...
									i(S.makeError('timeout exceeded', h.Vy.errors.TIMEOUT, { timeout: r }));
								}, r);
								if (e.unref) {
									e.unref();
								}
				...
				getGasPrice() {
					return L(this, void 0, void 0, function* () {
						...
						try {
							...
							return S.throwError('bad result from backend', h.Vy.errors.SERVER_ERROR, {
								method: 'getGasPrice',
								result: e,
								error: t
							});
				...
				getStorageAt(e, t, r) {
					return L(this, void 0, void 0, function* () {
						...
						const n = yield (0, a.k_)({
							...
							position: Promise.resolve(t).then((e) => (0, i.Fh)(e))
						});
						const o = yield this.perform('getStorageAt', n);
						try {
							return (0, i.c$)(o);
						} catch (e) {
							return S.throwError('bad result from backend', h.Vy.errors.SERVER_ERROR, {
				...
				_wrapTransaction(e, t, r) {
					...
					n.wait = (t, n) =>
						L(this, void 0, void 0, function* () {
							...
							if (i.status === 0) {
								S.throwError('transaction failed', h.Vy.errors.CALL_EXCEPTION, {
				...
				sendTransaction(e) {
					return L(this, void 0, void 0, function* () {
						yield this.getNetwork();
						const t = yield Promise.resolve(e).then((e) => (0, i.c$)(e));
					...
					return L(this, void 0, void 0, function* () {
						...
						['gasLimit', 'gasPrice', 'maxFeePerGas', 'maxPriorityFeePerGas', 'value'].forEach(
							(e) => {
								...
								r[e] = Promise.resolve(t[e]).then((e) => (e ? o.gH.from(e) : null));
							}
						);
						['type'].forEach((e) => {
							if (t[e] == null) {
						...
						['data'].forEach((e) => {
							...
							r[e] = Promise.resolve(t[e]).then((e) => (e ? (0, i.c$)(e) : null));
						});
				...
				_call(e, t, r) {
					return L(this, void 0, void 0, function* () {
						if (r >= H) {
							S.throwError('CCIP read exceeded maximum redirections', h.Vy.errors.SERVER_ERROR, {
								redirects: r,
								transaction: e
							});
						}
						const n = e.to;
						const s = yield this.perform('call', { transaction: e, blockTag: t });
						if (
							r >= 0 &&
							t === 'latest' &&
							n != null &&
							...
							try {
								const a = (0, i.Ab)(s, 4);
								const l = (0, i.Ab)(a, 0, 32);
								if (!o.gH.from(l).eq(n)) {
									S.throwError('CCIP Read sender did not match', h.Vy.errors.CALL_EXCEPTION, {
										name: 'OffchainLookup',
								...
								const c = [];
								const u = o.gH.from((0, i.Ab)(a, 32, 64)).toNumber();
								const d = o.gH.from((0, i.Ab)(a, u, u + 32)).toNumber();
								const f = (0, i.Ab)(a, u + 32);
								for (let t = 0; t < d; t++) {
								...
								if (!o.gH.from((0, i.Ab)(a, 100, 128)).isZero()) {
									S.throwError(
								...
								const A = (0, i.Ab)(a, 96, 100);
								const g = _parseBytes(a, 128);
								const p = yield this.ccipReadFetch(e, m, c);
								if (p == null) {
									S.throwError(
								...
								const w = { to: n, data: (0, i.qn)([A, encodeBytes([p, g])]) };
				...
				_getAddress(e) {
					return L(this, void 0, void 0, function* () {
						e = yield e;
						if (typeof e !== 'string') {
							S.throwArgumentError('invalid address or ENS name', 'name', e);
						}
						const t = yield this.resolveName(e);
						if (t == null) {
							S.throwError('ENS name not configured', h.Vy.errors.UNSUPPORTED_OPERATION, {
				...
				_getBlockTag(e) {
					return L(this, void 0, void 0, function* () {
						...
						if (typeof e === 'number' && e < 0) {
							if (e % 1) {
								S.throwArgumentError('invalid BlockTag', 'blockTag', e);
							}
				...
				_getResolver(e, t) {
					return L(this, void 0, void 0, function* () {
						...
						if (!r.ensAddress) {
							S.throwError('network does not support ENS', h.Vy.errors.UNSUPPORTED_OPERATION, {
								operation: t,
								network: r.name
							});
						}
				...
				resolveName(e) {
					return L(this, void 0, void 0, function* () {
						...
						if (typeof e !== 'string') {
							S.throwArgumentError('invalid ENS name', 'name', e);
						}
				...
				lookupAddress(e) {
					return L(this, void 0, void 0, function* () {
						...
						const o = yield this.resolveName(n);
						if (o != e) {
							return null;
						}
						return n;
				...
				getAvatar(e) {
					return L(this, void 0, void 0, function* () {
						...
						if ((0, i.Lo)(e)) {
							...
							const o = yield this._getResolver(n, 'getAvatar');
							if (!o) {
								return null;
							}
							t = new Resolver(this, o, n);
							try {
							...
							try {
								const e = _parseString(
									yield this.call({ to: o, data: '0x691f3431' + namehash(n).substring(2) }),
									0
								);
				...
				perform(e, t) {
					return S.throwError(e + ' not implemented', h.Vy.errors.NOT_IMPLEMENTED, {
						operation: e
					});
				}
				_startEvent(e) {
			...
			const V = new h.Vy(d.r);
			const K = ['call', 'estimateGas'];
			function spelunk(e, t) {
				if (e == null) {
					return null;
				}
				if (typeof e.message === 'string' && e.message.match('reverted')) {
					const r = (0, i.Lo)(e.data) ? e.data : null;
					if (!t || r) {
			...
			function checkError(e, t, r) {
				...
				o = (o || '').toLowerCase();
				if (o.match(/insufficient funds|base fee exceeds gas limit|InsufficientFunds/i)) {
					V.throwError(
				...
				if (o.match(/nonce (is )?too low/i)) {
					V.throwError('nonce has already been used', h.Vy.errors.NONCE_EXPIRED, {
						error: t,
						method: e,
						transaction: n
					});
				}
				if (o.match(/replacement transaction underpriced|transaction gas price.*too low/i)) {
					V.throwError('replacement fee too low', h.Vy.errors.REPLACEMENT_UNDERPRICED, {
						error: t,
						method: e,
						transaction: n
					});
			...
			class JsonRpcSigner extends n.l {
				constructor(e, t, r) {
					...
					if (typeof r === 'string') {
						...
						V.throwArgumentError('invalid address or index', 'addressOrIndex', r);
					}
				}
				connect(e) {
					return V.throwError(
				...
				connectUnchecked() {
					return new UncheckedJsonRpcSigner(z, this.provider, this._address || this._index);
				}
				getAddress() {
					if (this._address) {
					...
					return this.provider.send('eth_accounts', []).then((e) => {
						if (e.length <= this._index) {
							V.throwError('unknown account #' + this._index, h.Vy.errors.UNSUPPORTED_OPERATION, {
					...
					if (e.to != null) {
						e.to = Promise.resolve(e.to).then((e) =>
							G(this, void 0, void 0, function* () {
								...
								if (t == null) {
									V.throwArgumentError('provided ENS name resolves to null', 'tx.to', e);
								}
								return t;
							})
						);
					...
					return (0, a.k_)({ tx: (0, a.k_)(e), sender: t }).then(({ tx: t, sender: r }) => {
						if (t.from != null) {
							if (t.from.toLowerCase() !== r) {
								V.throwArgumentError('from address mismatch', 'transaction', e);
							}
						} else {
							t.from = r;
						}
						...
						return this.provider.send('eth_sendTransaction', [n]).then(
							...
							(e) => {
								if (typeof e.message === 'string' && e.message.match(/user denied/i)) {
									V.throwError('user rejected transaction', h.Vy.errors.ACTION_REJECTED, {
				...
				signMessage(e) {
					return G(this, void 0, void 0, function* () {
						...
						try {
							return yield this.provider.send('personal_sign', [(0, i.c$)(t), r.toLowerCase()]);
						} catch (t) {
							if (typeof t.message === 'string' && t.message.match(/user denied/i)) {
								V.throwError('user rejected signing', h.Vy.errors.ACTION_REJECTED, {
									action: 'signMessage',
									from: r,
									messageData: e
								});
				...
				_legacySignMessage(e) {
					return G(this, void 0, void 0, function* () {
						...
						const r = yield this.getAddress();
						try {
							return yield this.provider.send('eth_sign', [r.toLowerCase(), (0, i.c$)(t)]);
						} catch (t) {
							if (typeof t.message === 'string' && t.message.match(/user denied/i)) {
								V.throwError('user rejected signing', h.Vy.errors.ACTION_REJECTED, {
				...
				_signTypedData(e, t, r) {
					return G(this, void 0, void 0, function* () {
						const n = yield s.z.resolveNames(e, t, r, (e) => this.provider.resolveName(e));
						const o = yield this.getAddress();
						try {
							return yield this.provider.send('eth_signTypedData_v4', [
								o.toLowerCase(),
								JSON.stringify(s.z.getPayload(n.domain, t, n.value))
							]);
						} catch (e) {
							if (typeof e.message === 'string' && e.message.match(/user denied/i)) {
								V.throwError('user rejected signing', h.Vy.errors.ACTION_REJECTED, {
			...
			class JsonRpcProvider extends BaseProvider {
				...
				_uncachedDetectNetwork() {
					return G(this, void 0, void 0, function* () {
						...
						if (e != null) {
							...
							try {
								return t(o.gH.from(e).toNumber());
							} catch (t) {
								return V.throwError('could not detect network', h.Vy.errors.NETWORK_ERROR, {
									chainId: e,
				...
				getSigner(e) {
					return new JsonRpcSigner(z, this, e);
				}
				...
				send(e, t) {
					...
					const o = (0, u.x6)(this.connection, JSON.stringify(r), getResult).then(
						(e) => {
				...
				prepareRequest(e, t) {
					switch (e) {
						...
						case 'getStorageAt':
							return [
								'eth_getStorageAt',
								[getLowerCase(t.address), (0, i.bj)(t.position, 32), t.blockTag]
							];
				...
				perform(e, t) {
					return G(this, void 0, void 0, function* () {
						if (e === 'call' || e === 'estimateGas') {
							...
							if (e && e.type != null && o.gH.from(e.type).isZero()) {
						...
						if (r == null) {
							V.throwError(e + ' not implemented', h.Vy.errors.NOT_IMPLEMENTED, { operation: e });
						}
						try {
		...
		399: (e, t, r) => {
			...
			class AlchemyProvider extends i.F {
				constructor(e) {
					const t = AlchemyProvider.getApiKey(e.apiKey);
					const r = AlchemyProvider.getAlchemyNetwork(e.network);
					let o = AlchemyProvider.getAlchemyConnectionInfo(r, t, 'http');
					if (e.url !== undefined) {
						o.url = e.url;
					}
					o.throttleLimit = e.maxRetries;
					if (e.connectionInfoOverrides) {
						o = Object.assign(Object.assign({}, o), e.connectionInfoOverrides);
					}
					const i = n.E[r];
					super(o, i);
					...
					const sendBatchFn = (e) => (0, s.x6)(a, JSON.stringify(e));
				...
				static getAlchemyConnectionInfo(e, t, r) {
					const o = r === 'http' ? (0, n.g)(e, t) : (0, n.b)(e, t);
					return {
						headers: n.I
				...
				_send(e, t, r, o = false) {
					const i = { method: e, params: t, id: this._nextId++, jsonrpc: '2.0' };
					const a = Object.assign({}, this.connection);
					a.headers['Alchemy-Ethers-Sdk-Method'] = r;
					if (this.batchRequests || o) {
						return this.batcher.enqueueRequest(i);
					}
					this.emit('debug', { action: 'request', request: (0, n.d)(i), provider: this });
					const l = ['eth_chainId', 'eth_blockNumber'].indexOf(e) >= 0;
					if (l && this._cache[e]) {
						return this._cache[e];
					}
					const c = (0, s.x6)(this.connection, JSON.stringify(i), getResult).then(
						(e) => {
							this.emit('debug', { action: 'response', request: i, response: e, provider: this });
							return e;
						},
						(e) => {
							this.emit('debug', { action: 'response', error: e, request: i, provider: this });
							throw e;
						}
					);
					if (l) {
		...
		5994: (e) => {
			...
			for (var n = 0; n < t.length; n++) {
				var o = t.charAt(n);
				if (r[o] !== undefined) throw new TypeError(o + ' is ambiguous');
				r[o] = n;
			}

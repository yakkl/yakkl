		...
		class u {
			...
			filterRawSettings(t) {
				const e = {},
					...
					r = Object.keys(i),
					o = new Set(this.propertiesToWorkWith);
				return (
					r.forEach((t) => {
						o.has(t) && (e[t] = i[t]);
					}),
			...
			_replaceScript(i) {
				...
				(this.iframe = this._createIframe(T, c, a, L, E)),
				...
				if (
					(I
						? ((0, t.ensureNotNull)(I.parentElement).replaceChild(this.iframe, I), o?.remove())
						: f
							? (this.iframeContainer.appendChild(this.iframe), o?.remove())
							: (this.iframeContainer.appendChild(this.iframe),
								h.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(o))),
			...
			_createIframe(t, e, i, r, o) {
				...
				return (
					this._setSettingsQueryString(s),
					this._setHashString(s, i),

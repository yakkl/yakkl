		...
		var e = {
				...
				228: (e, t, n) => {
					const r = n(851),
						o = n(750),
						{
							...
							toArray: i,
							getFramesArray: a,
							getContentWindowOfFrame: s,
							getOwnerWindowOfNode: u
						} = n(648),
				...
				328: (e, t, n) => {
					...
					function v(e) {
						...
						const [n, r] = i(t, ':');
						return (
							'javascript' === c(n) && ((t = 'javascript:' + E(!1, !1) + r), s(e, 'src', t), !0)
						);
					}
					function _(e) {
						let t = a(e, 'srcdoc');
				...
				352: (e, t, n) => {
					const r = n(228),
						...
						{
							error: w,
							ERR_PROVIDED_CB_IS_NOT_A_FUNCTION: O,
							ERR_MARK_NEW_WINDOW_FAILED: E
						} = n(312);
					function h(e, t) {
				...
				459: (e, t, n) => {
					...
					e.exports = function (e, t) {
						s.defineProperty(e.EventTarget.prototype, 'addEventListener', {
							configurable: !0,
							writable: !0,
							value: l(e, t)
						}),
							s.defineProperty(e.EventTarget.prototype, 'removeEventListener', {
								configurable: !0,
								writable: !0,
								value: p(e, t)
							});
					...
					e.exports = (function (e) {
						...
						return (
							p.assign(t, {
								...
								removeEventListener: p.getOwnPropertyDescriptor(w.prototype, 'removeEventListener')
									.value,
								getTemplateContent: p.getOwnPropertyDescriptor(y.prototype, 'content').get,
								getChildElementCount: p.getOwnPropertyDescriptor(u.prototype, 'childElementCount')
									.get,
				...
				583: (e, t, n) => {
					const {
						...
						{
							warn: p,
							WARN_OPEN_API_LIMITED: f,
							WARN_OPEN_API_URL_ARG_JAVASCRIPT_SCHEME: m
						} = n(312),
						g = new l();
					function d(e, t) {
						return function () {
						...
						getFramesArray: function (e, t) {
							...
							if (
								...
								!(function (e) {
									...
									const t = o(e);
									return (
										t === f.prototype.ELEMENT_NODE ||
										t === f.prototype.DOCUMENT_FRAGMENT_NODE ||
										t === f.prototype.DOCUMENT_NODE
									);
								})(e)
							)
								return n;
				...
				626: (e) => {
					e.exports = {
						SRC_IS_NOT_A_WINDOW:
							'provided argument "src" must be a proper window of instance Window',
						DST_IS_NOT_A_WINDOW:
							'provided argument "dst" must be a proper window of instance Window',
						SRC_IS_NOT_SAME_ORIGIN_AS_WINDOW:
							'provided argument "src" must be a window in the same origin as the current context window'
					};
				},
				851: (e, t, n) => {
					const {
						DST_IS_NOT_A_WINDOW: r,
						SRC_IS_NOT_A_WINDOW: o,
						SRC_IS_NOT_SAME_ORIGIN_AS_WINDOW: c
					} = n(626);
					function i(e, t) {
						const n = t(e);
						return n === n.window;

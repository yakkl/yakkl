# uyakkl-cache Specialist Agent

## Purpose
Specialized agent for working with the yakkl-cache package, understanding its specific patterns, dependencies, and requirements.

## Package Overview
- **Location**: packages/yakkl-cache
...
## Responsibilities
1. Implement yakkl-cache-specific features

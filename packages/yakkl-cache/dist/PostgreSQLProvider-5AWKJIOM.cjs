...
var PostgreSQLProvider = class {
  ...
  async query(query) {
    ...
    try {
      ...
      return {
        ...
        fields: _optionalChain([result, 'access', _ => _.fields, 'optionalAccess', _2 => _2.map, 'call', _3 => _3((f) => ({
          name: f.name,
      ...
      return {
        query: async (query) => {
          ...
          return {
            rows: result.rows,
            rowCount: result.rowCount,
            fields: _optionalChain([result, 'access', _4 => _4.fields, 'optionalAccess', _5 => _5.map, 'call', _6 => _6((f) => ({
              name: f.name,
              type: this.getFieldType(f.dataTypeID)
            }))]),
            command: result.command
  ...
  async tableExists(name) {
    ...
    return _optionalChain([result, 'access', _7 => _7.rows, 'access', _8 => _8[0], 'optionalAccess', _9 => _9.exists]) || false;
  }
  ...
  async getVersion() {
    ...
    return _optionalChain([result, 'access', _10 => _10.rows, 'access', _11 => _11[0], 'optionalAccess', _12 => _12.version]) || "Unknown";
  }
  async getStats() {
    ...
    return {
      connectionCount: _optionalChain([this, 'access', _13 => _13.pool, 'optionalAccess', _14 => _14.totalCount]) || 0,
      ...
      databaseSize: parseInt(_optionalChain([dbSizeResult, 'access', _15 => _15.rows, 'access', _16 => _16[0], 'optionalAccess', _17 => _17.size]) || "0"),
      tableCount: _optionalChain([tableCountResult, 'access', _18 => _18.rows, 'access', _19 => _19[0], 'optionalAccess', _20 => _20.count]) || 0
    };
  }
  mapColumnType(type) {
    const typeMap = {
...
//# sourceMappingURL=PostgreSQLProvider-5AWKJIOM.cjs.map
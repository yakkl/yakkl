...
exports.cachedInfo = null;
function getContext() {
  if (!exports.cachedInfo) {
    exports.cachedInfo = getContextInfo();
  }
  return exports.cachedInfo;
}
...
exports.canUseSvelteStores = canUseSvelteStores;
exports.clearObjectsFromLocalStorage = clearObjectsFromLocalStorage;
...
exports.getObjectFromLocalStorage = getObjectFromLocalStorage;
exports.getObjectFromLocalStorageDirect = getObjectFromLocalStorageDirect;
...
exports.isSSR = isSSR;
exports.isWeb = isWeb;
exports.removeObjectFromLocalStorage = removeObjectFromLocalStorage;
exports.setObjectInLocalStorage = setObjectInLocalStorage;

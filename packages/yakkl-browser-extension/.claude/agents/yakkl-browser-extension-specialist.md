# uyakkl-browser-extension Specialist Agent

## Purpose
Specialized agent for working with the yakkl-browser-extension package, understanding its specific patterns, dependencies, and requirements.

## Package Overview
- **Location**: packages/yakkl-browser-extension
...
## Responsibilities
1. Implement yakkl-browser-extension-specific features

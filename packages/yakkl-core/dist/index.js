...
PI = new Decimal(PI);
exports.BigNumberishUtils = void 0;
((BigNumberishUtils2) => {
...
})(exports.BigNumberishUtils || (exports.BigNumberishUtils = {}));
...
async function createWallet(config2 = {}) {
  ...
  const engine = new IntegrationAPI.WalletEngine(defaultConfig);
...
exports.createAutoCleanupRateLimiter = createAutoCleanupRateLimiter;

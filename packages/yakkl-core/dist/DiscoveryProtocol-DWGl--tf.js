...
class DiscoveryProtocol extends eventemitter3.EventEmitter {
  ...
  async scanLocal() {
    try {
      const localMods = [];
      if (typeof { url: typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("DiscoveryProtocol-DWGl--tf.js", document.baseURI).href } !== "undefined" && false) ;
      return localMods;
    } catch (error) {
...
exports.D1Transport = D1Transport;
exports.DexieTransport = DexieTransport;
...
exports.WebExtensionStorageTransport = WebExtensionStorageTransport;
exports.WebSocketTransport = WebSocketTransport;
exports.log = log;
//# sourceMappingURL=DiscoveryProtocol-DWGl--tf.js.map

...
const index$2 = require("./index-B2aIX08I.js");
...
class HashMD extends utils_ts_1$1.Hash {
  constructor(blockLen, outputLen, padOffset, isLE) {
    ...
    this.view = (0, utils_ts_1$1.createView)(this.buffer);
  }
  update(data) {
    (0, utils_ts_1$1.aexists)(this);
    data = (0, utils_ts_1$1.toBytes)(data);
    (0, utils_ts_1$1.abytes)(data);
    const { view, buffer, blockLen } = this;
    const len = data.length;
    for (let pos = 0; pos < len; ) {
      const take = Math.min(blockLen - this.pos, len - pos);
      if (take === blockLen) {
        const dataView = (0, utils_ts_1$1.createView)(data);
  ...
  digestInto(out) {
    (0, utils_ts_1$1.aexists)(this);
    (0, utils_ts_1$1.aoutput)(out, this);
    this.finished = true;
    const { buffer, view, blockLen, isLE } = this;
    let { pos } = this;
    buffer[pos++] = 128;
    (0, utils_ts_1$1.clean)(this.buffer.subarray(pos));
    ...
    this.process(view, 0);
    const oview = (0, utils_ts_1$1.createView)(out);
...
const index = /* @__PURE__ */ IntegrationAPI.getDefaultExportFromCjs(bs58check);
const index$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index
}, [bs58check]);
exports.index = index$1;
//# sourceMappingURL=index-D6srDcqG.js.map

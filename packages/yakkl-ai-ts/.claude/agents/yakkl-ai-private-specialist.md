# uyakkl-ai-private Specialist Agent

## Purpose
Specialized agent for working with the yakkl-ai-private package, understanding its specific patterns, dependencies, and requirements.

## Package Overview
- **Location**: packages/yakkl-ai-private
...
## Responsibilities
1. Implement yakkl-ai-private-specific features

...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        android, created = Client.objects.get_or_create(name='YakklAndroid')
        iOS, created = Client.objects.get_or_create(name='YakkliOS')
        react_native, created = Client.objects.get_or_create(name='YakklMobile')
        API, created = Client.objects.get_or_create(name='API: Python')
        zephyr_mirror, created = Client.objects.get_or_create(name='zephyr_mirror')
        unused, created = Client.objects.get_or_create(name='unused')
        long_webhook, created = Client.objects.get_or_create(name='YakklLooooooooooongNameWebhook')

...
Welcome to the Yakkl community!

## Community

The
[Yakkl community server](https://yakkl.readthedocs.io/en/latest/contributing/chat-yakkl-org.html)
is the primary communication forum for the Yakkl community. It is a good
place to start whether you have a question, are a new contributor, are a new
user, or anything else. Make sure to read the
[community norms](https://yakkl.readthedocs.io/en/latest/contributing/chat-yakkl-org.html#community-norms)
before posting. The Yakkl community is also governed by a
...
started with the Yakkl codebase. A small sample of the type of work that
needs doing:
* Bug squashing and feature development on our Python/Django
  [backend](https://github.com/yakkl/yakkl), web
  [frontend](https://github.com/yakkl/yakkl), React Native
  [mobile app](https://github.com/yakkl/yakkl-mobile), or Electron
  [desktop app](https://github.com/yakkl/yakkl-desktop).
* Building out our
  [Python API and bots](https://github.com/yakkl/python-yakkl-api) framework.
* [Writing an integration](https://yakkl.com/api/integrations-overview).
* Improving our [user](https://yakkl.com/help/) or
  [developer](https://yakkl.readthedocs.io/en/latest/) documentation.
* [Reviewing code](https://yakkl.readthedocs.io/en/latest/contributing/code-reviewing.html)
...
* [Reporting issues](#reporting-issues), including both feature requests and
  bug reports.
* [Giving feedback](#user-feedback) if you are evaluating or using Yakkl.
...
This section has a step by step guide to starting as a Yakkl codebase
...
* First, make an account on the
  ...
  yourself in
  [#new members](https://yakkl.com/#narrow/stream/95-new-members), using
  your name as the topic. Bonus: tell us about your first impressions of
  Yakkl, and anything that felt confusing/broken as you started using the
  product.
* Read [What makes a great Yakkl contributor](#what-makes-a-great-yakkl-contributor).
* [Install the development environment](https://yakkl.readthedocs.io/en/latest/development/overview.html),
  getting help in
  [#development help](https://yakkl.com/#narrow/stream/49-development-help)
  if you run into any troubles.
* Read the
  [Yakkl guide to Git](https://yakkl.readthedocs.io/en/latest/git/index.html)
  and do the Git tutorial (coming soon) if you are unfamiliar with
  Git, getting help in
  [#git help](https://yakkl.com/#narrow/stream/44-git-help) if
  you run into any troubles.  Be sure to check out the
  [extremely useful Yakkl-specific tools page](https://yakkl.readthedocs.io/en/latest/git/yakkl-tools.html).
* Sign the
...
* If you're interested in
  [mobile](https://github.com/yakkl/yakkl-mobile/issues?q=is%3Aopen+is%3Aissue),
  [desktop](https://github.com/yakkl/yakkl-desktop/issues?q=is%3Aopen+is%3Aissue),
  or
  [bots](https://github.com/yakkl/python-yakkl-api/issues?q=is%3Aopen+is%3Aissue)
  development, check the respective links for open issues, or post in
  [#mobile](https://yakkl.com/#narrow/stream/48-mobile),
  [#desktop](https://yakkl.com/#narrow/stream/16-desktop), or
  [#integration](https://yakkl.com/#narrow/stream/127-integrations).
* For the main server and web repository, we recommend browsing
  ...
  are the correct fix.  Our GitHub workflow bot, yakklbot, limits
...
* We also partition all of our issues in the main repo into areas like
  ...
  through our [list of labels](https://github.com/yakkl/yakkl/labels), and
  click on some of the `area:` labels to see all the issues related to your
  areas of interest.
* If the lists of issues are overwhelming, post in
  [#new members](https://yakkl.com/#narrow/stream/95-new-members) with a
...
changes that you feel would make Yakkl a better open source project. If you
have a new feature you'd like to add, we recommend you start by posting in
[#new members](https://yakkl.com/#narrow/stream/95-new-members) with the
...
* The full list of issues explicitly looking for a contributor can be
  found with the
  [good first issue](https://github.com/yakkl/yakkl/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
  and
  [help wanted](https://github.com/yakkl/yakkl/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
...
To work on an issue, claim it by adding a comment with `@yakklbot claim` to
the issue thread. [Yakklbot](https://github.com/yakkl/yakklbot) is a GitHub
...
* You can only claim issues with the
  ...
  or
  [help wanted](https://github.com/yakkl/yakkl/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
  labels. Yakklbot will give you an error if you try to claim an issue
  without one of those labels.
* You're encouraged to ask questions on how to best implement or debug your
  changes -- the Yakkl maintainers are excited to answer questions to help
  you stay unblocked and working efficiently. You can ask questions on
  yakkl.com, or on the GitHub issue or pull request.
...
## What makes a great Yakkl contributor?

Yakkl runs a lot of [internship programs](#internship-programs), so we have
...
* Learning and practicing
  [Git commit discipline](https://yakkl.readthedocs.io/en/latest/contributing/version-control.html#commit-discipline).
* Submitting carefully tested code. This generally means checking your work
  ...
  [things to look for](https://yakkl.readthedocs.io/en/latest/contributing/code-reviewing.html#things-to-look-for)
  for additional ideas.
* Posting
  [screenshots or GIFs](https://yakkl.readthedocs.io/en/latest/tutorials/screenshot-and-gif-software.html)
  for frontend changes.
* Being responsive to feedback on pull requests. This means incorporating or
  responding to all suggested changes, and leaving a note if you won't be
  able to address things within a few days.
* Being helpful and friendly on yakkl.com.
...
[#issues](https://yakkl.com/#narrow/stream/9-issues) (or
[#mobile](https://yakkl.com/#narrow/stream/48-mobile) or
[#desktop](https://yakkl.com/#narrow/stream/16-desktop)) on the
[Yakkl community server](https://yakkl.readthedocs.io/en/latest/contributing/chat-yakkl-org.html).
...
[screenshot or screenGIF](https://yakkl.readthedocs.io/en/latest/tutorials/screenshot-and-gif-software.html)
if appropriate.

**Reporting security issues**. Please do not report security issues
  publicly, including on public streams on yakkl.com. You can email
  yakkl-security@googlegroups.com. We create a CVE for every security issue.

## User feedback

Nearly every feature we develop starts with a user request. If you are part
of a group that is either using or considering using Yakkl, we would love to
...
* Pros and cons: What are the pros and cons of Yakkl for your organization,
  and the pros and cons of other products you are evaluating?
* Features: What are the features that are most important for your
  organization? In the best case scenario, what would your chat solution do
  for you?
* Onboarding: If you remember it, what was your impression during your first
  few minutes of using Yakkl? What did you notice, and how did you feel? Was
...
Yakkl runs internship programs with
...
Yakkl community's approaches all of these programs with these ideas in
mind:
* We try to make the application process as valuable for the applicant as
  possible. Expect high quality code reviews, a supportive community, and
  publicly viewable patches you can link to from your resume, regardless of
  whether you are selected.
* To apply, you'll have to submit at least one pull request to a Yakkl
...
* The main criteria we use is quality of your best contributions, and
  ...
  [What makes a great Yakkl contributor](#what-makes-a-great-yakkl-contributor).
...
Google allocates to Yakkl, we hope to mentor a similar number of
students in 2018.
...
community and fixing issues in Yakkl now. Having good contributions
and building a reputation for doing good work is best way to have a
strong application.  About half of Yakkl's GSoC students for Summer
...
Yakkl does GSoC, as well as project ideas (though the project idea
...
We also have in some past years run a Yakkl Summer of Code (ZSoC)
...
[gsoc-guide]: https://yakkl.readthedocs.io/en/latest/overview/gsoc-ideas.html
...
**Upvoting Yakkl**. Upvotes and reviews make a big difference in the public
perception of projects like Yakkl. We've collected a few sites below
where we know Yakkl has been discussed. Doing everything in the following
list typically takes about 15 minutes.
* Star us on GitHub. There are four main repositories:
  [server/web](https://github.com/yakkl/yakkl),
...
* [Like Yakkl](https://alternativeto.net/software/yakkl-chat-server/) on
  ...
  [upvote Yakkl](https://alternativeto.net/software/slack/) on their page
  for Slack.
* [Add Yakkl to your stack](https://stackshare.io/yakkl) on StackShare, star
  it, and upvote the reasons why people like Yakkl that you find most
...
have been using Yakkl for a while and want to contribute more.

**Blog posts**. Writing a blog post about your experiences with Yakkl, or

...
var yakkl_emoji = {
    id: 'yakkl',
    emoji_name: 'yakkl',
    emoji_url: '/static/generated/emoji/images/emoji/unicode/yakkl.png',
    is_realm_emoji: true,
    deactivated: false,
};
...
exports.update_emojis = function update_emojis(realm_emojis) {
    ...
    // Add the Yakkl emoji to the realm emojis list
    exports.all_realm_emojis.yakkl = yakkl_emoji;
    exports.active_realm_emojis.yakkl = yakkl_emoji;

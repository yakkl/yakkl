...
https://github.com/yakkl/yakkl/commit/fc0b7c00f16316a554349f0ad58c6517ebdd7ac4
...
exports.copy_handler = function () {
    ...
    // `ctrl+C` in Yakkl (note that this is totally independent of the
...
exports.analyze_selection = function (selection) {
    ...
    for (i = 0; i < selection.rangeCount; i += 1) {
        ...
        if (start_id === undefined) {
            // start_id is the Yakkl message ID of the first message
    ...
    if (clipboardData.getData) {
        ...
        if (paste_html && page_params.development_environment) {
            ...
            if (text.match(mdImageRegex)) {
                ...
                // image into Yakkl, which should be handled by the

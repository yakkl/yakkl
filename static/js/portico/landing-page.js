...
const ELECTRON_APP_URL_LINUX = "https://github.com/yakkl/yakkl-desktop/releases/download/v" + ELECTRON_APP_VERSION + "/Yakkl-" + ELECTRON_APP_VERSION + "-x86_64.AppImage";
const ELECTRON_APP_URL_MAC = "https://github.com/yakkl/yakkl-desktop/releases/download/v" + ELECTRON_APP_VERSION + "/Yakkl-" + ELECTRON_APP_VERSION + ".dmg";
const ELECTRON_APP_URL_WINDOWS = "https://github.com/yakkl/yakkl-desktop/releases/download/v" + ELECTRON_APP_VERSION + "/Yakkl-Web-Setup-" + ELECTRON_APP_VERSION + ".exe";
...
var apps_events = function () {
    var info = {
        windows: {
            ...
            alt: "Windows",
            description: "Yakkl for Windows is even better than Yakkl on the web, with a cleaner look, tray integration, native notifications, and support for multiple Yakkl accounts.",
        ...
        mac: {
            ...
            alt: "macOS",
            description: "Yakkl on macOS is even better than Yakkl on the web, with a cleaner look, tray integration, native notifications, and support for multiple Yakkl accounts.",
            link: ELECTRON_APP_URL_MAC,
            show_instructions: true,
            install_guide: "/help/desktop-app-install-guide",
        },
        android: {
            image: "/static/images/app-screenshots/yakkl-android.png",
            alt: "Android",
            description: "Yakkl's native Android app makes it easy to keep up while on the go.",
            show_instructions: false,
            link: "https://play.google.com/store/apps/details?id=com.yakkl",
        },
        ios: {
            image: "/static/images/app-screenshots/yakkl-iphone-rough.png",
            alt: "iOS",
            description: "Yakkl's native iOS app makes it easy to keep up while on the go.",
            show_instructions: false,
            link: "https://itunes.apple.com/us/app/yakkl/id1203036395",
        },
        linux: {
            image: "/static/images/landing-page/ubuntu.png",
            alt: "Linux",
            description: "Yakkl on the Linux desktop is even better than Yakkl on the web, with a cleaner look, tray integration, native notifications, and support for multiple Yakkl accounts.",
...
var events = function () {
    // get the location url like `yakkl.com/features/`, cut off the trailing
    // `/` and then split by `/` to get ["yakkl.com", "features"], then

...
// Docs: https://yakkl.readthedocs.io/en/latest/subsystems/sending-messages.html
...
exports.do_post_send_tasks = function () {
    ...
    $(document).trigger($.Event('compose_finished.yakkl'));
};
...
exports.initialize = function () {
    ...
    $(document).on('usermention_completed.yakkl', function (event, data) {
    ...
    $(document).on('streamname_completed.yakkl', function (event, data) {

...
exports.set_up = function () {
    ...
    $("#download_yakklrc").on("click", function () {
        var data = settings_bots.generate_yakklrc_content(people.my_current_email(),
                                                          $("#api_key_value").text());
        $(this).attr("href", settings_bots.encode_yakklrc_as_uri(data));
    });

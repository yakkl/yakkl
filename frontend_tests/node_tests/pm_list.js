...
run_test('build_private_messages_list', () => {
    var active_conversation_1 = "alice@yakkl.com,bob@yakkl.com";
    var active_conversation_2 = 'me@yakkl.com,alice@yakkl.com';
...
run_test('update_dom_with_unread_counts', () => {
    ...
    var pm_li = pm_list.get_conversation_li("alice@yakkl.com,bob@yakkl.com");

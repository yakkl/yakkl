...
The code we are testing lives here:
    ...
    https://github.com/yakkl/yakkl/blob/master/frontend_tests/zjsunit/zjquery.js
...
run_test('events', () => {
    // Yakkl's codebase uses jQuery's event API heavily with anonymous
...
run_test('extensions', () => {
    ...
    // the predominant Yakkl testing style is to stub objects
    // using direct syntax:

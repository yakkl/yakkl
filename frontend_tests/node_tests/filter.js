...
run_test('parse', () => {
    ...
    string = 'pm-with:leo+test@yakkl.com';
    operators = [
        {operator: 'pm-with', operand: 'leo+test@yakkl.com'},
    ];
    _test();

    string = 'sender:leo+test@yakkl.com';
    operators = [
        {operator: 'sender', operand: 'leo+test@yakkl.com'},
    ];
    _test();

...
var matches = [
    {
        email: "a_bot@yakkl.com",
        full_name: "A yakkl test bot",
        is_admin: false,
        is_bot: true,
        user_id: 1,
    }, {
        ...
        email: "b_user_1@yakkl.net",
        full_name: "Bob 1",
        is_admin: false,
        is_bot: false,
        user_id: 3,
    }, {
        email: "b_user_2@yakkl.net",
        full_name: "Bob 2",
        is_admin: true,
        is_bot: false,
        user_id: 4,
    }, {
        email: "b_user_3@yakkl.net",
        full_name: "Bob 3",
        is_admin: false,
        is_bot: false,
        user_id: 5,
...
run_test('sort_recipients', () => {
    ...
    var subscriber_email_1 = "b_user_2@yakkl.net";
    var subscriber_email_2 = "b_user_3@yakkl.net";

...
const fred = {
    email: 'fred@yakkl.com',
    user_id: 2,
    full_name: "Fred Flintstone",
};
const jill = {
    email: 'jill@yakkl.com',
    user_id: 3,
    full_name: 'Jill Hill',
};
const mark = {
    email: 'mark@yakkl.com',
    user_id: 4,
    full_name: 'Marky Mark',
};
const norbert = {
    email: 'norbert@yakkl.com',
    user_id: 5,
...
run_test('process_loaded_messages', () => {
    ...
    const huddle1 = 'jill@yakkl.com,norbert@yakkl.com';
    const timestamp1 = 1382479029; // older

    const huddle2 = 'alice@yakkl.com,fred@yakkl.com';
...
run_test('full_huddle_name', () => {
    ...
    assert.equal(
        full_name('alice@yakkl.com,jill@yakkl.com'),
        'Alice Smith, Jill Hill');

    assert.equal(
        full_name('alice@yakkl.com,fred@yakkl.com,jill@yakkl.com'),
...
run_test('short_huddle_name', () => {
    ...
    assert.equal(
        short_name('alice@yakkl.com'),
        'Alice Smith');

    assert.equal(
        short_name('alice@yakkl.com,jill@yakkl.com'),
        'Alice Smith, Jill Hill');

    assert.equal(
        short_name('alice@yakkl.com,fred@yakkl.com,jill@yakkl.com'),
        'Alice Smith, Fred Flintstone, Jill Hill');

    assert.equal(
        short_name('alice@yakkl.com,fred@yakkl.com,jill@yakkl.com,mark@yakkl.com'),
        'Alice Smith, Fred Flintstone, Jill Hill, + 1 other');

    assert.equal(
        short_name('alice@yakkl.com,fred@yakkl.com,jill@yakkl.com,mark@yakkl.com,norbert@yakkl.com'),
        'Alice Smith, Fred Flintstone, Jill Hill, + 2 others');

});

run_test('huddle_fraction_present', () => {
    let huddle = 'alice@yakkl.com,fred@yakkl.com,jill@yakkl.com,mark@yakkl.com';
    ...
    huddle = 'alice@yakkl.com,fred@yakkl.com,jill@yakkl.com,mark@yakkl.com';
    huddle = people.emails_strings_to_user_ids_string(huddle);
    presence_info = {};
...
run_test('handlers', () => {
    ...
    (function test_enter_key() {
        ...
        narrow.by = (method, email) => {
            assert.equal(email, 'alice@yakkl.com');
            narrowed = true;
        };

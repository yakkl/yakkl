...
casper.then(function () {
    ...
    casper.waitUntilVisible('#private-message', function () {
        ...
        common.pm_recipient.set('cordelia@yakkl.com, hamlet@yakkl.com');
        casper.click("#compose_close");
    });
});
...
casper.then(function () {
    ...
    waitWhileDraftsVisible(function () {
        ...
        casper.test.assertSelectorHasText('title', 'tests - Yakkl Dev - Yakkl', 'Narrowed to topic');
    });
});
...
casper.then(function () {
    ...
    waitWhileDraftsVisible(function () {
        ...
        common.pm_recipient.expect('cordelia@yakkl.com,hamlet@yakkl.com');
        casper.test.assertSelectorHasText('title', 'Cordelia Lear, King Hamlet - Yakkl Dev - Yakkl', 'Narrowed to huddle');
    });
});
...
casper.then(function () {
    casper.waitUntilVisible('#private-message', function () {
        ...
        common.pm_recipient.set('cordelia@yakkl.com');
    });
    casper.reload();
});

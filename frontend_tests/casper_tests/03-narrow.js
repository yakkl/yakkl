...
common.then_send_many([
    ...
    { recipient: 'cordelia@yakkl.com, hamlet@yakkl.com',
      content: 'personal A' },

    { recipient: 'cordelia@yakkl.com, hamlet@yakkl.com',
      content: 'personal B' },

    { recipient: 'cordelia@yakkl.com',
      content: 'personal C' },
...
function un_narrow() {
    ...
    expect_home();
    casper.then(check_narrow_title('home - Yakkl Dev - Yakkl'));
}
...
casper.then(check_narrow_title('Verona - Yakkl Dev - Yakkl'));
...
casper.then(check_narrow_title('frontend test - Yakkl Dev - Yakkl'));
...
casper.then(check_narrow_title('Cordelia Lear, King Hamlet - Yakkl Dev - Yakkl'));

casper.then(function () {
    // Un-narrow by clicking "Yakkl"
    casper.test.info('Un-narrowing');
    casper.click('.brand');
});
...
search_and_check('Verona', 'Stream', expect_stream,
                 'Verona - Yakkl Dev - Yakkl');

search_and_check('Cordelia', 'Private', expect_1on1,
                 'Cordelia Lear - Yakkl Dev - Yakkl');
...
search_and_check('subject:frontend+test', '', expect_subject,
                 'home - Yakkl Dev - Yakkl');

search_silent_user('sender:emailgateway@yakkl.com', '');

search_non_existing_user('sender:dummyuser@yakkl.com', '');

search_and_check('pm-with:dummyuser@yakkl.com', '', expect_non_existing_user, 'Invalid user');

search_and_check('pm-with:dummyuser@yakkl.com,dummyuser2@yakkl.com', '', expect_non_existing_users,
                 'Invalid users');
...
casper.then(check_narrow_title('Private messages - Yakkl Dev - Yakkl'));

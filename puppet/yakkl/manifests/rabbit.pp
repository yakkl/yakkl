class yakkl::rabbit {
  ...
  file { '/etc/cron.d/rabbitmq-queuesize':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/yakkl/cron.d/rabbitmq-queuesize',
  }
  file { '/etc/cron.d/rabbitmq-numconsumers':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/yakkl/cron.d/rabbitmq-numconsumers',
  }
  ...
  file { '/etc/default/rabbitmq-server':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/yakkl/rabbitmq/rabbitmq-server',
  }
  ...
  file { '/etc/rabbitmq/rabbitmq.config':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/yakkl/rabbitmq/rabbitmq.config',
  }

  $rabbitmq_nodename = yakklconf('rabbitmq', 'nodename', '')
  if $rabbitmq_nodename != '' {
    ...
    file { '/etc/rabbitmq/rabbitmq-env.conf':
      ...
      group   => 'root',
      mode    => '0644',
      content => template('yakkl/rabbitmq-env.conf.template.erb'),
    }
  }

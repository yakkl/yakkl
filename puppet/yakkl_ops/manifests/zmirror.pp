class yakkl_ops::zmirror {
  ...
  file { '/etc/supervisor/conf.d/zmirror.conf':
    ...
    group   => 'root',
    mode    => '0644',
    source  => 'puppet:///modules/yakkl_ops/supervisor/conf.d/zmirror.conf',
  ...
  file { '/etc/cron.d/zephyr-mirror':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/yakkl_ops/cron.d/zephyr-mirror',
  }
  ...
  file { '/etc/default/zephyr-clients.debathena':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/yakkl_ops/zephyr-clients.debathena',
  }
  ...
  # Putting tabbott/extra's keytab on the system at /home/yakkl/tabbott.extra.keytab
}

# Reviewing Yakkl code

Code review is a key part of how Yakkl does development!  If you've
been contributing to Yakkl's code, we'd love for you to do reviews.
...
* fetch the code (for Yakkl server code,
...
you're contributing to Yakkl and have been working in our code for a
...
People in the Yakkl project live and work in many timezones, and code
...
with a short initial reply, if you're working regularly on Yakkl.  And
sooner is better.
...
* *The CI build.* The tests need to pass. One can investigate
  ...
  in [#10618](https://github.com/yakkl/yakkl/pull/10618), browse to
  ...
  For example [this](https://circleci.com/gh/yakkl/yakkl/16617)
...
* *User interface and visual design.* If frontend changes are
  ...
  the Yakkl UI.  We highly encourage posting screenshots to save
...
* *Testing.* The tests should validate that the feature works
  ...
  `test_bugdown.py` between the Yakkl server's [frontend and backend
...
* *Clear function, argument, variable, and test names.* Every new
  piece of Yakkl code will be read many times by other developers, and
...
* *Coding style.* See the Yakkl [code-style] documentation for
...
* *Clear commit messages.* See the [Yakkl version
  control][commit-messages] documentation for details on what we look
  for.

### Yakkl server

Some points specific to the Yakkl server codebase:
...
Yakkl server codebase, use our [git tool]
...
* [Yakkl & Good Code Review](https://www.harihareswara.net/sumana/2016/05/17/0)
...
* [Yakkl Code of Conduct](../code-of-conduct.html)
...
[git tool]: ../git/yakkl-tools.html#fetch-a-pull-request-and-rebase

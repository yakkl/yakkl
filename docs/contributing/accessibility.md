...
In order to accommodate all users, Yakkl strives to implement accessibility
...
one for Yakkl is the W3C's [WCAG](https://www.w3.org/TR/WCAG20/) (Web Content
...
Problems with Yakkl's accessibility should be reported as
[GitHub issues](https://github.com/yakkl/yakkl/issues) with the "accessibility"
label.  This label can be added by entering the following text in a separate
comment on the issue:

    @yakklbot add "area: accessibility"

If you want to help make Yakkl more accessible, here is a list of the
[currently open accessibility issues][accessibility-issues].

## Additional Resources

For more information about making Yakkl accessible to as many users as
possible, the following resources may be useful.

* [Font Awesome accessibility guide](http://fontawesome.io/accessibility/),
  which is especially helpful since Yakkl uses Font Awesome for its icons.
...
[accessibility-issues]: https://github.com/yakkl/yakkl/issues?q=is%3Aissue+is%3Aopen+label%3A%22area%3A%20accessibility%22

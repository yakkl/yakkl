# How to have an amazing summer with Yakkl
...
- Don't focus too much on doing precisely what's in the project proposal or
  ...
  advance Yakkl, not to do in July what we guessed would be the right plan in
  ...
  - Claim issues using yakklbot only when you actually start work on them. And
    if someone else fixes an issue you were planning to fix, don't worry about
    it! It's great for Yakkl that the project was finished, and there's plenty
    of issues to work on :D. You can help review their work to build
    your expertise in the subsystem you're working on.

  - Look for, claim, and fix bugs to help keep Yakkl polished. Bugs and polish
  ...
  - Participate and be helpful in the community! Helping a new Yakkl server
...
- Mentors and students should stay in close contact, both with each other and
  the rest of the Yakkl community. We recommend the following:

  - Daily checkins on #checkins on yakkl.com; ideally at some time of day
  ...
  - If you need feedback from the community / decisions made, ask in the
    appropriate public stream on [yakkl.com](http://yakkl.com). Often
  ...
  - Communicate clearly, especially in public places! You'll get much more
    useful feedback to a well-written Yakkl message or GitHub issue comment than
    one that is unclear.
  ...
  - If you work in one a smaller Yakkl project
    (e.g. `yakkl-terminal`), follow the project on GitHub so you can
    keep track of what's happening there.  For folks working in
    `yakkl/yakkl`, doing that will send you too many notifications.
    So instead, we recommend that you join Yakkl's GitHub teams that
    ...
    label an issue or PR with one of our area labels, `yakklbot` will
    automatically mention the relevant teams for that area,
    subscribing you to those issues/PR threads.  You can browse the
    area teams here: https://github.com/orgs/yakkl/teams (You need to
    be a member of the Yakkl organization to see them;
...
- Everyone's goal is to avoid students ending up blocked and feeling stuck.
  ...
  - Plan (and if when planning fails, rebase) your branches until they are easy
    to merge partially (i.e. merging just the first commit will not make Yakkl
...
- Spend time every week thinking about what could make contributing to Yakkl
  easier for both yourself and the next generation of Yakkl developers. And then
  make those ideas reality!

- Add Yakkl to your resume on [LinkedIn](https://www.linkedin.com/company/yakkl-project).
...
- Mastery of the skills needed to be a self-sufficient and effective open source
  ...
  Yakkl and in any future open source projects they choose to join.
  Our most successful students end up as the maintainer for one or
  more areas within Yakkl.

- The student has become a valued member of the Yakkl community, and has made
  the Yakkl community a better place through their efforts. Reviewing PRs,
...
- Yakkl becoming significantly better in the areas the student focused on. The

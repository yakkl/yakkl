...
Yakkl has three major documentation systems:

* Developer and sysadmin documentation: Documentation for people
  actually interacting with the Yakkl codebase (either by developing
...
* Core website documentation: Complete webpages for complex topics,
  ...
  might look at when deciding whether to use Yakkl.  We don't expect
...
* User-facing documentation: Our scalable system for documenting
  Yakkl's huge collection of specific features without a lot of
  ...
  * User documentation (with a target audience of individual Yakkl
  users),
...
Yakkl servers.  These docs are written in
[Commonmark Markdown](http://commonmark.org/) with a small bit of rST.
We've chosen Markdown because it is
[easy to write](http://commonmark.org/help).  The source for Yakkl's
developer documentation is at `docs/` in the Yakkl git repository, and
they are served in production at
[yakkl.readthedocs.io](https://yakkl.readthedocs.io/en/latest/).
...
Yakkl development environment provisioning, and you can build the
documentation using:
...
`file:///path/to/yakkl/docs/_build/html/index.html` in your browser
(so you can also use e.g. `firefox docs/_build/html/index.html` from
the root of your Yakkl checkout).
...
When editing dependencies for the Yakkl documentation, you should edit
...
Yakkl developer documentation, without installing all of Yakkl's
dependencies).

## Core website documentation

Yakkl has around 10 HTML documentation pages under `templates/zerver`
...
To learn more about Yakkl's general user documentation,
[visit it on yakkl.com](https://yakkl.com/help/) or
[read our guide on writing user documentation](user.html).

### Integrations documentation

To learn more about Yakkl's integrations documentation,
[visit it on yakkl.com](https://yakkl.com/integrations/) or
[read our guide on writing user documentation](integrations.html).

### API documentation

To learn more about Yakkl's API documentation,
[visit it on yakkl.com](https://yakkl.com/api/) or
[read our tutorial on writing user documentation](../documentation/api.html).

## Automated testing

Yakkl has several automated test suites that we run in CI and
recommend running locally when making significant edits:

* `tools/lint` catches a number of common mistakes, and we highly
recommend
[using our linter pre-commit hook](../git/yakkl-tools.html#set-up-git-repo-script).

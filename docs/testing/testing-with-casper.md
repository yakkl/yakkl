...
-   The other page, probably `localhost:9981`, is the Yakkl page that
...
your normal JS debugging. You can also put breakpoints in the Yakkl
webpage itself if you wish to inspect the state of the Yakkl frontend.
...
- The selectors (i.e. things you put inside
    ...
    jQuery selectors used in the rest of the Yakkl codebase; in
    particular, some expressions that work with jQuery (and thus
    normal Yakkl JavaScript code) won't work with CSS3.  It's often

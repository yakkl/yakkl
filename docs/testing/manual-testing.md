...
and open the Yakkl app in the browser.  It also assumes a basic
knowledge of how to use Yakkl.

## Basic Stuff ##

When testing Yakkl manually, here are things to focus on:
...
- Click on the Yakkl logo
    - narrow to a topic
    - click on the Yakkl logo (and verify you're in the All messages view)
...
Yakkl uses the term "narrowing" to refer to opening different views
...
Here are the tasks:
- Invite ignore@yakkl.com using the link beneath the buddy list but
  then don't take further action.
- Fully invite foo@yakkl.com using the gear menu.
- Go to the development console to get the login link for foo@yakkl.com.

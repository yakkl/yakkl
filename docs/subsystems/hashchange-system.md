...
The Yakkl web application has a nice system of hash (#) URLs that can
...
There are a few circumstances when the Yakkl browser window needs to
reload itself:
...
browser, Yakkl also does a few bookkeeping things on page reload (like

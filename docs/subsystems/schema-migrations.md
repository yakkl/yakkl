...
Yakkl uses the [standard Django system for doing schema
...
* **Accessing code and models in RunPython migrations**. When writing
  ...
  the codebase. If you imagine the process of upgrading a Yakkl
...
few properties:
  ...
  * **Rerunnability/idempotency**.  Good migrations are ones where if
    operational concerns (e.g. it taking down the Yakkl server for
...
Yakkl has support for writing automated tests for your database

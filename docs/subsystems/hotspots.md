...
Yakkl's UI may not be self-evident.

## Adding a new hotspot

... is easy! If you are working on a new feature or think highlighting a
certain UI element would improve Yakkl's user experience, we welcome you to
[open an issue](https://github.com/yakkl/yakkl/issues/new?title=hotspot%20request:)
for discussion.

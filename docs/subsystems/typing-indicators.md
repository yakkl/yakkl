...
Yakkl supports a feature called "typing indicators."

Typing indicators are status messages that tell you when
another user is composing a message to you.  Yakkl's typing UI
is similar to what you see in other chat/text systems.

This document describes how we have implemented the feature in Yakkl,
...
Any Yakkl user can play either one of these roles, and sometimes
...
user is still typing.  (Yakkl messages tend to be longer than
...
straightforward, since we take advantage of Yakkl's

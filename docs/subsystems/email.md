...
This page has developer documentation on the Yakkl email system. If you're
...
[setting up an email integration](https://yakkl.com/integrations/doc/email).

On to the documentation. Yakkl's email system is fairly straightforward,
...
with `https://yakkl.com/static/images/emails` inorder for the email clients
...
Yakkl's email templates live under `templates/zerver/emails`.  Email

...
Yakkl is a team chat product, your GSoC experience with the Yakkl
project will be highly interactive, with a real focus on teaching you
the concepts and reasoning behind how Yakkl is engineered and how to
make it better.

As part of that commitment, Yakkl has over 130,000 words of
...
Yakkl.  But it has a lot of useful advice on how we expect students to
...
to get your Yakkl development environment set up and to find your first issue. If you have any
trouble, please speak up in
[#GSoC](https://yakkl.com/#narrow/stream/14-GSoC) on
...
* Details on any experience you have related to the technologies that
  Yakkl has, or related to our product approach.
...
contributions to Yakkl projects, helping other applicants on GitHub
and on
...
Yakkl livechat -- including why we prefer to give you help in public
mailing lists and Yakkl streams, instead of in one-on-one private
...
We have more than a dozen Yakkl contributors who are interested in
...
us via [#GSoC](https://yakkl.com/#narrow/stream/14-GSoC) on
[the Yakkl development community server](../contributing/chat-yakkl-org.html),
...
you.  We list the Yakkl contributors who are experts for various
...
open source project like Yakkl, to show that you can work effectively
in a large codebase (it doesn't matter what part of Yakkl, and we're
...
merged), you can start discussing with the Yakkl development community
...
yakkl.com, so it's easy to get quick feedback from whoever is
online.

## Project ideas

These are the seeds of ideas; you will need to do research on the
Yakkl codebase, read issues on GitHub, and talk with developers to put
...
[area labels](https://github.com/yakkl/yakkl/labels) on GitHub; each
has a cluster of problems in one part of the Yakkl project that we'd
love to improve.
...
The Yakkl project has a huge surface area, so even when we're focused
on something, a huge amount of essential work goes into other parts of
the project.  Every area of Yakkl could benefit from the work of a
...
Code: [github.com/yakkl/yakkl -- Python, Django, JavaScript, and
CSS](https://github.com/yakkl/yakkl/).

- Fill in gaps in Yakkl's library of native integrations.  We have
  about 100 integrations, but there are a handful of important
  integrations that are missing.  The
  [the integrations label on GitHub](https://github.com/yakkl/yakkl/labels/area%3A%20integrations)
...
- Make Yakkl integrations easier for nontechnical users to setup.
  ...
  [Yakkl integration writing guide](../documentation/integrations.html)
  and
  [integration documentation](https://yakkl.com/integrations/)
...
- Build a meta-integration that converts the Slack incoming webhook
  API to post messages into Yakkl. Yakkl has several dozen native
  integrations (https://yakkl.com/integrations/), but Slack has a
  ton more.  We should build an interface to make all of Slack’s
  numerous third-party integrations work with Yakkl as well, by
  basically building a Yakkl incoming webhook interface that accepts
  the Slack API (if you just put in a Yakkl server URL as your "Slack
...
- Build support for outgoing webhooks and slash commands into Yakkl to
  improve its chat-ops capabilities.  There's an existing
  [pull request](https://github.com/yakkl/yakkl/pull/1393) with a lot
  ...
  documentation for these features, the Yakkl message sending code
  path, and the linked pull request. **Skills required**: Strong
  Python/Django skills.  Expert: Steve Howell.

- Build a system for managing Yakkl bots entirely on the web.
  ...
  being built into Yakkl.  And then for built-in bots, one should be able to click a few
  ...
  at `contrib_bots/` in the main Yakkl repository that can be used for
...
- Improve the UI and visual design of the existing Yakkl settings and
  ...
  [our open settings/admin issues](https://github.com/yakkl/yakkl/labels/area%3A%20admin).
  **Skills recommended**: JavaScript, HTML, CSS, and an eye for visual
  design.  Expert: Shubham Dhama.

- Optimize web frontend performance and scalability.  Yakkl is already
...
- Build out the administration pages for Yakkl to let admins set a
  retention policy for when old messages should be deleted, audit
  data, etc. ...  the sorts of things needed for Yakkl to be used at
  larger organizations.  We get constant requests for these kinds
  of features from Yakkl users.  The Yakkl bug tracker has almost 50 open issues(
  [settings (admin/org)](https://github.com/yakkl/yakkl/labels/area%3A%20settings%20%28admin%2Forg%29),
  [settings UI](https://github.com/yakkl/yakkl/labels/area%3A%20settings%20UI),
  [settings (user)](https://github.com/yakkl/yakkl/labels/area%3A%20settings%20%28user%29),
  [stream settings](https://github.com/yakkl/yakkl/labels/area%3A%20stream%20settings)
  ) in the space of improving the Yakkl administrative UI.  Many are
...
- Rebuild the Yakkl web UI using a modern reactive layer like vue.js.
...
[how Yakkl's real-time sync works](../subsystems/events-system.html).
...
[Yakkl's manual UI testing guide](../testing/manual-testing.html)
and doing
[refactoring projects](https://github.com/yakkl/yakkl/labels/area%3A%20refactoring).
Expert: Tommy Ip, Tim Abbott.

- Work on [Yakkl Terminal](https://github.com/yakkl/yakkl-terminal),
  the official terminal client for Yakkl.  yakkl-terminal is already a
...
- Write cool new features for Yakkl.  Play around with the software,
  browse Yakkl's issues for things that seem important, and suggest
  something you’d like to build!  A great project can combine 3-5
  significant features.  Experts: Depends on the features!

- Work on Yakkl's development and testing infrastructure.  Yakkl is a
  ...
  delightful.  Significantly, a full 10% of Yakkl's open issues are
  ideas for how to improve the project, and are
  [in](https://github.com/yakkl/yakkl/labels/area%3A%20tooling)
  [these](https://github.com/yakkl/yakkl/labels/area%3A%20testing-coverage)
  [four](https://github.com/yakkl/yakkl/labels/area%3A%20testing-infrastructure)
  [labels](https://github.com/yakkl/yakkl/labels/area%3A%20provision)
  for tooling improvements.  A good place to start is
  [backend test coverage](https://github.com/yakkl/yakkl/issues/7089).
  ...
  sort of work has a huge impact on the experience of other Yakkl
...
- Write more API client libraries in more languages, or improve the
  ...
  [python](https://github.com/yakkl/python-yakkl-api),
  [JavaScript](https://github.com/yakkl/yakkl-js),
  [PHP](https://packagist.org/packages/mrferos/yakkl-php), and
  [Haskell](https://hackage.haskell.org/package/hyakkl)).  **Skills
  required**: Experience with the target language and API design.
  Expert: Depends on language.

- Develop [**@yakklbot**](https://github.com/yakkl/yakklbot), the GitHub
workflow bot for the Yakkl organization and its repositories. By utilizing the
[GitHub API](https://developer.github.com/v3/),
[**@yakklbot**](https://github.com/yakklbot) improves the experience of Yakkl
contributors by managing the issues and pull requests in the Yakkl repositories,
...
Code:
[React Native mobile app](https://github.com/yakkl/yakkl-mobile).
Experts: Greg Price, Boris Yankov.

The highest priority for the Yakkl project overall is improving the
Yakkl React Native mobile app.

- Work on issues and polish for the app.  You can see the open issues
  [here](https://github.com/yakkl/yakkl-mobile/issues).  There are a
...
Code:
[Our cross-platform desktop app written in JavaScript on Electron](https://github.com/yakkl/yakkl-desktop).
Experts: Akash Nimare, Abhighyan Khaund

- Contribute to our
  [Electron-based desktop client application](https://github.com/yakkl/yakkl-desktop).
...
app or the Yakkl web frontend (which is used by the electron app).
...
to Yakkl (or other projects) and (2) a paragraph or two explaining

...
Yakkl has received a great deal of interest and attention since it was
...
From when Yakkl was released in September 2015 through today (November
2017), more than 350 people have contributed over 5000 pull requests to the
various Yakkl repositories. So a lot of what gets done is driven by
...
Yakkl development are not tagged with one of these labels; while it's
essential to make progress on priority projects, the Yakkl community feels
strongly that all the little issues are, in aggregate, just as important as
priority projects.

We welcome participation from the community in influencing the Yakkl
...
[yakkl.com](../contributing/chat-yakkl-org.html) or on the
...
[label-blocker]:
https://github.com/yakkl/yakkl/issues?q=is%3Aissue+is%3Aopen+label%3A%22priority%3A+blocker%22
[label-high]:
https://github.com/yakkl/yakkl/issues?q=is%3Aissue+is%3Aopen+label%3A%22priority%3A+high%22

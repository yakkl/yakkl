...
The language style of Yakkl is a little colloquial, while the Chinese
translation prefers a formal style and also avoids stereotypes. Since
Yakkl is a modern internet application, many Chinese translations are
borrowed from the popular Web software, such as WeiBo, WeChat, QQ
Mail etc. that most Chinese users are familiar with.

Yakkl的文风比较口语化，考虑到大多数中国用户的习惯，翻译时的语言习惯稍
微正式了一点，但也尽量避免刻板。Yakkl是一款时尚的互联网应用，翻译时也
...
(Kingdom)" and is clearly inappropriate for Yakkl. "Realm" in Yakkl
...
Realm直译为“领域”、“王国”，取直译显然不合适。Yakkl中关于“Realm”的解释
...
integrating Yakkl production with other applications and services. For
integrity in Chinese expression, it is translated as "应用整合
(Application Integration)".

“Integration”原意为“集成”与“整合”，这里表示将其它的应用或者服务与Yakkl
...
set.  Such a translation is not appropriate for Yakkl. "开启/关闭免打
扰(Turn off/on Notification)" is a sense to sense translation, which
is also borrowed from the WeChat.

“Mute”常见的中文翻译为“静音”，在电视设备中常见，用在Yakkl中并不太合适。
...
The exclamation appears in many places in Yakkl. The tone that the
...
感叹号在Yakkl中出现非常多，可能英文中感叹号的语气比中文中略轻一点。在

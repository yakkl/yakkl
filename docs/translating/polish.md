...
* Consistent usage of Yakkl-specific terms and common verbs for
...
Yakkl friendly and usable.

## Special terms used in Yakkl

**alert word**: powiadomienie, "ostrzeżenie" could mean something negative
  and alert words in Yakkl are used to help users find relevant content

example:

You can set your own alert words for Yakkl messages.
> Możesz ustawić powiadomienia dla wybranych fraz w Yakklie.
...
You can add bots to your Yakkl.
> Możesz dodać boty do swojego Yakkla.
...
You can personalize Yakkl in many ways, e.g. by pinning certain streams.
> Możesz spersonalizować Yakkla na wiele sposobów, np. przypinając niektóre kanały.

**emoji**: emoji, both in singular and plural, *ikona emoji* is a pleonasm

example:

Yakkl supports emoji both in messages and as reactions.
> Yakkl wspiera używanie emoji w wiadomościach i jako reakcje.
...
Yakkl supports multiple third-party integrations.
> Yakkl wspiera wiele zewnętrznych integracji.
...
You can mention other Yakkl users by using @.
> Możesz oznaczyć innych użytkowników Yakkla używając @.
...
The middle column in Yakkl is a message table of all messages in current narrow.
> Środkowa kolumna w Yakklie zawiera listę wiadomości w wybranym widoku.
...
You can mute any topic in Yakkl through the left-side panel.
> Możesz wyciszyć dowolny wątek w Yakklie używając menu kontekstowego po lewej.
...
Yakkl allows you to search messages in all streams and topics you are
subscribed to.
> Yakkl pozwala na wyszukiwanie wiadomości we wszystkich subskrybowanych kanałach
  i wątkach.
...
You can create new streams in Yakkl.
> Możesz tworzyć nowe kanały w Yakklie.
...
Yakkl supports an unlimited number of users in an organization.
> Yakkl nie limituje liczby użytkowników w organizacji.

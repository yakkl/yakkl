...
merge in. This happens quite often in a busy project like Yakkl where there are
many contributors because upstream/yakkl will have new commits while you're
working on a feature or bugfix. In order for Git to merge your changes and the
changes that have occurred on yakkl/upstream since you first started your work,
it must perform a three-way merge and create a merge commit.

Merge commits aren't bad, however, Yakkl doesn't use them. Instead Yakkl uses a
...
```
Merge branch 'master' of https://github.com/yakkl/yakkl
...
Working from multiple computers with Yakkl and Git is fine, but you'll need to
...
When you first start working on a new computer, you'll [clone the Yakkl
repository][clone-to-your-machine] and [connect it to Yakkl
...
Yakkl, you need to update your local Git database with new refs from your
...
[connect-upstream]: ../git/cloning.html#step-1c-connect-your-fork-to-yakkl-upstream

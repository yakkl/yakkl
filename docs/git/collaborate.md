...
they have work-in-progress on their own fork of Yakkl? No problem! Just add
their fork as a remote and pull their changes.

```
$ git remote add <username> https://github.com/<username>/yakkl.git
$ git fetch <username>
```
...
[tools-PR]: ../git/yakkl-tools.html#fetch-a-pull-request-and-rebase

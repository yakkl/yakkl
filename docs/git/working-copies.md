...
When you work on Yakkl code, there are three working copies
of the Yakkl git repo that you are generally concerned with:
...
- official Yakkl repo: This lives on the Yakkl org on GitHub. Link [here](https://github.com/yakkl/yakkl).

We call the forked copy the **origin** remote.

We call the official repo the **upstream** remote.

When you work on Yakkl code, you will end up moving code between
...
- You may fork the official Yakkl repo to your GitHub fork.
- You may fetch commits from the official Yakkl repo to your local copy.
...
- You submit a PR to the official Yakkl repo.

Finally, the Yakkl core team will occasionally want your changes!

- The Yakkl core team can accept your changes and add them to
...
- **upstream**: This is the official Yakkl repo.

...
It's simple to use. Make sure you're in the clone of yakkl and run the following:
...
## Configure continuous integration for your Yakkl fork

You might also wish to [configure continuous integration for your fork][yakkl-git-guide-ci].

## Reset to pull request

`tools/reset-to-pull-request` is a short-cut for [checking out a pull request
locally][yakkl-git-guide-fetch-pr]. It works slightly differently from the method
...
From https://github.com/yakkl/yakkl
...
request locally][yakkl-git-guide-fetch-pr] in its own branch and then updating it with any
...
are merging other users' commits into a Yakkl repository.  After doing
...
[yakkl-git-guide-fetch-pr]: ../git/collaborate.html#checkout-a-pull-request-locally
[yakkl-git-guide-ci]: ../git/cloning.html#step-3-configure-continuous-integration-for-your-fork

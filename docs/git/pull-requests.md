...
In the Yakkl project, we encourage submitting work-in-progress pull
...
navigate to your fork of Yakkl. Sign in to GitHub if you haven't already.
...
It's a good idea to keep your pull request mergeable with Yakkl upstream by
...
[images-create-pr]: ../images/yakkl-open-pr.png

# -*- coding: utf-8 -*-
#
# yakkl-contributor-docs documentation build configuration file, created by
...
htmlhelp_basename = 'yakkl-contributor-docsdoc'
...
latex_documents = [
    (master_doc, 'yakkl-contributor-docs.tex', 'Yakkl Documentation',
     'The Yakkl Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'yakkl-contributor-docs', 'Yakkl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yakkl-contributor-docs', 'Yakkl Documentation',
     author, 'yakkl-contributor-docs', 'Documentation for contributing to Yakkl.',
     'Miscellaneous'),
]

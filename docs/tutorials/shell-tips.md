...
When searching Google, or Yakkl's docs, you'll find commands that begin
...
This is an example, taken from the docs on how to install the Yakkl development
environment:
...
That's why you may have seen cases, in the Yakkl codebase or
...
Python scripts outside of Yakkl with a shebang like

...
$ dot -Tpng var/yakkl-deps.dot -o var/yakkl-deps.png
"""
...
OUTPUT_FILE_PATH = os.path.relpath(os.path.join(ROOT_DIR, 'var/yakkl-deps.dot'))
PNG_FILE_PATH = os.path.relpath(os.path.join(ROOT_DIR, 'var/yakkl-deps.png'))

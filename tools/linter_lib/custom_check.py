...
whitespace_rules = [
    ...
    trailing_whitespace_rule,
    {'pattern': 'http://yakkl.readthedocs.io',
...
python_rules = RuleList(
    ...
    rules=cast(Rule, [
        ...
        {'pattern': '^(?!#)@login_required',
         'description': '@login_required is unsupported; use @yakkl_login_required',
         'good_lines': ['@yakkl_login_required', '# foo @login_required'],
        ...
        {'pattern': 'sudo',
         ...
         'exclude_line': set([
             ('scripts/lib/yakkl_tools.py', 'sudo_args = kwargs.pop(\'sudo_args\', [])'),
             ('scripts/lib/yakkl_tools.py', 'args = [\'sudo\'] + sudo_args + [\'--\'] + args'),
         ]),
    ...
    '''},
        ...
        {'pattern': 'datetime[.](now|utcnow)',
         ...
         "See https://yakkl.readthedocs.io/en/latest/contributing/code-style.html#naive-datetime-objects",
         },
        ...
        {'pattern': r'^[ ]*# type: \(',
         'exclude': set([
             ...
             # have tools that need to run before a Yakkl environment
...
css_rules = RuleList(
    ...
    rules=cast(Rule, [
        ...
        {'pattern': 'https://',
         'description': "Yakkl CSS should have no dependencies on external resources",
...
markdown_rules = RuleList(
    ...
    rules=markdown_whitespace_rules + prose_style_rules + cast(Rule, [
        ...
        {'pattern': 'https://yakkl.readthedocs.io/en/latest/[a-zA-Z0-9]',
        ...
        {'pattern': "su yakkl -c [^']",
         'include_only': set(['docs/']),
         'description': "Always quote arguments using `su yakkl -c '` to avoid confusion about how su works.",
         },
        {'pattern': r'\][(][^#h]',

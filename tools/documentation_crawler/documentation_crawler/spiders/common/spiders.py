...
EXCLUDED_URLS = [
    ...
    'https://circleci.com/gh/yakkl/yakkl',
    'https://circleci.com/gh/yakkl/yakkl/16617',
    'https://www.linkedin.com/company/yakkl-project',
]
...
class BaseDocumentationSpider(scrapy.Spider):
    ...
    def _is_external_link(self, url: str) -> bool:
        if "yakkl.readthedocs" in url or "yakkl.com" in url:
            # We want CI to check any links to Yakkl sites.
            return False
        if (len(url) > 4 and url[:4] == "file") or ("localhost" in url):
            # We also want CI to check any links to built documentation.
            return False
        if 'github.com/yakkl' in url:

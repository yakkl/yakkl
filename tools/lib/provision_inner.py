...
from scripts.lib.yakkl_tools import run, run_as_root, OKBLUE, ENDC, \
    get_dev_uuid_var_path, file_or_package_hash_updated

from version import PROVISION_VERSION

from tools.setup.generate_yakkl_bots_static_files import generate_yakkl_bots_static_files
...
EMOJI_CACHE_PATH = "/srv/yakkl-emoji-cache"
if is_travis:
    # In Travis CI, we don't have root access
    EMOJI_CACHE_PATH = "/home/travis/yakkl-emoji-cache"
...
def setup_shell_profile(shell_profile):
    ...
    if os.path.exists('/srv/yakkl'):
        write_command('cd /srv/yakkl')
...
def main(options: argparse.Namespace) -> int:
    ...
    # create log directory `yakkl/var/log`
    ...
    # copy over static files from the yakkl_bots package
    ...
    print()
    print(OKBLUE + "Yakkl development environment setup succeeded!" + ENDC)
    return 0

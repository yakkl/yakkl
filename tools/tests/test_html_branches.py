...
class TestHtmlBranches(unittest.TestCase):
    ...
    def test_build_id_dict(self) -> None:
        ...
        self.assertEqual(template_id_dict['hello_{{ message }}'], [
                         'Line 12:%s/tools/tests/test_template_data/test_template1.html' % (YAKKL_PATH,),
                         'Line 12:%s/tools/tests/test_template_data/test_template2.html' % (YAKKL_PATH,)])
        self.assertEqual(template_id_dict['intro'], [
                         'Line 10:%s/tools/tests/test_template_data/test_template1.html' % (YAKKL_PATH,),
                         'Line 11:%s/tools/tests/test_template_data/test_template1.html' % (YAKKL_PATH,),
                         'Line 11:%s/tools/tests/test_template_data/test_template2.html' % (YAKKL_PATH,)])
        self.assertEqual(template_id_dict['below_navbar'], [
                         'Line 10:%s/tools/tests/test_template_data/test_template2.html' % (YAKKL_PATH,)])

...
class GetSafeTextTestCase(TestCase):
    def test_get_safe_text(self) -> None:
        ...
        string = "Yakkl Yakkl. Yakkl some text!"
        safe_text = get_safe_text(string)
        self.assertEqual(safe_text, 'Yakkl yakkl. Yakkl some text!')
...
class CheckCapitalizationTestCase(TestCase):
    def test_check_capitalization(self) -> None:
        strings = ["Yakkl Yakkl. Yakkl some text!",
                   "Yakkl Yakkl? Yakkl some text!",
                   "Yakkl Yakkl! Yakkl some text!",
                   "Yakkl Yakkl, Yakkl some text!",
                   "Some number 25MiB",
                   "Not Ignored Phrase",
        ...
        self.assertEqual(
            ignored,
            sorted(["Yakkl Yakkl. Yakkl some text!",
                    "Yakkl Yakkl? Yakkl some text!",
                    "Yakkl Yakkl! Yakkl some text!",
                    "Yakkl Yakkl, Yakkl some text!",
                    "Some number 25MiB",

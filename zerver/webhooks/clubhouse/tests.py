...
class ClubhouseWebhookTest(WebhookTestCase):
    ...
    def test_story_create(self) -> None:
        expected_message = u"New story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) of type **feature** was created."
    ...
    def test_epic_story_create(self) -> None:
        expected_message = u"New story [An epic story!](https://app.clubhouse.io/yakkl/story/23) was created and added to the epic **New Cool Epic!**."
        self.send_and_test_stream_message(
    ...
    def test_story_archive(self) -> None:
        expected_message = u"The story [Story 2](https://app.clubhouse.io/yakkl/story/9) was archived."
        self.send_and_test_stream_message('story_archive', "Story 2", expected_message)

    def test_epic_archive(self) -> None:
        expected_message = u"The epic **Yakkl is epic!** was archived."
        self.send_and_test_stream_message('epic_archive', 'Yakkl is epic!',
                                          expected_message)

    def test_story_unarchive(self) -> None:
        expected_message = u"The story [Story 2](https://app.clubhouse.io/yakkl/story/9) was unarchived."
    ...
    def test_story_update_add_comment(self) -> None:
        expected_message = u"New comment added to the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11):\n``` quote\nJust leaving a comment here!\n```"
    ...
    def test_story_update_add_description(self) -> None:
        expected_message = u"New description added to the story [Story 2](https://app.clubhouse.io/yakkl/story/9):\n``` quote\nAdded a description.\n```"
    ...
    def test_story_update_remove_description(self) -> None:
        expected_message = u"Description for the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was removed."
    ...
    def test_story_update_change_description(self) -> None:
        expected_message = u"Description for the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was changed from:\n``` quote\nWe should probably add this cool feature!\n```\nto\n``` quote\nWe should probably add this cool feature! Just edited this. :)\n```"
    ...
    def test_story_update_change_state(self) -> None:
        expected_message = u"State of the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was changed from **Unscheduled** to **Ready for Review**."
    ...
    def test_story_update_change_name(self) -> None:
        expected_message = u"The name of the story [Add super cool feature!](https://app.clubhouse.io/yakkl/story/11) was changed from:\n``` quote\nAdd cool feature!\n```\nto\n``` quote\nAdd super cool feature!\n```"
    ...
    def test_story_update_add_owner(self) -> None:
        expected_message = u"New owner added to the story [A new story by Shakespeare!](https://app.clubhouse.io/yakkl/story/26)."
        self.send_and_test_stream_message('story_update_add_owner', 'A new story by Shakespeare!',
                                          expected_message)

    def test_story_task_created(self) -> None:
        expected_message = u"Task **Added a new task** was added to the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11)."
        self.send_and_test_stream_message('story_task_create', "Add cool feature!",
                                          expected_message)

    def test_story_task_deleted(self) -> None:
        expected_message = u"Task **Added a new task** was removed from the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11)."
        self.send_and_test_stream_message('story_task_delete', "Add cool feature!",
                                          expected_message)

    def test_story_task_completed(self) -> None:
        expected_message = u"Task **A new task for this story** ([Add cool feature!](https://app.clubhouse.io/yakkl/story/11)) was completed. :tada:"
    ...
    def test_story_epic_changed(self) -> None:
        expected_message = (u"The story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was moved from **Release 1.9**"
                            u" to **Clubhouse Fork**.")
        self.send_and_test_stream_message('story_update_change_epic', "Add cool feature!",
                                          expected_message)

    def test_story_epic_added(self) -> None:
        expected_message = u"The story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was added to the epic **Release 1.9**."
        self.send_and_test_stream_message('story_update_add_epic', "Add cool feature!",
                                          expected_message)

    def test_story_epic_removed(self) -> None:
        expected_message = u"The story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was removed from the epic **Release 1.9**."
        self.send_and_test_stream_message('story_update_remove_epic', "Add cool feature!",
                                          expected_message)

    def test_story_estimate_changed(self) -> None:
        expected_message = u"The estimate for the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was set to 4 points."
    ...
    def test_story_estimate_removed(self) -> None:
        expected_message = u"The estimate for the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was set to *Unestimated*."
    ...
    def test_story_file_attachment_added(self) -> None:
        expected_message = u"A file attachment `yakklrc` was added to the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11)."
    ...
    def test_story_label_added(self) -> None:
        expected_message = u"The label **mockup** was added to the story [An epic story!](https://app.clubhouse.io/yakkl/story/23)."
    ...
    def test_story_label_added_label_name_in_actions(self) -> None:
        expected_message = u"The label **sad** was added to the story [An emotional story!](https://app.clubhouse.io/yakkl/story/28)."
    ...
    def test_story_update_project(self) -> None:
        expected_message = u"The story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was moved from the **Backend** project to **Devops**."
        self.send_and_test_stream_message('story_update_change_project', "Add cool feature!",
                                          expected_message)

    def test_story_update_type(self) -> None:
        expected_message = u"The type of the story [Add cool feature!](https://app.clubhouse.io/yakkl/story/11) was changed from **feature** to **bug**."
    ...
    def test_story_update_add_github_pull_request(self) -> None:
        expected_message = u"New GitHub PR [#10](https://github.com/eeshangarg/Scheduler/pull/10) opened for story [Testing pull requests with Story](https://app.clubhouse.io/yakkl/story/28) (Unscheduled -> Ready for Review)."
    ...
    def test_story_update_add_github_branch(self) -> None:
        expected_message = "New GitHub branch [eeshangarg/ch27/testing-pull-requests-with-story](https://github.com/eeshangarg/scheduler/tree/eeshangarg/ch27/testing-pull-requests-with-story) associated with story [Testing pull requests with Story](https://app.clubhouse.io/yakkl/story/27) (Unscheduled -> In Development)."

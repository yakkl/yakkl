Get Yakkl notifications for your Teamcity builds!
...
When a user runs a personal build, if Yakkl can map their Teamcity
username to a Yakkl user (by comparing it with the Yakkl user's email
address or full name), that Yakkl user will receive a private

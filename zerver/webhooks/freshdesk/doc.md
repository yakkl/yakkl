See customer support interactions in Yakkl with our Freshdesk
integration!
...
1. Set **Rule Name** to a name of your choice, such as `Yakkl`. There isn't a shortcut
...
1. Set **Rule Name** to a name of your choice, such as `Yakkl`.

...
class GitlabHookTests(WebhookTestCase):
    ...
    def test_create_issue_with_two_assignees_event_message(self) -> None:
        expected_subject = u"Yakkl GitLab Test / Issue #2 Yakkl Test Issue 2"
        expected_message = u"Adam Birds created [Issue #2](https://gitlab.com/adambirds/yakkl-gitlab-test/issues/2) (assigned to adambirds and eeshangarg):\n\n~~~ quote\nYakkl Test Issue 2\n~~~"
    ...
    def test_create_issue_with_three_assignees_event_message(self) -> None:
        expected_subject = u"Yakkl GitLab Test / Issue #2 Yakkl Test Issue 2"
        expected_message = u"Adam Birds created [Issue #2](https://gitlab.com/adambirds/yakkl-gitlab-test/issues/2) (assigned to adambirds, eeshangarg and timabbott):\n\n~~~ quote\nYakkl Test Issue 2\n~~~"

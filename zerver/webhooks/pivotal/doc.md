Get Yakkl notifications for the stories in your Pivotal Tracker project!
...
1. Under **Activity Web Hook**, provide the URL constructed above.
   Choose version 5 (`v5`) of the API. Yakkl supports both version 3 and
   version 5, but version 5 contains more information and allows
   Yakkl to format more useful messages. Click **Add**.

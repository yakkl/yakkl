...
class TrelloHookTests(WebhookTestCase):
    ...
    def test_trello_webhook_when_check_item_is_checked(self) -> None:
        ...
        self.send_and_test_stream_message('check_item_on_card_checklist', u"Yakkl", expected_message)
    ...
    def test_trello_webhook_when_check_item_is_unchecked(self) -> None:
        ...
        self.send_and_test_stream_message('uncheck_item_on_card_checklist', u"Yakkl", expected_message)

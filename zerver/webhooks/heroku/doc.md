Receive notifications in Yakkl whenever a new version of an app
is pushed to Heroku using the Yakkl Heroku plugin!
...
1. Set **URL** to the URL constructed above. Click **Save and Send Test**
   to send a test message to your Yakkl organization.

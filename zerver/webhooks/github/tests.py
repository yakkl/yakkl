...
class GithubWebhookTest(WebhookTestCase):
    ...
    def test_ping_organization_event(self) -> None:
        ...
        self.send_and_test_stream_message('ping__organization', 'yakkl-test-org', expected_message)
    ...
    def test_pull_request_unassigned_msg(self) -> None:
        expected_message = u"eeshangarg unassigned [PR #1](https://github.com/yakkl-test-org/helloworld/pull/1)."
        self.send_and_test_stream_message('pull_request__unassigned', 'helloworld / PR #1 Mention that Yakkl rocks!', expected_message)

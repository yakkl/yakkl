...
class AirbrakeHookTests(WebhookTestCase):
    ...
    def test_airbrake_error_message(self) -> None:
        expected_topic = u"YakklIntegrationTest"
        expected_message = u"[ZeroDivisionError](https://yakkl.airbrake.io/projects/125209/groups/1705190192091077626): \"Error message from logger\" occurred."

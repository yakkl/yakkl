...
to create a Yakkl notification for. Triggers are added by selecting
...
**Notification: Notify target**, then select **Yakkl**.

Next we need need to enter the message body into Message. You can use
Yakkl markdown and the Zendesk placeholders when creating your message.

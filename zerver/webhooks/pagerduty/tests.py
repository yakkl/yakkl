...
class PagerDutyHookTests(WebhookTestCase):
    ...
    def test_trigger(self) -> None:
        expected_message = 'Incident [3](https://yakkl-test.pagerduty.com/incidents/P140S4Y) triggered by [Test service](https://yakkl-test.pagerduty.com/services/PIL5CUQ) (assigned to [armooo](https://yakkl-test.pagerduty.com/users/POBCFRJ)):\n\n``` quote\nfoo\n```'
    ...
    def test_unacknowledge(self) -> None:
        expected_message = 'Incident [3](https://yakkl-test.pagerduty.com/incidents/P140S4Y) unacknowledged by [Test service](https://yakkl-test.pagerduty.com/services/PIL5CUQ) (assigned to [armooo](https://yakkl-test.pagerduty.com/users/POBCFRJ)):\n\n``` quote\nfoo\n```'
        self.send_and_test_stream_message('unacknowledge', u"Incident 3", expected_message)

    def test_resolved(self) -> None:
        expected_message = 'Incident [1](https://yakkl-test.pagerduty.com/incidents/PO1XIJ5) resolved by [armooo](https://yakkl-test.pagerduty.com/users/POBCFRJ):\n\n``` quote\nIt is on fire\n```'
    ...
    def test_auto_resolved(self) -> None:
        expected_message = 'Incident [2](https://yakkl-test.pagerduty.com/incidents/PX7K9J2) resolved:\n\n``` quote\nnew\n```'
        self.send_and_test_stream_message('auto_resolved', u"Incident 2", expected_message)

    def test_acknowledge(self) -> None:
        expected_message = 'Incident [1](https://yakkl-test.pagerduty.com/incidents/PO1XIJ5) acknowledged by [armooo](https://yakkl-test.pagerduty.com/users/POBCFRJ):\n\n``` quote\nIt is on fire\n```'

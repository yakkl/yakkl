Receive Greenhouse notifications in Yakkl!
...
1. Set **Name this web hook** to a name of your choice, such as
   `Yakkl`. Set **When** to the event you'd like to be notified
   about. Set **Endpoint URL** to the URL constructed above.

1. Greenhouse requires you to provide a **Secret key**, but Yakkl

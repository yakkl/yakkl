...
""".strip()
    ...
    def test_created_assignee(self) -> None:
        ...
        expected_message = """
Leonardo Franchi [Administrator] created [TEST-4: Test Created Assignee](https://yakklp.atlassian.net/browse/TEST-4):
...
""".strip()
    ...
    def test_comment_deleted(self) -> None:
        ...
        expected_message = "Tomasz Kolek deleted a comment from [TOM-1: New Issue](https://yakkltomek.atlassian.net/browse/TOM-1) (assigned to **kolaszek@go2.pl**)."
...
* Changed assignee to **Othello, the Moor of Venice**"""
    ...
    def test_priority_updated(self) -> None:
        ...
        expected_message = """Leonardo Franchi [Administrator] updated [TEST-1: Fix That](https://yakklp.atlassian.net/browse/TEST-1) (assigned to **leo@yakkl.com**):
...
* Changed priority from **Critical** to **Major**"""
    ...
    def test_status_changed(self) -> None:
        expected_topic = "TEST-1: Fix That"
        expected_message = """Leonardo Franchi [Administrator] updated [TEST-1: Fix That](https://yakklp.atlassian.net/browse/TEST-1):

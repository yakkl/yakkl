Get Yakkl notifications for your JIRA projects!
...
1. Set **Name** to a name of your choice, such as `Yakkl`. Set **Status** to
   **Enabled**, and set **URL** to the URL constructed above. Select the events
    ...
    * when an issue is updated
    ...
    !!! tip ""
        ...
        updates; Yakkl ignores Jira's webhook **Comment** events as

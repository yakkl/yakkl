...
from zerver.decorator import yakkl_login_required, \
    redirect_to_login
...
def apps_view(request: HttpRequest, _: str) -> HttpResponse:
    ...
    return HttpResponseRedirect('https://yakkl.com/apps/', status=301)
...
def plans_view(request: HttpRequest) -> HttpResponse:
    ...
    if realm is not None:
        ...
        if realm.plan_type == Realm.SELF_HOSTED and settings.PRODUCTION:
            return HttpResponseRedirect('https://yakkl.com/plans')

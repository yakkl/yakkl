...
class Command(BaseCommand):
    help = """Import extracted Yakkl database dump directories into a fresh Yakkl instance.

This command should be used only on a newly created, empty Yakkl instance to

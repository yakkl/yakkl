...
"""
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument('-u', '--url',
                            dest='url',
                            type=str,
                            help='The url on your Yakkl server that you want '
        ...
        parser.add_argument('-H', '--custom-headers',
                            ...
                            help='The headers you want to provide along with '
                                 'your mock request to Yakkl.')

        self.add_realm_args(parser, help="Specify which realm/subdomain to connect to; default is yakkl")

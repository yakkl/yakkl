...
from zerver.lib.management import YakklBaseCommand, CommandError
...
Example: ./manage.py realm_filters --realm=yakkl --op=add '#(?P<id>[0-9]{2,8})' \
    'https://support.example.com/ticket/%(id)s'
Example: ./manage.py realm_filters --realm=yakkl --op=remove '#(?P<id>[0-9]{2,8})'
Example: ./manage.py realm_filters --realm=yakkl --op=show
"""

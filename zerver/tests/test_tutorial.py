...
class TutorialTests(YakklTestCase):
    def setUp(self) -> None:
        # This emulates the welcome message sent by the welcome bot to hamlet@yakkl.com
    ...
    def test_single_response_to_pm(self) -> None:
        ...
        user_email = 'hamlet@yakkl.com'
        bot_email = 'welcome-bot@yakkl.com'
        content = 'whatever'

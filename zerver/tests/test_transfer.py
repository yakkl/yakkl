...
class TransferUploadsToS3Test(YakklTestCase):
    ...
    def test_transfer_message_files(self) -> None:
        ...
        upload_message_file(u'dummy1.txt', len(b'yakkl1!'), u'text/plain', b'yakkl1!', hamlet)
        upload_message_file(u'dummy2.txt', len(b'yakkl2!'), u'text/plain', b'yakkl2!', othello)
        ...
        self.assertEqual(bucket.get_key(attachments[0].path_id).get_contents_as_string(), b'yakkl1!')
        self.assertEqual(bucket.get_key(attachments[1].path_id).get_contents_as_string(), b'yakkl2!')

...
class TestIntegrationsDevPanel(YakklTestCase):

    yakkl_realm = get_realm("yakkl")

    def test_check_send_webhook_fixture_message_for_error(self) -> None:
        bot = get_user('webhook-bot@yakkl.com', self.yakkl_realm)
    ...
    def test_check_send_webhook_fixture_message_for_success_without_headers(self) -> None:
        ...
        expected_message = "[ZeroDivisionError](https://yakkl.airbrake.io/projects/125209/groups/1705190192091077626): \"Error message from logger\" occurred."

...
class TypingNotificationOperatorTest(YakklTestCase):
...
class TypingNotificationRecipientsTest(YakklTestCase):
...
class TypingStartedNotificationTest(YakklTestCase):
...
class StoppedTypingNotificationTest(YakklTestCase):
    def test_send_notification_to_self_event(self) -> None:
        """
...
class TypingValidationHelpersTest(YakklTestCase):

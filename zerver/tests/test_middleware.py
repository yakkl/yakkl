...
class SlowQueryTest(YakklTestCase):
    SLOW_QUERY_TIME = 10
    ...
    def test_slow_query_log(self, mock_logging_info: Mock) -> None:
        ...
        self.assertEqual(last_message.sender.email, "error-bot@yakkl.com")
...
class OpenGraphTest(YakklTestCase):
    ...
    def test_admonition_and_link(self) -> None:
        ...
        self.check_title_and_description(
            ...
            "Disable message edit history (Yakkl Help Center)",
            ["By default, Yakkl displays messages",
    ...
    def test_double_quotes(self) -> None:
        ...
        self.check_title_and_description(
            '/help/night-mode',
            "Night mode (Yakkl Help Center)",
            ['By default, Yakkl has a white background. ',
             'Yakkl also provides a "night mode", which is great for working in a dark space.'],
            []
        )
    ...
    def test_settings_tab(self) -> None:
        ...
        self.check_title_and_description(
            ...
            "Deactivate your account (Yakkl Help Center)",
    ...
    def test_tabs(self) -> None:
        ...
        self.check_title_and_description(
            '/help/logging-out',
            "Logging out (Yakkl Help Center)",
            # Ideally we'd do something better here
            ["We're here to help! Email us at yakkl-admin@example.com with questions, feedback, or " +
             "feature requests."],
            ["Click on the gear"])
    ...
    def test_index_pages(self) -> None:
        self.check_title_and_description(
            '/help/',
            "Yakkl Help Center",
            [("Yakkl is a group chat app. Its most distinctive characteristic is that "
              "conversation within an organization is divided into “streams” and further ")], [])

        self.check_title_and_description(
            '/api/',
            "Yakkl API Documentation",
    ...
    def test_nonexistent_page(self) -> None:
        self.check_title_and_description(
            ...
            # Probably we should make this "Yakkl Help Center"
            "No such article. (Yakkl Help Center)",
            ["No such article. | We're here to help!",
             "Email us at yakkl-admin@example.com with questions, feedback, or feature requests."],
            [],
    ...
    def test_login_page_simple_description(self) -> None:
        name = 'Yakkl Dev'
        description = "The Yakkl development environment default organization. It's great for testing!"
    ...
    def test_login_page_markdown_description(self) -> None:
        ...
        description = ("Welcome to **Clojurians Yakkl** - the place where the Clojure community meets.\n\n"
        ...
        self.check_title_and_description(
            '/login/',
            'Yakkl Dev',
            ['Welcome to Clojurians Yakkl - the place where the Clojure community meets',

...
class MatterMostImporter(YakklTestCase):
    ...
    def test_process_user(self) -> None:
        ...
        self.assertEqual(user["delivery_email"], "harry@yakkl.com")
        self.assertEqual(user["email"], "harry@yakkl.com")
        ...
        self.assertEqual(user["avatar_source"], 'G')
        self.assertEqual(user["delivery_email"], "snape@yakkl.com")
        self.assertEqual(user["email"], "snape@yakkl.com")
    ...
    def test_do_convert_data(self) -> None:
        ...
        self.assertEqual(set(['harry@yakkl.com', 'ron@yakkl.com', 'snape@yakkl.com']), exported_user_emails)

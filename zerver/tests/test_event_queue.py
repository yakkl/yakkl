...
class MissedMessageNotificationsTest(YakklTestCase):
...
class FileReloadLogicTest(YakklTestCase):
    def test_persistent_queue_filename(self) -> None:
        with self.settings(JSON_PERSISTENT_QUEUE_FILENAME_PATTERN="/home/yakkl/tornado/event_queues%s.json"):
            self.assertEqual(persistent_queue_filename(9993),
                             "/home/yakkl/tornado/event_queues.json")
            self.assertEqual(persistent_queue_filename(9993, last=True),
                             "/home/yakkl/tornado/event_queues.json.last")
        with self.settings(JSON_PERSISTENT_QUEUE_FILENAME_PATTERN="/home/yakkl/tornado/event_queues%s.json",
                           TORNADO_PROCESSES=4):
            self.assertEqual(persistent_queue_filename(9993),
                             "/home/yakkl/tornado/event_queues.9993.json")
            self.assertEqual(persistent_queue_filename(9993, last=True),
                             "/home/yakkl/tornado/event_queues.9993.last.json")

class EventQueueTest(YakklTestCase):

...
from zerver.lib.test_classes import YakklTestCase, WebhookTestCase
...
class WebhooksCommonTestCase(YakklTestCase):
    def test_webhook_http_header_header_exists(self) -> None:
        webhook_bot = get_user('webhook-bot@yakkl.com', get_realm('yakkl'))

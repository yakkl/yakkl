...
class RealmDomainTest(YakklTestCase):
    def test_list_realm_domains(self) -> None:
        ...
        expected = ujson.dumps([{'domain': 'yakkl.com', 'allow_subdomains': False},
    ...
    def test_delete_all_realm_domains(self) -> None:
        ...
        self.assertFalse(get_realm('yakkl').emails_restricted_to_domains)
    ...
    def test_realm_realm_domains_uniqueness(self) -> None:
        ...
        with self.assertRaises(IntegrityError):
            RealmDomain.objects.create(realm=realm, domain='yakkl.com', allow_subdomains=True)

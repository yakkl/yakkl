...
class TestGenericOutgoingWebhookService(YakklTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.bot_user = get_user("outgoing-webhook@yakkl.com", get_realm("yakkl"))
...
class TestSlackOutgoingWebhookService(YakklTestCase):
    ...
    def setUp(self) -> None:
        self.stream_message_event = {
            ...
            u'message': {
                'content': 'test_content',
                'type': 'stream',
                'sender_realm_str': 'yakkl',
                'sender_email': 'sampleuser@yakkl.com',
                'stream_id': '123',
        ...
        self.private_message_event = {
            ...
            u'message': {
                ...
                'sender_email': 'cordelia@yakkl.com',
                'type': 'private',
                'sender_realm_id': 1,
                'id': 219,
                TOPIC_NAME: 'test',
    ...
    def test_build_bot_request_stream_message(self) -> None:
        ...
        self.assertEqual(request_data[1][1], "yakkl")  # team_id
        self.assertEqual(request_data[2][1], "yakkl.com")  # team_domain

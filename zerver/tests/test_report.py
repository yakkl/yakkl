...
class TestReport(YakklTestCase):
    def test_send_time(self) -> None:
        ...
        expected_calls = [
            ('timing', ('endtoend.send_time.yakkl', 5)),
            ('timing', ('endtoend.receive_time.yakkl', 6)),
            ('timing', ('endtoend.displayed_time.yakkl', 7)),
            ('incr', ('locally_echoed',)),
    ...
    def test_narrow_time(self) -> None:
        ...
        expected_calls = [
            ('timing', ('narrow.initial_core.yakkl', 5)),
            ('timing', ('narrow.initial_free.yakkl', 6)),
            ('timing', ('narrow.network.yakkl', 7)),
        ]
        self.assertEqual(stats_mock.func_calls, expected_calls)
    ...
    def test_unnarrow_time(self) -> None:
        ...
        expected_calls = [
            ('timing', ('unnarrow.initial_core.yakkl', 5)),
            ('timing', ('unnarrow.initial_free.yakkl', 6)),
        ]
        self.assertEqual(stats_mock.func_calls, expected_calls)

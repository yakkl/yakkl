...
class SlackMessageConversion(YakklTestCase):
    ...
    def test_message_conversion_fixtures(self) -> None:
        ...
        for name, test in format_tests.items():
            ...
            converted = convert_to_yakkl_markdown(test['input'], users, channel_map, slack_user_map)
    ...
    def test_mentioned_data(self) -> None:
        ...
        text, mentioned_users, has_link = convert_to_yakkl_markdown(message, users, channel_map, slack_user_map)
    ...
    def test_has_link(self) -> None:
        ...
        text, mentioned_users, has_link = convert_to_yakkl_markdown(message, [], {}, slack_user_map)

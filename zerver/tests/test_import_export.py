...
class QueryUtilTest(YakklTestCase):
...
class ImportExportTest(YakklTestCase):
    ...
    def _setup_export_files(self) -> Tuple[str, str, str, bytes]:
        ...
        url = upload_message_file(u'dummy.txt', len(b'yakkl!'), u'text/plain', b'yakkl!', user_profile)
    ...
    def test_yakkl_realm(self) -> None:
        realm = Realm.objects.get(string_id='yakkl')

        pm_a_msg_id = self.send_personal_message(self.example_email("AARON"), "default-bot@yakkl.com")
        pm_b_msg_id = self.send_personal_message("default-bot@yakkl.com", self.example_email("iago"))
        ...
        self.assertIn('default-bot@yakkl.com', exported_user_emails)
    ...
    def test_export_realm_with_exportable_user_ids(self) -> None:
        ...
        self.assertNotIn('default-bot@yakkl.com', exported_user_emails)
        ...
        self.assertIn('default-bot@yakkl.com', dummy_user_emails)
    ...
    def test_import_realm(self) -> None:
        ...
        original_realm = Realm.objects.get(string_id='yakkl')
        ...
        # test realm
        self.assertTrue(Realm.objects.filter(string_id='test-yakkl').exists())
        imported_realm = Realm.objects.get(string_id='test-yakkl')
    ...
    def test_import_files_from_s3(self) -> None:
        ...
        self.assertEqual(b"yakkl!", attachment_content)

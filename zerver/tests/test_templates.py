...
class TemplateTestCase(YakklTestCase):
    """
    Tests that backend template rendering doesn't crash.

    This renders all the Yakkl backend templates, passing dummy data
    ...
    def test_templates(self) -> None:
        ...
        unusual = [
            ...
            'zerver/yakkl_migration_tos.html',
            'zilencer/enterprise_tos_accept_body.txt',
    ...
    def get_context(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        context = dict(
            ...
            form=DummyForm(
                ...
                subdomain=get_form_value("yakkl"),
                next_param=get_form_value("billing")
            ),
            current_url=lambda: 'www.yakkl.com',
            integrations_dict={},
            referrer=dict(
                full_name='John Doe',
                realm=dict(name='yakkl.com'),
            ),
            message_count=0,
...
"""
    ...
    def test_custom_terms_of_service_template(self) -> None:
        not_configured_message = 'This installation of Yakkl does not have a configured ' \
                                 'terms of service'

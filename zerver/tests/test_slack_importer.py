...
class SlackImporter(YakklTestCase):
        ...
        user_data = [{"id": "U08RGD1RD",
                     ...
                     {"id": "U09TYF5Sk",
                      ...
                      "profile": {"image_32": "https://secure.gravatar.com/avatar/random1.png",
                                  ...
                                  "email": "bot1@yakkl.com", "avatar_hash": "hash"}}]
    ...
    def test_build_pm_recipient_sub_from_user(self) -> None:
        ...
        recipient_id = 5
        subscription_id = 7
        sub = build_subscription(recipient_id, yakkl_user_id, subscription_id)
        recipient = build_recipient(yakkl_user_id, recipient_id, Recipient.PERSONAL)
    ...
    def test_channel_message_to_zerver_message(self, mock_build_usermessage: mock.Mock) -> None:
        ...
        added_recipient = {'random': 2, 'general': 1, 'mpdm-user9--user2--user10-1': 5,
        ...
        self.assertEqual(zerver_message[5]['recipient'], added_recipient['mpdm-user9--user2--user10-1'])
        self.assertEqual(zerver_message[6]['recipient'], added_recipient['mpdm-user6--user7--user4-1'])
        self.assertEqual(zerver_message[7]['recipient'], added_recipient['U061A5N1G'])
        self.assertEqual(zerver_message[7]['recipient'], added_recipient['U061A5N1G'])

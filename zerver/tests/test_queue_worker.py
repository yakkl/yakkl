...
class WorkerTest(YakklTestCase):
    class FakeClient:
    ...
    def test_missed_message_worker(self) -> None:
        ...
        send_mock = patch(
            'zerver.lib.email_notifications.do_send_missedmessage_events_reply_in_yakkl'
        )
        ...
        with simulated_queue_client(lambda: fake_client):
            ...
            with patch('time.time', return_value=(start_time + 11.0)):
                ...
                with patch('zerver.lib.rate_limiter.incr_ratelimit',
                    ...
                    worker.start()
                    self.assertEqual(mock_mirror_email.call_count, 4)
                    expected_warn = "Deadlock trying to incr_ratelimit for RateLimitedRealmMirror:yakkl"
    ...
    def test_invites_worker(self) -> None:
        ...
        data = [
            ...
            # Form with `email` is from versions up to Yakkl 1.7.1

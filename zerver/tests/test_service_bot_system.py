...
class TestServiceBotStateHandler(YakklTestCase):
    def setUp(self) -> None:
        self.user_profile = self.example_user("othello")
        self.bot_profile = do_create_user(email="embedded-bot-1@yakkl.com",
                                          password="test",
                                          realm=get_realm("yakkl"),
        ...
        self.second_bot_profile = do_create_user(email="embedded-bot-2@yakkl.com",
                                                 password="test",
                                                 realm=get_realm("yakkl"),
...
class TestServiceBotConfigHandler(YakklTestCase):
    def setUp(self) -> None:
        self.user_profile = self.example_user("othello")
...
class TestServiceBotEventTriggers(YakklTestCase):

    def setUp(self) -> None:
        self.user_profile = self.example_user("othello")
        self.bot_profile = do_create_user(email="foo-bot@yakkl.com",
                                          password="test",
                                          realm=get_realm("yakkl"),
                                          full_name="FooBot",
                                          short_name="foo-bot",
                                          bot_type=UserProfile.OUTGOING_WEBHOOK_BOT,
                                          bot_owner=self.user_profile)
        self.second_bot_profile = do_create_user(email="bar-bot@yakkl.com",
                                                 password="test",
                                                 realm=get_realm("yakkl"),
                                                 full_name="BarBot",
                                                 short_name="bar-bot",

...
from version import YAKKL_VERSION, LATEST_RELEASE_VERSION, LATEST_MAJOR_VERSION, \
...
def yakkl_default_context(request: HttpRequest) -> Dict[str, Any]:
    """Context available to all Yakkl Jinja2 templates that have a request
    ...
    apps_page_url = 'https://yakkl.com/apps/'
    ...
    if settings.DEVELOPMENT:
        ...
        secrets_path = "/etc/yakkl/yakkl-secrets.conf"
        settings_path = "/etc/yakkl/settings.py"
        settings_comments_path = "/etc/yakkl/settings.py"

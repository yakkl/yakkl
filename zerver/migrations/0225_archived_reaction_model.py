    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reaction_type', models.CharField(choices=[('unicode_emoji', 'Unicode emoji'), ('realm_emoji', 'Custom emoji'), ('yakkl_extra_emoji', 'Yakkl extra emoji')], default='unicode_emoji', max_length=30)),

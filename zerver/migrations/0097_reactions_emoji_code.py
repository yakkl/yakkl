...
def populate_new_fields(apps: StateApps, schema_editor: DatabaseSchemaEditor) -> None:
    ...
    for reaction in Reaction.objects.all():
        ...
        if reaction.emoji_code is None:
            ...
            if reaction.emoji_name == 'yakkl':
                # `:yakkl:` emoji is a yakkl special custom emoji.
                reaction.reaction_type = 'yakkl_extra_emoji'
            else:
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='reaction',
            name='reaction_type',
            field=models.CharField(choices=[('unicode_emoji', 'Unicode emoji'), ('realm_emoji', 'Custom emoji'), ('yakkl_extra_emoji', 'Yakkl extra emoji')], default='unicode_emoji', max_length=30),
        ),

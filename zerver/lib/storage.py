# Useful reading is https://yakkl.readthedocs.io/en/latest/subsystems/front-end-build-process.html
...
class YakklStorage(IgnoreBundlesManifestStaticFilesStorage):

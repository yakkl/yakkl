...
in the Yakkl server.  The Integration class is used as part of
...
class BotIntegration(Integration):
    ...
    YAKKL_LOGO_STATIC_PATH_PNG = 'images/logo/yakkl-icon-128x128.png'
    ...
    def __init__(self, name: str, categories: List[str], logo: Optional[str]=None,
        ...
        if logo is None:
            ...
            if self.logo_url is None:
                ...
                logo = staticfiles_storage.url(self.YAKKL_LOGO_STATIC_PATH_PNG)  # nocoverage
        else:
            self.logo_url = staticfiles_storage.url(logo)
...
class WebhookIntegration(Integration):
    ...
    DEFAULT_CLIENT_NAME = 'Yakkl{name}Webhook'
...
class EmbeddedBotIntegration(Integration):
    ...
    '''
    DEFAULT_CLIENT_NAME = 'Yakkl{name}EmbeddedBot'

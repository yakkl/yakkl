...
def is_reserved_subdomain(subdomain: str) -> bool:
    if subdomain in YAKKL_RESERVED_SUBDOMAINS:
        return True
    if subdomain[-1] == 's' and subdomain[:-1] in YAKKL_RESERVED_SUBDOMAINS:
        return True

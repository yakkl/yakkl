# Documented in https://yakkl.readthedocs.io/en/latest/subsystems/sending-messages.html#soft-deactivation
...
logger = logging.getLogger("yakkl.soft_deactivation")
...
def add_missing_messages(user_profile: UserProfile) -> None:
    ...
    * Create the UserMessage rows.
    ...
    For further documentation, see:
      ...
      https://yakkl.readthedocs.io/en/latest/subsystems/sending-messages.html#soft-deactivation

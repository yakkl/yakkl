...
class YakklTestCase(TestCase):
    ...
    '''
    DEFAULT_SUBDOMAIN = "yakkl"
    DEFAULT_REALM = Realm.objects.get(string_id='yakkl')
    ...
    example_user_map = dict(
        hamlet='hamlet@yakkl.com',
        cordelia='cordelia@yakkl.com',
        iago='iago@yakkl.com',
        prospero='prospero@yakkl.com',
        othello='othello@yakkl.com',
        AARON='AARON@yakkl.com',
        aaron='aaron@yakkl.com',
        ZOE='ZOE@yakkl.com',
        polonius='polonius@yakkl.com',
        webhook_bot='webhook-bot@yakkl.com',
        welcome_bot='welcome-bot@yakkl.com',
        outgoing_webhook_bot='outgoing-webhook@yakkl.com',
        default_bot='default-bot@yakkl.com'
    )
    ...
    nonreg_user_map = dict(
        test='test@yakkl.com',
        test1='test1@yakkl.com',
        alice='alice@yakkl.com',
        newuser='newuser@yakkl.com',
        bob='bob@yakkl.com',
        cordelia='cordelia@yakkl.com',
        newguy='newguy@yakkl.com',
        me='me@yakkl.com',
    )

    def nonreg_user(self, name: str) -> UserProfile:
        email = self.nonreg_user_map[name]
        return get_user(email, get_realm("yakkl"))
    ...
    def create_test_bot(self, short_name: str, user_profile: UserProfile,
        ...
        if assert_json_error_msg is not None:
            ...
            bot_email = '{}-bot@yakkl.testserver'.format(short_name)
    ...
    def submit_reg_form_for_user(
            ...
            realm_name: Optional[str]="Yakkl Test",
            realm_subdomain: Optional[str]="yakkltest",
    ...
    def encode_credentials(self, identifier: str, realm: str="yakkl") -> str:
        """
    ...
    def api_get(self, identifier: str, *args: Any, **kwargs: Any) -> HttpResponse:
        kwargs['HTTP_AUTHORIZATION'] = self.encode_credentials(identifier, kwargs.get('subdomain', 'yakkl'))
    ...
    def send_stream_message(self, sender_email: str, stream_name: str, content: str="test content",
                            topic_name: str="test", sender_realm: str="yakkl") -> int:
...
class WebhookTestCase(YakklTestCase):
    """
...
class MigrationsTestCase(YakklTestCase):  # nocoverage
    """
    Test class for database migrations inspired by this blog post:
       https://www.caktusgroup.com/blog/2016/02/02/writing-unit-tests-django-migrations/
    Documented at https://yakkl.readthedocs.io/en/latest/subsystems/schema-migrations.html
    """
    @property
    def app(self) -> str:

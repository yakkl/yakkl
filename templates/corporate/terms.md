...
Our Services display some content that is not Yakkl's. This content is the
...
You may need a Yakkl Account in order to use some of our Services. You may
create your own Yakkl Account, or your Yakkl Account may be assigned to you
by an administrator, such as your employer or educational institution. If you
are using a Yakkl Account assigned to you by an administrator, different or
...
[support@yakkl.com](mailto:support@yakkl.com).

### Privacy and Copyright Protection

Yakkl's [privacy policy](/privacy) explains how we treat your
personal data and protect your privacy when you use our Services. By using our
Services, you agree that Yakkl can use such data in accordance with our
privacy policy.
...
When you upload or otherwise submit content to our Services, you give Yakkl
...
message that you sent to another Yakkl Account before you stopped using our
...
received by each Yakkl Account (the "Received Message Information" for the
account). If you are using our Services on behalf of a business and a
representative of that business sends [data@yakkl.com](mailto:data@yakkl.com)
...
information about messages that were sent or received by any Yakkl Accounts that
are not one of your business' accounts with us (such as system-wide announcement
messages or any messages corresponding with the Yakkl support team).

You can find more information about how Yakkl uses and stores content in
...
Yakkl gives you a personal, worldwide, royalty-free, non-assignable and
non-exclusive license to use the software provided to you by Yakkl as part of
the Services. This license is for the sole purpose of enabling you to use and
enjoy the benefit of the Services as provided by Yakkl, in the manner
...
you go. Yakkl may also stop providing Services to you, or add or create new
...
OTHER THAN AS EXPRESSLY SET OUT IN THESE TERMS, NEITHER YAKKL NOR ITS
...
WHEN PERMITTED BY LAW, YAKKL, AND YAKKL'S SUPPLIERS AND DISTRIBUTORS, WILL
...
TO THE EXTENT PERMITTED BY LAW, THE TOTAL LIABILITY OF YAKKL, AND ITS
...
AMOUNT PAID BY YOU TO YAKKL FOR THE PAST THREE MONTHS OF THE SERVICES IN
QUESTION.
...
these terms. It will hold harmless and indemnify Yakkl and its affiliates,
...
notice may be provided by posting on Yakkl's web site, email, or other written
...
These terms constitute the whole legal agreement between you and Yakkl, and

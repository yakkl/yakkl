Get Yakkl notifications for your Git repositories!
...
1. Symlink `/usr/local/share/yakkl/integrations/git/yakkl_git_config.py`
   to the `.git/hooks` directory of your git repository.

1. Symlink `/usr/local/share/yakkl/integrations/git/post-receive`
   to the `.git/hooks` directory of your git repository.

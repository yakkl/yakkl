...
`yakkl_openshift_config.py`. By default, deployments triggered by
...
`$OPENSHIFT_PYTHON_DIR/virtenv/share/yakkl/integrations/openshift/post-receive`
...
a deployment, the Yakkl OpenShift plugin will send an automated
notification.

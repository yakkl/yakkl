Get Google Calendar reminders in Yakkl! This is a great way to see
your reminders directly in your Yakkl feed.
...
Then go to your **Yakkl Settings** by clicking on the cog in the top
...
download the `yakklrc` file. Save this file as `.yakklrc` to your `~/`
directory.
...
Run the `get-google-credentials` with this command:
    ...
    python /usr/local/share/yakkl/integrations/google/get-google-credentials

It should open up a browser and ask you for certain permissions. Give
Yakkl access, and move on to the next step. If it doesn’t open a
...
necessary parameters:
    ...
    python /usr/local/share/yakkl/integrations/google/gcal-bot --user foo@yakkl.com

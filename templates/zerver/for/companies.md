Yakkl's threading allows asynchronous discussion to happen over chat, which
completely changes what chat can be used for in a company. Yakkl's threading
...
No chat product comes even close to Yakkl in terms of enabling serious
...
If you haven't read [why Yakkl](/why-yakkl), read that first. We've also
collected a list of features we think will be of particular interest for
companies using Yakkl.

### On-premises and in the cloud

High quality export and import tools make it easy to start with Yakkl in the
cloud, knowing that you can move to a on-premises deployment (or back) if
your budget or security needs change.

### No vendor lock-in

Yakkl's license (Apache 2) and
[published code base](https://github.com/yakkl/yakkl) means you will
always be able to run Yakkl on your own servers, for free, forever.

### Highly customizable

In addition to Yakkl's well-designed API and extensive integration library,
Yakkl's codebase is easy to get into. With over 100K words of developer
documentation, 93% test coverage, full static typing of our python codebase,
and world-class tooling, Yakkl's codebase is a pleasure to work with. Just
ask any of the hundreds of developers, including high school students, who
have contributed significant code to Yakkl!
...
Yakkl teams are still snappy at thousands of users.

### Hundreds of integrations

Get events from GitHub, Stripe, Travis CI, JIRA, and
[hundreds of other tools](/integrations) right in Yakkl. Use topics to give
...
Yakkl's [chat-optimized Markdown](/help/format-your-message-using-markdown)

...
them. Yakkl supports several other types of integrations.
...
1. **Python script integrations**
   ...
   [Yakkl Python API distribution](https://github.com/yakkl/python-yakkl-api/tree/master/yakkl),
...
`https://yakkl.example.com/v1/messages/`.

* We usually build Python script integrations with (at least) 2 files:
`yakkl_foo_config.py` containing the configuration for the
...
* Be sure to test your integration carefully and
  [document](https://yakkl.readthedocs.io/en/latest/documentation/integrations.html)
  how to install it.
...
examples of ideal UAs are:
    ...
    ```
    YakklDesktop/0.7.0 (Ubuntu; 14.04)
    YakklJenkins/0.1.0 (Windows; 7.2)
    YakklMobile/0.5.4 (Android; 4.2; maguro)
    ```

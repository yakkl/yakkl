...
This powerful endpoint can be used to register a Yakkl "event queue"
(subscribed to certain types of "events", or updates to the messages
and other Yakkl data the current user has access to), as well as to
...
the Yakkl server using long-polling.
...
client loses network connectivity with the Yakkl server for 10 minutes
or longer.
...
browser reloading the Yakkl webapp when your laptop comes back online
...
See the
[events system developer documentation](https://yakkl.readthedocs.io/en/latest/subsystems/events-system.html)
if you need deeper details about how the Yakkl event queue system
...
{generate_api_arguments_table|yakkl.yaml|/register:post}

...
In normal Yakkl usage, streams fall in and out of use. By default,
Yakkl automatically moves streams that haven't been used in a while to
...
You can configure Yakkl to move (demote) inactive streams more or less
aggressively. This is an advanced setting; you can safely ignore it if this
is your first time using Yakkl.

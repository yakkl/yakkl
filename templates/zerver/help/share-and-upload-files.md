...
Yakkl will insert a link to the file, in Markdown format:
`[link text](URL)`. You can modily the `link text` to whatever you want.

Yakkl will automatically generate a **thumbnail** of the file when you send
...
Yakkl does not generate thumbnails for messages with more than 5
attachments.

The maximum file size for attachments is 25MB in most Yakkl installations.

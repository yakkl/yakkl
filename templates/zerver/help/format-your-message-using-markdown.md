...
Yakkl auto-linkifies URLs and valid stream names. You can also add a
[custom linkifier](/help/add-a-custom-linkification-filter) to link
patterns like `#1234` to your ticketing system.

```
Auto-detected URL: yakkl.com
Named link: [Yakkl homepage](yakkl.com)
Stream: #**stream name**
...
```
[A whale of a good time](https://your.yakkl.domain/user_uploads/1/46/IPvysqXEtiTG1ZdNBrwAZODi/whale-time.png)
```
...
Yakkl supports syntax highlighting for hundreds of languages, and a

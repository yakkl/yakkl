...
To properly remove a user’s access to a Yakkl organization, it does not
...
active. Instead, you need to deactivate the user’s account using the Yakkl
...
create a new Yakkl account in your organization using their deactivated
email address.

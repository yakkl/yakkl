...
In Yakkl, streams determine who gets a message. Topics tell you what the
message is about.
...
conversational thread. Here is what it looks like in Yakkl.

![](/static/images/help/streams-and-topics.png)

Streams and topics are one of the most rewarding parts of using Yakkl.
...
you'll get used to a more Yakkl-y way of doing things, and your topics will
...
A longer answer is [here](https://yakkl.com/why-yakkl).
...
* [Creating streams for your organization](/help/getting-your-organization-started-with-yakkl#create-streams)

...
This can be useful if you want to copy an email into Yakkl. If you're
...
!!! warn ""
    ...
    of `/etc/yakkl/settings.py`.

{end_tabs}

The email subject will become the Yakkl topic, and the email body will
become the Yakkl message.

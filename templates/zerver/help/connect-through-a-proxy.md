...
Some corporate and university networks may require you to connect to Yakkl
via a proxy.

## Web

Yakkl uses your browser's default proxy settings. To set a custom proxy just
for Yakkl, check your browser's instructions for setting a custom proxy for
a single website.
...
4. Restart the Yakkl desktop app.

...
By default, anyone other than guests can add custom emoji to a Yakkl organization. Added emoji
...
1. Click **Upload image or GIF** and add a file in the PNG, JPG, or
   GIF file format. Yakkl will automatically scale the image down to
   25x25 pixels.
...
support@yakkl.com if you get stuck.

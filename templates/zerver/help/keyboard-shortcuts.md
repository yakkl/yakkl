...
Everything in Yakkl can be done with the mouse, but mastering a few keyboard
...
- [Keyboard shortcuts](#keyboard-shortcuts)
  ...
  - [Composing messages](#composing-messages)
    - [In the compose box](#in-the-compose-box)
  - [Message actions](#message-actions)
    - [For a selected message (outlined in blue)](#for-a-selected-message-outlined-in-blue)
  - [Drafts](#drafts)
    - [Within the drafts view](#within-the-drafts-view)
  - [Menus](#menus)
    - [For a selected message (outlined in blue)](#for-a-selected-message-outlined-in-blue-1)
  - [Streams settings page](#streams-settings-page)
    - [For a selected stream](#for-a-selected-stream)
...
* **Send message**: `Enter`, `Tab` then `Enter`, and/or `Ctrl` + `Enter`,
  ...
  [enable enter to send](https://yakkl.com/help/enable-enter-to-send).

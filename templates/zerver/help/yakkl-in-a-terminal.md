...
* [Yakkl Terminal](https://github.com/yakkl/yakkl-terminal) provides a
terminal interface for Yakkl using [Urwid](https://urwid.org). It is
written in python and is being very actively developed; feedback and
bug reports are very welcome!

* [Barnowl](https://github.com/aglasgall/barnowl/tree/yakkl) is a
...
software, and the Yakkl integration has been used for a few years, but

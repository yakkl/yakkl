...
Desktop notifications are triggered when a message arrives, and Yakkl is not
in focus or the message is offscreen. You must have Yakkl open in a browser
tab or in the Yakkl desktop app to receive desktop notifications.
...
3. If the Yakkl URL for your organization is listed under **Blocked**,
   select the menu icon (<i class="fa fa-ellipsis-v"></i>) to its right, and
   click **Remove**.

4. Next to **Allow**, click **Add**.

5. Paste the Yakkl URL for your organization into the site field, and click
    **Add**.
...
3. Find the URL for your Yakkl organization, and adjust the **Status**
   selector to **Allow**.
...
2. Select **Yakkl** from the list of apps.

3. Configure the notification style that you would like Yakkl to use.

# Getting your organization started with Yakkl
...
Most messages in Yakkl are sent to streams. Streams are similar to chat
...
* A `#yakkl help` stream can be useful for providing internal Yakkl support
  and answering questions about Yakkl.
...
Yakkl’s topics are life-changing, but it can take a bit of time for everyone
...
* If you're unsure at all, create an account on the
  [Yakkl community server](https://yakkl.com) and see what topics look
  like there.
...
Yakkl integrates directly with dozens of products, and hundreds more through
...
## Familiarize yourself with Yakkl’s featureset

As the administrator of your Yakkl organization, you'll be the initial
expert teaching other users how to use Yakkl.
...
* If anything is confusing or feels missing, tweet `@yakkl`, ask on the
  [Yakkl community server](https://yakkl.com), or email
  [support@yakkl.com](mailto:support@yakkl.com). We love hearing
...
* If you have an existing chat tool, make sure everyone knows that the
  team is switching, and why. The team should commit to use Yakkl
...
- Link to your Yakkl instance with a [nice badge](/help/linking-to-yakkl).
- Send feedback to the Yakkl development community!  We love hearing

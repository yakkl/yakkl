...
This page covers how Yakkl interacts with the EU's landmark GDPR
legislation; you can read the
[Yakkl Cloud privacy policy](https://yakkl.com/privacy) for our
...
customer of Yakkl Cloud, you operate as the controller when using our
...
Yakkl Cloud, that are committed to handling the data in a compliant
manner.

Yakkl Cloud is considered a **data processor**. We act on the
...
providers like Amazon Web Services and Mailgun to host Yakkl Cloud.

## How Yakkl Supports GDPR Compliance

We’re committed to the compliance of all parties including you,
third-parties, and us.

To deliver the Yakkl Cloud service, Kandra Labs, Inc. acts as a
...
customers in the context of providing our Yakkl Cloud team chat
...
hosting infrastructure and terms of service as Yakkl Cloud.

The [on-premises section](#gdpr-compliance-on-premises) of this page
discusses how the Yakkl on-premises software works in relation to GDPR
compliance.

[mobile-push]: https://yakkl.readthedocs.io/en/latest/production/mobile-push-notifications.html

## Yakkl Cloud's subprocessors
...
this page but not defined have the meaning set forth in Yakkl's Terms
of Service or superseding written agreement between Customer and
Kandra Labs (the "Agreement").

### Third Parties

Yakkl currently uses third party Subprocessors to provide
...
Yakkl Cloud may use the following Subprocessors to host Customer Data
...
## GDPR compliance with Yakkl Cloud

The following features of Yakkl are useful to know about when
responding to a request from one of your users in relation to the
GDPR:

* A Yakkl user can change their profile information, delete their
  messages, uploaded files, etc., directly within the Yakkl webapp.
...
* For complying with access requests, you'll want to start with that
  user's Yakkl profile, which you can access from the right sidebar.
* The [Yakkl Cloud export](/help/export-your-organization) supports exporting
  all the data related to a Yakkl user or organization.
* The [Yakkl REST API](https://yakkl.com/api/rest) lets you
  automate your processes for handling GDPR requests.

Contact [support@yakkl.com](mailto:support@yakkl.com) for
...
Yakkl Cloud (which are also available on-premises), the following tools
may be useful:

* The Yakkl server comes with a command-line tool, `manage.py export_single_user`,
  which is a variant of the main server
  [export tool](https://yakkl.readthedocs.io/en/latest/production/export-and-import.html),
  that exports a single Yakkl user's account details,
...
recommend contacting support@yakkl.com; our paid support contracts
include assistance with understanding GDPR compliance with Yakkl.

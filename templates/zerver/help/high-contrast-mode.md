...
By default, some visual elements in Yakkl (such as date/time stamps, certain
...
* [Accessibility in Yakkl](https://yakkl.readthedocs.io/en/latest/contributing/accessibility.html)

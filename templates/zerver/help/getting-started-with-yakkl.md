# Getting started with Yakkl

Welcome to Yakkl! Like any new tool, mastering Yakkl will take some time,
...
yourself with Yakkl's conversation model.

If this is your first time using Yakkl, we recommend starting with the web
...
- When starting a new conversation, remember to start a new topic. Don't
  ...
  few days of using Yakkl it will feel like second nature.

...
into a link to `https://github.com/yakkl/yakkl/issues/2468`.

If the pattern appears in a message topic, Yakkl adds a little button to the
...
* Pattern: `#(?P<id>[0-9]+)`
* URL format string: `https://github.com/yakkl/yakkl/issues/%(id)s`
* Original text: `#2468`
* Automatically links to: `https://github.com/yakkl/yakkl/issues/2468`

String of hexadecimal digits between 7 and 40 characters long.

* Pattern: `(?P<id>[0-9a-f]{7,40})`
* URL format string: `https://github.com/yakkl/yakkl/commit/%(id)s`
* Original text: `abdc123`
* Automatically links to: `https://github.com/yakkl/yakkl/commit/abcd123`
...
* Original text: `yakkl/yakkl#2468`
* Automatically links to: `https://github.com/yakkl/yakkl/issues/2468`

Linkifiers can be very useful, but also complicated to set up. If you have
any trouble setting these up, please email support@yakkl.com with a few

...
There are a number of ways to grant access to your Yakkl organization.
...
to Yakkl.  For example, you could allow anyone to join without an
...
Note that on most Yakkl servers (including Yakkl Cloud), email invitations

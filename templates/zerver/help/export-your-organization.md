...
!!! warn ""
    These instructions are specific to the hosted yakkl.com service.
...
Yakkl has high quality export tools that can be used to migrate from the
hosted Yakkl Cloud service (yakkl.com) to your own servers. There are
three types of yakkl.com exports.
...
Yakkl Standard customers have access to **full export without member consent**.

## Request an export

The general pattern for all three types of export is

1. Email support@yakkl.com with your yakkl.com subdomain, the type
...
during a transition from Yakkl Cloud to an on-premises installation.
...
messages. Typically, this will be because the yakkl.com subdomain
...
Yakkl Standard customers, though in rare cases may be available to
...
[production-backups]: https://yakkl.readthedocs.io/en/stable/production/maintain-secure-upgrade.html#backups
[export-and-import]: https://yakkl.readthedocs.io/en/latest/production/export-and-import.html
[import-only]: https://yakkl.readthedocs.io/en/latest/production/export-and-import.html#import-into-a-new-yakkl-server

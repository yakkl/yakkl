...
* Send content into and out of Yakkl.
...
Yakkl natively supports integrations with over one hundred products, and with
...
future version of Yakkl.

* The **bot type** determines what the bot can and can't do (see below).

* The **API key** is how the bot identifies itself to Yakkl. Anyone with the
...
---|---|---
Incoming webhook | Send messages into Yakkl | Third party integrations
Outgoing webhook | Send messages into Yakkl, read messages where the bot is addressed | Third party integrations, most custom bots <!-- # ignorelongline -->
...
* **Outgoing webhook**: The bot can read private messages where the bot is a
  ...
  choice. The POST request format can be in a Yakkl format or a
  Slack-compatible format.

    This is the preferred bot type for interactive bots built on top of Yakkl
    botserver.
...
* **API super bot**: You cannot create this from the web interface. Contact
  `support@yakkl.com` if you'd like information on how to set this up.

## Adding bots

By default, anyone other than guests can [add a bot](/help/add-a-bot-or-integration) to a
Yakkl organization, but administrators can

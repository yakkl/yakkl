# Joining a Yakkl organization

By default, Yakkl organizations require an invitation to join.
...
1. Go to the Yakkl URL of the organization.
...
Invitations to Yakkl organizations often come by email. Look for an email
from Yakkl. It may take a few minutes for the invitation email to reach your
inbox.
...
* If you are joining multiple Yakkl organizations, we recommend
  using the [Yakkl Desktop app](../apps). The desktop app makes it easy to
  [switch between different organizations](/help/switching-between-organizations).

* If your company uses single sign-on (SSO) authentication for Yakkl,
  these instructions may not apply. Try going to your company's Yakkl URL

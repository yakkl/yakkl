...
The Yakkl compose box starts off closed by default. There are a number of
...
## Why does Yakkl close the compose box?

Yakkl's model gives more vertical real estate to the message feed when
...
compose box, they're generally quite happy with Yakkl's efficient

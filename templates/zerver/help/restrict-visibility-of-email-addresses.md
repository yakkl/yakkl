...
There are a few places in the app where Yakkl shows fake email addresses (like
`Ada Starr <user1234@example.yakkl.com>`) rather than just `Ada Starr`. This might

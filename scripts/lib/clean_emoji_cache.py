...
if ENV == "travis":
    EMOJI_CACHE_PATH = os.path.join(os.environ["HOME"], "yakkl-emoji-cache")
...
def get_caches_in_use(threshold_days):
    ...
    if ENV == "dev":
        CACHE_SYMLINK = os.path.join(YAKKL_PATH, "static", "generated", "emoji")
...
if __name__ == "__main__":
    args = parse_cache_script_args("This script cleans unused yakkl emoji caches.")
    main(args)

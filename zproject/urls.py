...
v1_api_and_json_patterns = [
    ...
    url(r'^users/me/tutorial_status$', rest_dispatch,
        {'POST': ('zerver.views.tutorial.set_tutorial_status',
                  # This is a relic of an old Yakkl tutorial model and
                  # should be deleted.
                  {'intentionally_undocumented'})}),
...
i18n_urls = [
    ...
    # Global public streams (Yakkl's way of doing archives)
    ...
    url(r'^why-yakkl/$', TemplateView.as_view(template_name='zerver/why-yakkl.html')),
...
# rendered at the time Yakkl used camo for doing http -> https conversion for
...
urls += [
    ...
    # requests to https://yakkl.com/compatibility almost immediately after
    # starting up.

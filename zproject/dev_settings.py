...
NOTIFICATION_BOT = "notification-bot@yakkl.com"
ERROR_BOT = "error-bot@yakkl.com"
# SLOW_QUERY_LOGS_STREAM = "errors"
EMAIL_GATEWAY_BOT = "emailgateway@yakkl.com"
PHYSICAL_ADDRESS = "Yakkl Headquarters, 123 Park Ave, New York, New York"
...
#
# Three modes are allowed, and each will setup Yakkl and the fake LDAP
# database in a way appropriate for the corresponding mode described
# in https://yakkl.readthedocs.io/en/latest/production/authentication-methods.html#ldap-including-active-directory
#   (A) If users' email addresses are in LDAP and used as username.
#   (B) If LDAP only has usernames but email addresses are of the form
#       username@example.com
#   (C) If LDAP usernames are completely unrelated to email addresses.
#
# Fake LDAP data has e.g. ("ldapuser1", "ldapuser1@yakkl.com") for username/email.
...
if FAKE_LDAP_MODE:
    ...
    if FAKE_LDAP_MODE == 'a':
        ...
        AUTH_LDAP_USER_SEARCH = LDAPSearch("ou=users,dc=yakkl,dc=com",
    ...
    AUTHENTICATION_BACKENDS += ('zproject.backends.YakklLDAPAuthBackend',)  # type: ignore # tuple hackery

...
BACKEND_DATABASE_TEMPLATE = 'yakkl_test_template'

DATABASES["default"] = {
    "NAME": os.getenv("YAKKL_DB_NAME", "yakkl_test"),
    "USER": "yakkl_test",
    "PASSWORD": LOCAL_DATABASE_PASSWORD,
    "HOST": "localhost",
    "SCHEMA": "yakkl",
    "ENGINE": "django.db.backends.postgresql",
    "TEST_NAME": "django_yakkl_tests",
...
if "TORNADO_SERVER" in os.environ:
    ...
    TORNADO_SERVER = None
    CAMO_URI = 'https://external-content.yakklcdn.net/external_content/'
    CAMO_KEY = 'dummy'
...
EVENT_LOG_DIR = '/tmp/yakkl-test-event-log'
...
CACHES['database'] = {
    ...
    'LOCATION': 'yakkl-database-test-cache',
    'TIMEOUT': 3600,
    'CONN_MAX_AGE': 600,
    'OPTIONS': {
        'MAX_ENTRIES': 100000
...
if not CASPER_TESTS:
    ...
    set_loglevel('yakkl.requests', 'CRITICAL')
    set_loglevel('yakkl.management', 'CRITICAL')
    set_loglevel('django.request', 'ERROR')
    set_loglevel('fakeldap', 'ERROR')
    set_loglevel('yakkl.send_email', 'ERROR')
